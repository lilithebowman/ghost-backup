import { cx as st, cy as Q, cz as v, cA as it, cB as Ee, cp as Ie, cC as H, cD as ot, cq as m, cE as X, cF as P, cG as z, cr as fe, cH as at, cI as lt, bl as ht, cJ as ft, cK as ut, cL as dt, cM as pt, cN as ct, cO as mt, cv as Me, ct as gt, cP as kt, cQ as ue, cR as Lt } from "./index-CnMcD9aj.mjs";
import { html as bt, htmlCompletionSource as wt } from "./index-CjqAcKpK.mjs";
class _ {
...
` + e.scrub();
  ...
  reuseFragment(e) {
    ...
    return r ? (this.absoluteLineStart += r, this.lineStart = Ge(this.absoluteLineStart, this.ranges), this.moveRangeI(), this.absoluteLineStart < this.to ? (this.lineStart++, this.absoluteLineStart++, this.readLine()) : (this.atEnd = !0, this.readLine()), !0) : !1;
  }
  /**
...
const vt = Ie({
  ...
  LinkTitle: m.string,
  Paragraph: m.content
}), Nt = new Z(new Ee(Xe).extend(vt), Object.keys($).map((t) => $[t]), Object.keys($).map((t) => De[t]), Object.keys($), Bt, He, Object.keys(V).map((t) => V[t]), Object.keys(V), []);
function yt(t, e, r) {
  let n = [];
...
function ur(t = {}) {
  ...
  let l = t.extensions ? [t.extensions] : [], h = [a.support, Vt], f;
...
//# sourceMappingURL=index-BEh3nFEy.mjs.map
