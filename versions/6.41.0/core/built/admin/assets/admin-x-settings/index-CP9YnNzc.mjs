import { L as k, E as $, a as z } from "./index-BLF2n6YB.mjs";
import { cp as R, cq as t, cr as Y, cs as W, ct as Z, cu as x, cv as G, cw as _, cE as V, cT as E, cU as U } from "./index-CnMcD9aj.mjs";
const T = 135, m = 1, q = 136, C = 137, P = 2, N = 138, F = 3, I = 4, X = [
  ...
  8287,
  12288
], D = 58, B = 40, b = 95, K = 91, c = 45, A = 46, L = 35, J = 37, H = 38, M = 92, ee = 10, Oe = 42;
function Q(e) {
...
const v = (e, r, i) => (O, a) => {
  ...
  if (X.includes(e.peek(-1))) {
    let { next: r } = e;
    (Q(r) || r == b || r == L || r == A || r == Oe || r == K || r == D && Q(e.peek(1)) || r == c || r == H) && e.acceptToken(T);
  }
}), oe = new $((e) => {
  if (!X.includes(e.peek(-1))) {
    let { next: r } = e;
...
//# sourceMappingURL=index-CP9YnNzc.mjs.map
