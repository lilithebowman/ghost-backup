import { c as d } from "./check-BMQmbjGF.mjs";
import { j as l } from "./index-ccmRG8Rd.mjs";
import { M as k } from "./alert-dialog-DiH_9lnq.mjs";
const v = {
  Reddit: "reddit.com",
...
], Z = d("wallet-cards", A), C = ({ defaultSourceIconUrl: r, displayName: s, iconSrc: o }) => /* @__PURE__ */ l.jsx(l.Fragment, { children: s.trim().toLowerCase().endsWith("newsletter") ? /* @__PURE__ */ l.jsx(k, { "aria-label": "Newsletter", className: "size-4 text-muted-foreground" }) : /* @__PURE__ */ l.jsx(
  "img",
  {
    alt: "",
    className: "size-4",
...
//# sourceMappingURL=source-icon-DEuqlf2t.mjs.map
