import { e as G, j as s, h as _, R as D, c as V, g as b, a as g, d as I } from "./index-ccmRG8Rd.mjs";
import { B as O } from "./button-bsWyESEG.mjs";
import { E as P } from "./empty-indicator-C_CRWWaH.mjs";
import { A as q, p as J, e as Q, U as X, S as E, W as Y, C as Z } from "./source-icon-DEuqlf2t.mjs";
import { C as N, a as S, b as C, e as v, c as w, f as ss, T as es, P as rs, d as as } from "./post-analytics-header-9jDeEi2u.mjs";
import { S as ts, a as ns, b as cs, c as os, d as is, e as ls } from "./sheet-BDkY1KkY.mjs";
import { T as ds, a as ms, b as L, c as f, d as hs, e as y } from "./table-Dy0zIRBD.mjs";
import { u as xs, d as ps, e as us, K as M, f as H, a as k, b as T, c as R, g as js } from "./stats-CzDKJ9UC.mjs";
import { S as W, U as bs } from "./get-site-timezone-_SyeKwec.mjs";
import { S as A, b as gs } from "./skeleton-9GpF0jm6.mjs";
...
const ys = ({ className: a }) => {
...
}, K = "https://www.google.com/s2/favicons?domain=ghost.org&sz=64", F = ({ headerStyle: a = "table", children: n = "Source", data: m, mode: r, defaultSourceIconUrl: t = K }) => {
  ...
  const { data: a } = fs(), { postId: n } = I(), { stats: m, totals: r, isLoading: t, currencySymbol: o } = ws(n || ""), { appSettings: e } = _(), h = G(), c = (d) => h(js({ filter: d }), { crossApp: !0 }), i = a?.url, u = a?.icon;
  ...
  return e?.paidMembersEnabled || (p = "grid grid-cols-1 border rounded-md", l = "border-none hover:shadow-none"), /* @__PURE__ */ s.jsxs(s.Fragment, { children: [
    ...
    /* @__PURE__ */ s.jsx(as, { children: t ? /* @__PURE__ */ s.jsxs("div", { className: p, children: [
      /* @__PURE__ */ s.jsx(N, { className: l, children: /* @__PURE__ */ s.jsx(w, { className: "grid grid-cols-3 p-0", children: Array.from({ length: 3 }, (d, x) => /* @__PURE__ */ s.jsxs("div", { className: "h-[98px] gap-1 border-r px-6 py-5 last:border-r-0", children: [
        /* @__PURE__ */ s.jsx(A, { className: "w-2/3" }),
        /* @__PURE__ */ s.jsx(A, { className: "h-7 w-12" })
      ] }, x)) }) }),
...
//# sourceMappingURL=growth-BUOzMr3u.mjs.map
