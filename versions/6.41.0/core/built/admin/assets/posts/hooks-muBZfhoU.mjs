import { _ as p1, $ as Q, a0 as D1, a1 as n1, a2 as s1, a3 as V1, a4 as R1, a5 as Q1, a6 as i1, a7 as I1, a8 as P, a9 as l1, aa as E1, ab as F1, ac as Z1, r as X1, B as f1, D as v1, b as B, ad as $, u as k1, k as T, ae as C1, af as U1, o as e, n as w1, j as L, V as G1, Y as N1, ag as e1, ah as q1, ai as K1, aj as Y1, a as _1 } from "./index-ccmRG8Rd.mjs";
class b1 extends p1 {
  constructor(o, r) {
  ...
  onSubscribe() {
    this.listeners.size === 1 && (this.currentQuery.addObserver(this), a1(this.currentQuery, this.options) && this.executeFetch(), this.updateTimers());
  }
  onUnsubscribe() {
  ...
  setOptions(o, r) {
    ...
    s && c1(this.currentQuery, i, this.options, n) && this.executeFetch(), this.updateResult(r), s && (this.currentQuery !== i || this.options.enabled !== n.enabled || this.options.staleTime !== n.staleTime) && this.updateStaleTimeout();
  ...
  getOptimisticResult(o) {
    ...
    return $1(this, n, o) && (this.currentResult = n, this.currentResultOptions = this.options, this.currentResultState = this.currentQuery.state), n;
  }
  getCurrentResult() {
  ...
  executeFetch(o) {
    ...
    return o != null && o.throwOnError || (r = r.catch(D1)), r;
  }
  updateStaleTimeout() {
    if (this.clearStaleTimeout(), n1 || this.currentResult.isStale || !s1(this.options.staleTime))
      return;
    const r = V1(this.currentResult.dataUpdatedAt, this.options.staleTime) + 1;
  ...
  updateRefetchInterval(o) {
    this.clearRefetchInterval(), this.currentRefetchInterval = o, !(n1 || this.options.enabled === !1 || !s1(this.currentRefetchInterval) || this.currentRefetchInterval === 0) && (this.refetchIntervalId = setInterval(() => {
      (this.options.refetchIntervalInBackground || R1.isFocused()) && this.executeFetch();
  ...
  createResult(o, r) {
    ...
    if (r._optimisticResults) {
      const b = this.hasListeners(), F = !b && a1(o, r), W1 = b && c1(o, n, r, i);
      (F || W1) && (k = Q1(o.options.networkMode) ? "fetching" : "paused", g || (v = "loading")), r._optimisticResults === "isRestoring" && (k = "idle");
    }
    if (r.keepPreviousData && !h.dataUpdatedAt && u != null && u.isSuccess && v !== "error")
      ...
      if (s && h.data === l?.data && r.select === this.selectFn)
        ...
        try {
          this.selectFn = r.select, _ = r.select(h.data), _ = i1(s?.data, _, r), this.selectResult = _, this.selectError = null;
        } catch (b) {
          this.selectError = b;
        }
    else
    ...
    if (typeof r.placeholderData < "u" && typeof _ > "u" && v === "loading") {
      ...
      typeof b < "u" && (v = "success", _ = i1(s?.data, b, r), R = !0);
    }
    this.selectError && (p = this.selectError, _ = this.selectResult, w = Date.now(), v = "error");
    const z = k === "fetching", C = v === "loading", M = v === "error";
    return {
      status: v,
      fetchStatus: k,
      isLoading: C,
      ...
      isFetching: z,
      isRefetching: z && !C,
      isLoadingError: M && h.dataUpdatedAt === 0,
      isPaused: k === "paused",
      isPlaceholderData: R,
      isPreviousData: V,
      isRefetchError: M && h.dataUpdatedAt !== 0,
      isStale: t1(o, r),
...
function a1(t, o) {
  return J1(t, o) || t.state.dataUpdatedAt > 0 && G(t, o, o.refetchOnMount);
}
function G(t, o, r) {
  if (o.enabled !== !1) {
    const n = typeof r == "function" ? r(t) : r;
    return n === "always" || n !== !1 && t1(t, o);
  }
  return !1;
}
function c1(t, o, r, n) {
  return r.enabled !== !1 && (t !== o || n.enabled === !1) && (!r.suspense || t.state.status !== "error") && t1(t, r);
}
function t1(t, o) {
...
class ee extends b1 {
  ...
  getOptimisticResult(o) {
    return o.behavior = l1(), super.getOptimisticResult(o);
  }
  fetchNextPage({
    pageParam: o,
    ...r
  ...
  createResult(o, r) {
    ...
    const {
      ...
      isFetching: h,
      isRefetching: g
    } = u, p = h && ((n = d.fetchMeta) == null || (i = n.fetchMore) == null ? void 0 : i.direction) === "forward", w = h && ((s = d.fetchMeta) == null || (l = s.fetchMore) == null ? void 0 : l.direction) === "backward";
    return {
      ...u,
      fetchNextPage: this.fetchNextPage,
      fetchPreviousPage: this.fetchPreviousPage,
      hasNextPage: F1(r, (a = d.data) == null ? void 0 : a.pages),
      hasPreviousPage: E1(r, (c = d.data) == null ? void 0 : c.pages),
...
let te = class extends p1 {
  ...
  updateResult() {
    const o = this.currentMutation ? this.currentMutation.state : Z1(), r = {
      ...o,
...
function oe() {
  ...
  function a(h, g) {
    var p = g(), w = n({ inst: { value: p, getSnapshot: g } }), k = w[0].inst, v = w[1];
    return s(
      function() {
        k.value = p, k.getSnapshot = g, c(k) && v({ inst: k });
      },
      [h, p, g]
    ), i(
      function() {
...
var d1;
function re() {
  return d1 || (d1 = 1, Z.exports = oe()), Z.exports;
}
var ne = re();
const L1 = ne.useSyncExternalStore, m1 = /* @__PURE__ */ v1(!1), se = () => f1(m1);
m1.Provider;
function ie() {
  let t = !1;
  return {
...
const le = /* @__PURE__ */ v1(ie()), ae = () => f1(le);
function j1(t, o) {
...
const ce = (t, o) => {
  ...
  useErrorBoundary: r,
  query: n
}) => t.isError && !o.isReset() && !t.isFetching && j1(r, [t.error, n]), he = (t) => {
  t.suspense && typeof t.staleTime != "number" && (t.staleTime = 1e3);
}, ge = (t, o) => t.isLoading && t.isFetching && !o, pe = (t, o, r) => t?.suspense && ge(o, r), fe = (t, o, r) => o.fetchOptimistic(t).then(({
  data: n
}) => {
...
function y1(t, o) {
  const r = $({
    context: t.context
  }), n = se(), i = ae(), s = r.defaultQueryOptions(t);
  s._optimisticResults = n ? "isRestoring" : "optimistic", s.onError && (s.onError = P.batchCalls(s.onError)), s.onSuccess && (s.onSuccess = P.batchCalls(s.onSuccess)), s.onSettled && (s.onSettled = P.batchCalls(s.onSettled)), he(s), ce(s, i), ue(i);
  const [l] = k1(() => new o(r, s)), a = l.getOptimisticResult(s);
  if (L1(T((c) => {
    const d = n ? () => {
    } : l.subscribe(P.batchCalls(c));
    return l.updateResult(), d;
  }, [l, n]), () => l.getCurrentResult(), () => l.getCurrentResult()), B(() => {
    l.setOptions(s, {
      listeners: !1
    });
  }, [s, l]), pe(s, a, n))
...
function ve(t, o, r) {
  ...
  const l = L1(T((c) => s.subscribe(P.batchCalls(c)), [s]), () => s.getCurrentResult(), () => s.getCurrentResult()), a = T((c, d) => {
    s.mutate(c, d).catch(ke);
  }, [s]);
...
const we = (t) => /* @__PURE__ */ e("svg", { xmlns: "http://www.w3.org/2000/svg", fill: "none", viewBox: "0 0 14 14", height: 16, width: 16, ...t }, /* @__PURE__ */ e("g", { id: "user-single-neutral--close-geometric-human-person-single-up-user" }, /* @__PURE__ */ e("path", { id: "Union", fill: "currentColor", fillRule: "evenodd", d: "M10.5 3.5C10.5 5.433 8.93295 7 6.99995 7C5.06695 7 3.49995 5.433 3.49995 3.5C3.49995 1.567 5.06695 0 6.99995 0C8.93295 0 10.5 1.567 10.5 3.5ZM0.320435 13.4C1.21244 10.56 3.86563 8.50003 6.99996 8.50003C10.1343 8.50003 12.7875 10.56 13.6795 13.4C13.7751 13.7044 13.537 14 13.2179 14H0.781996C0.462883 14 0.224811 13.7044 0.320435 13.4Z", clipRule: "evenodd" }))), _e = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  stroke: "currentColor",
  strokeOpacity: 1
}, strokeWidth: 1.5, strokeLinecap: "round", strokeLinejoin: "round" })), ze = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: He
}, Symbol.toStringTag, { value: "Module" })), Te = (t) => /* @__PURE__ */ e("svg", { id: "Regular", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", strokeWidth: 1.5, ...t }, /* @__PURE__ */ e("defs", null), /* @__PURE__ */ e("title", null, "arrow-corner-left"), /* @__PURE__ */ e("path", { d: "M20.16 3.75 4.25 19.66", fill: "none", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round" }), /* @__PURE__ */ e("path", { d: "m4.25 4.66 0 15 15 0", fillRule: "evenodd", fill: "none", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round" })), We = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: Te
}, Symbol.toStringTag, { value: "Module" })), De = (t) => /* @__PURE__ */ e("svg", { id: "Regular", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", strokeWidth: 1.5, ...t }, /* @__PURE__ */ e("defs", null), /* @__PURE__ */ e("title", null, "arrow-corner-right"), /* @__PURE__ */ e("path", { d: "m4 3.75 15.91 15.91", fill: "none", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round" }), /* @__PURE__ */ e("path", { d: "m4.91 19.66 15 0 0-15", fillRule: "evenodd", fill: "none", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round" })), Ve = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: De
}, Symbol.toStringTag, { value: "Module" })), Re = (t) => /* @__PURE__ */ e("svg", { id: "Regular", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", ...t }, /* @__PURE__ */ e("defs", null), /* @__PURE__ */ e("title", null, "arrow-down"), /* @__PURE__ */ e("line", { x1: 12, y1: 0.75, x2: 12, y2: 23.25, fill: "none", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5px" }), /* @__PURE__ */ e("polyline", { points: "1.5 12.75 12 23.25 22.5 12.75", fillRule: "evenodd", fill: "none", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5px" })), Qe = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: Re
  ...
  __proto__: null,
  default: d0
}, Symbol.toStringTag, { value: "Module" })), g0 = (t) => /* @__PURE__ */ e("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", id: "Layout-Agenda--Streamline-Ultimate", height: 24, width: 24, ...t }, /* @__PURE__ */ e("desc", null, "Layout Agenda Streamline Icon: https://streamlinehq.com"), /* @__PURE__ */ e("defs", null), /* @__PURE__ */ e("title", null, "layout-agenda"), /* @__PURE__ */ e("path", { d: "M2.25 0.747h19.5s1.5 0 1.5 1.5v6s0 1.5 -1.5 1.5H2.25s-1.5 0 -1.5 -1.5v-6s0 -1.5 1.5 -1.5", fill: "none", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 1.5 }), /* @__PURE__ */ e("path", { d: "M2.25 14.247h19.5s1.5 0 1.5 1.5v6s0 1.5 -1.5 1.5H2.25s-1.5 0 -1.5 -1.5v-6s0 -1.5 1.5 -1.5", fill: "none", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 1.5 })), p0 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: g0
}, Symbol.toStringTag, { value: "Module" })), f0 = (t) => /* @__PURE__ */ e("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "-0.75 -0.75 24 24", height: 24, width: 24, ...t }, /* @__PURE__ */ e("defs", null), /* @__PURE__ */ e("title", null, "layout-module-1"), /* @__PURE__ */ e("path", { d: "M2.109375 0.7003125h5.625s1.40625 0 1.40625 1.40625v5.625s0 1.40625 -1.40625 1.40625h-5.625s-1.40625 0 -1.40625 -1.40625v-5.625s0 -1.40625 1.40625 -1.40625", fill: "none", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 1.5 }), /* @__PURE__ */ e("path", { d: "M2.109375 13.356562499999999h5.625s1.40625 0 1.40625 1.40625v5.625s0 1.40625 -1.40625 1.40625h-5.625s-1.40625 0 -1.40625 -1.40625v-5.625s0 -1.40625 1.40625 -1.40625", fill: "none", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 1.5 }), /* @__PURE__ */ e("path", { d: "M14.765625 0.7003125h5.625s1.40625 0 1.40625 1.40625v5.625s0 1.40625 -1.40625 1.40625h-5.625s-1.40625 0 -1.40625 -1.40625v-5.625s0 -1.40625 1.40625 -1.40625", fill: "none", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 1.5 }), /* @__PURE__ */ e("path", { d: "M14.765625 13.356562499999999h5.625s1.40625 0 1.40625 1.40625v5.625s0 1.40625 -1.40625 1.40625h-5.625s-1.40625 0 -1.40625 -1.40625v-5.625s0 -1.40625 1.40625 -1.40625", fill: "none", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 1.5 })), v0 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: f0
}, Symbol.toStringTag, { value: "Module" })), k0 = (t) => /* @__PURE__ */ e("svg", { viewBox: "0 0 24 24", xmlns: "http://www.w3.org/2000/svg", strokeWidth: 1.5, ...t }, /* @__PURE__ */ e("path", { d: "M6,13.223,8.45,16.7a1.049,1.049,0,0,0,1.707.051L18,6.828", fill: "none", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round" }), /* @__PURE__ */ e("path", { d: "M0.750 11.999 A11.250 11.250 0 1 0 23.250 11.999 A11.250 11.250 0 1 0 0.750 11.999 Z", fill: "none", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round" })), C0 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: k0
}, Symbol.toStringTag, { value: "Module" })), w0 = (t) => /* @__PURE__ */ e("svg", { viewBox: "0 0 24 24", xmlns: "http://www.w3.org/2000/svg", strokeWidth: 1.5, ...t }, /* @__PURE__ */ e("path", { style: {
  fill: "none",
  stroke: "currentColor",
  strokeLinecap: "round",
  strokeLinejoin: "round"
}, d: "m1.6 14.512 7.065 7.065 13.676-19", fill: "none", strokeLinecap: "round", strokeLinejoin: "round" })), _0 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: w0
}, Symbol.toStringTag, { value: "Module" })), b0 = (t) => /* @__PURE__ */ e("svg", { id: "Regular", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", ...t }, /* @__PURE__ */ e("defs", null), /* @__PURE__ */ e("title", null, "arrow-down-1"), /* @__PURE__ */ e("path", { d: "M23.25,7.311,12.53,18.03a.749.749,0,0,1-1.06,0L.75,7.311", fill: "none", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5px", fillRule: "evenodd" })), L0 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: b0
}, Symbol.toStringTag, { value: "Module" })), m0 = (t) => /* @__PURE__ */ e("svg", { id: "Regular", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", ...t }, /* @__PURE__ */ e("defs", null), /* @__PURE__ */ e("title", null, "arrow-left-1"), /* @__PURE__ */ e("path", { d: "M16.25,23.25,5.53,12.53a.749.749,0,0,1,0-1.06L16.25.75", fill: "none", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5px", fillRule: "evenodd" })), j0 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: m0
}, Symbol.toStringTag, { value: "Module" })), y0 = (t) => /* @__PURE__ */ e("svg", { id: "Regular", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", ...t }, /* @__PURE__ */ e("defs", null), /* @__PURE__ */ e("title", null, "arrow-right-1"), /* @__PURE__ */ e("path", { d: "M5.5.75,16.22,11.47a.749.749,0,0,1,0,1.06L5.5,23.25", fill: "none", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5px", fillRule: "evenodd" })), M0 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: y0
}, Symbol.toStringTag, { value: "Module" })), A0 = (t) => /* @__PURE__ */ e("svg", { id: "Regular", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", ...t }, /* @__PURE__ */ e("defs", null), /* @__PURE__ */ e("title", null, "arrow-up-1"), /* @__PURE__ */ e("path", { d: "M.75,17.189,11.47,6.47a.749.749,0,0,1,1.06,0L23.25,17.189", fill: "none", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5px", fillRule: "evenodd" })), x0 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: A0
}, Symbol.toStringTag, { value: "Module" })), S0 = (t) => /* @__PURE__ */ e("svg", { viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg", ...t }, /* @__PURE__ */ e("path", { d: "M12 23C18.0751 23 23 18.0751 23 12C23 5.92487 18.0751 1 12 1C5.92487 1 1 5.92487 1 12C1 18.0751 5.92487 23 12 23Z", stroke: "currentColor", strokeWidth: 2, strokeLinecap: "round", strokeLinejoin: "round" })), P0 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: S0
}, Symbol.toStringTag, { value: "Module" })), O0 = (t) => /* @__PURE__ */ e("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", ...t }, /* @__PURE__ */ e("defs", null), /* @__PURE__ */ e("title", null, "close"), /* @__PURE__ */ e("line", { x1: 0.75, y1: 23.249, x2: 23.25, y2: 0.749, fill: "none", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5px" }), /* @__PURE__ */ e("line", { x1: 23.25, y1: 23.249, x2: 0.75, y2: 0.749, fill: "none", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5px" })), B0 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: O0
}, Symbol.toStringTag, { value: "Module" })), H0 = (t) => /* @__PURE__ */ e("svg", { xmlns: "http://www.w3.org/2000/svg", fill: "none", viewBox: "0 0 24 24", id: "Layout--Streamline-Ultimate", height: 24, width: 24, ...t }, /* @__PURE__ */ e("desc", null, "Layout Streamline Icon: https://streamlinehq.com"), /* @__PURE__ */ e("path", { stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", d: "m1.5 2.99707 0 18.00003c0 0.8284 0.67157 1.5 1.5 1.5l18 0c0.8284 0 1.5 -0.6716 1.5 -1.5l0 -18.00003c0 -0.82843 -0.6716 -1.5 -1.5 -1.5l-18 0c-0.82843 0 -1.5 0.67157 -1.5 1.5Z", strokeWidth: 1.5 }), /* @__PURE__ */ e("path", { stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", d: "m12.0029 22.4971 0 -21.00003", strokeWidth: 1.5 }), /* @__PURE__ */ e("path", { stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", d: "m12.0029 11.9971 10 0", strokeWidth: 1.5 })), z0 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: H0
}, Symbol.toStringTag, { value: "Module" })), T0 = (t) => /* @__PURE__ */ e("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", ...t }, /* @__PURE__ */ e("path", { d: "M12 1.34C5.66 1.34 0.5 5.59 0.5 10.81a8.58 8.58 0 0 0 3.18 6.54l-2.3 4.59a0.49 0.49 0 0 0 0.09 0.57 0.5 0.5 0 0 0 0.57 0.1l6.15 -2.86a13.44 13.44 0 0 0 3.81 0.54c6.34 0 11.5 -4.25 11.5 -9.48S18.34 1.34 12 1.34Z", fill: "currentColor", strokeWidth: "1.5px" })), W0 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: T0
}, Symbol.toStringTag, { value: "Module" })), D0 = (t) => /* @__PURE__ */ e("svg", { xmlns: "http://www.w3.org/2000/svg", fill: "none", viewBox: "0 0 24 24", ...t }, /* @__PURE__ */ e("path", { stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5px", d: "M12.658 2a9.307 9.307 0 0 0-8.15 4.788 9.326 9.326 0 0 0 .23 9.456L2 22l5.75-2.74a9.32 9.32 0 0 0 13.894-5.372 9.341 9.341 0 0 0-1.532-8.185A9.328 9.328 0 0 0 12.658 2Z" })), V0 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: D0
}, Symbol.toStringTag, { value: "Module" })), R0 = (t) => /* @__PURE__ */ e("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", strokeWidth: "1.5px", ...t }, /* @__PURE__ */ e("g", null, /* @__PURE__ */ e("path", { d: "M21.92,17l1.32-10a.75.75,0,0,0-1.08-.78L17.88,9.56a.74.74,0,0,1-1.09-.16L12.56,3.22a.74.74,0,0,0-1.12,0L7.21,9.4a.74.74,0,0,1-1.09.16L1.84,6.3a.75.75,0,0,0-1.08.78L2.08,17Z", fill: "none", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round" }), /* @__PURE__ */ e("line", { x1: 2.25, y1: 21.03, x2: 21.75, y2: 21.03, fill: "none", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round" }))), Q0 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: R0
...
let Io = { data: "" }, Eo = (t) => {
  ...
  for (let s in t) {
    let l = t[s];
    s[0] == "@" ? s[1] == "i" ? r = s + " " + l + ";" : n += s[1] == "f" ? A(l, s) : s + "{" + A(l, s[1] == "k" ? "" : o) + "}" : typeof l == "object" ? n += A(l, o ? o.replace(/([^,])+/g, (a) => s.replace(/([^,]*:\S+\([^)]*\))|([^,])+/g, (c) => /&/.test(c) ? c.replace(/&/g, a) : a ? a + " " + c : c)) : s) : l != null && (s = /^--/.test(s) ? s : s.replace(/[A-Z]/g, "-$&").toLowerCase(), i += A.p ? A.p(s, l) : s + ":" + l + ";");
  }
  ...
  if (!j[l]) {
    let c = s !== t ? t : ((d) => {
      let u, h, g = [{}];
      for (; u = Fo.exec(d.replace(Zo, "")); ) u[4] ? g.shift() : u[3] ? (h = u[3].replace(g1, " ").trim(), g.unshift(g[0][h] = g[0][h] || {})) : g[0][u[1]] = u[2].replace(g1, " ").trim();
      return g[0];
    })(t);
    j[l] = A(i ? { ["@keyframes " + l]: c } : c, r ? "" : "." + l);
  }
  let a = r && j.g ? j.g : null;
  return r && (j.g = j[l]), ((c, d, u, h) => {
    h ? d.data = d.data.replace(h, c) : d.data.indexOf(c) === -1 && (d.data = u ? c + d.data : d.data + c);
  })(j[l], o, n, a), l;
}, Uo = (t, o, r) => t.reduce((n, i, s) => {
  let l = o[s];
  if (l && l.call) {
...
function I(t) {
  ...
  return Xo(r.unshift ? r.raw ? Uo(r, [].slice.call(arguments, 1), o.p) : r.reduce((n, i) => Object.assign(n, i && i.call ? i(o.p) : i), {}) : r, Eo(o.target), o.g, o.o, o.k);
}
let x1, N, q;
I.bind({ g: 1 });
let y = I.bind({ k: 1 });
...
function x(t, o) {
  ...
  return function() {
    ...
    function i(s, l) {
      ...
      r.p = Object.assign({ theme: N && N() }, a), r.o = / *go\d+/.test(c), a.className = I.apply(r, n) + (c ? " " + c : "");
      let d = t;
      return t[0] && (d = a.as || t, delete a.as), q && d[0] && q(a), x1(d, a);
    }
    return i;
  };
}
var No = (t) => typeof t == "function", K = (t, o) => No(t) ? t(o) : t, qo = /* @__PURE__ */ (() => {
  let t = 0;
  return () => (++t).toString();
})(), Ko = /* @__PURE__ */ (() => {
  let t;
...
}, Jo = [], $o = { toasts: [], pausedAt: void 0, settings: { toastLimit: Yo } }, O = {}, O1 = (t, o = S1) => {
  O[o] = P1(O[o] || $o, t), Jo.forEach(([r, n]) => {
    r === o && n(O[o]);
  });
}, B1 = (t) => Object.keys(O).forEach((o) => O1(t, o)), er = (t) => Object.keys(O).find((o) => O[o].toasts.some((r) => r.id === t)), o1 = (t = S1) => (o) => {
  O1(o, t);
}, tr = (t, o = "blank", r) => ({ createdAt: Date.now(), visible: !0, dismissed: !1, type: o, ariaProps: { role: "status", "aria-live": "polite" }, message: t, pauseDuration: 0, ...r, id: r?.id || qo() }), D = (t) => (o, r) => {
  let n = tr(o, t, r);
  return o1(n.toasterId || er(n.id))({ type: 2, toast: n }), n.id;
}, f = (t, o) => D("blank")(t, o);
f.error = D("error");
f.success = D("success");
f.loading = D("loading");
...
f.dismissAll = (t) => f.dismiss(void 0, t);
f.remove = (t, o) => {
  let r = { type: 4, toastId: t };
  o ? o1(o)(r) : B1(r);
};
f.removeAll = (t) => f.remove(void 0, t);
f.promise = (t, o, r) => {
  let n = f.loading(o.loading, { ...r, ...r?.loading });
  return typeof t == "function" && (t = t()), t.then((i) => {
    let s = o.success ? K(o.success, i) : void 0;
    return s ? f.success(s, { id: n, ...r, ...r?.success }) : f.dismiss(n), i;
  }).catch((i) => {
    let s = o.error ? K(o.error, i) : void 0;
    s ? f.error(s, { id: n, ...r, ...r?.error }) : f.dismiss(n);
  }), t;
};
var or = y`
from {
...
`, fr = ({ toast: t }) => {
  ...
  return o !== void 0 ? typeof o == "string" ? e(pr, null, o) : o : r === "blank" ? null : e(hr, null, e(lr, { ...n }), r !== "loading" && e(dr, null, r === "error" ? e(sr, { ...n }) : e(ur, { ...n })));
}, vr = (t) => `
...
`, Cr = "0%{opacity:0;} 100%{opacity:1;}", wr = "0%{opacity:1;} 100%{opacity:0;}", _r = x("div")`
  display: flex;
  align-items: center;
  background: #fff;
  color: #363636;
...
`, Lr = (t, o) => {
  let r = t.includes("top") ? 1 : -1, [n, i] = Ko() ? [Cr, wr] : [vr(r), kr(r)];
  return { animation: o ? `${y(n)} 0.35s cubic-bezier(.21,1.02,.73,1) forwards` : `${y(i)} 0.4s forwards cubic-bezier(.06,.71,.55,1)` };
};
G1(({ toast: t, position: o, style: r, children: n }) => {
  let i = t.height ? Lr(t.position || o || "top-center", t.visible) : { opacity: 0 }, s = e(fr, { toast: t }), l = e(br, { ...t.ariaProps }, K(t.message, t));
  return e(_r, { className: t.className, style: { ...i, ...r, ...t.style } }, typeof n == "function" ? n({ icon: s, message: l }) : e(N1, null, s, l));
});
Go(e);
I`
  z-index: 9999;
...
const jr = ({
  ...
  return /* @__PURE__ */ L.jsxs("div", { className: i, "data-testid": `toast-${r?.type}`, children: [
    /* @__PURE__ */ L.jsxs("div", { className: "mr-7 flex items-start gap-[10px]", children: [
      r?.icon && (typeof r.icon == "string" ? /* @__PURE__ */ L.jsx("div", { className: "mt-px", children: /* @__PURE__ */ L.jsx(h1, { className: "grow", colorClass: n, name: r.icon, size: "sm" }) }) : r.icon),
      o
    ] }),
    /* @__PURE__ */ L.jsx("button", { className: "absolute top-5 right-5 -mt-1.5 -mr-1.5 cursor-pointer rounded-full p-2 text-grey-700 hover:text-black dark:hover:text-white", type: "button", onClick: () => {
      f.dismiss(t.id);
    }, children: /* @__PURE__ */ L.jsx("div", { children: /* @__PURE__ */ L.jsx(h1, { colorClass: "stroke-2", name: "close", size: "2xs" }) }) })
  ] });
}, U = ({
  title: t,
  message: o,
  ...
  i.position || (i.position = "bottom-left"), r === "pageError" && (r = "error", i.position = "top-center", i.duration = 1 / 0), f.custom(
...
const r1 = () => {
  const { sentryDSN: t } = e1();
  return T((r, { withToast: n = !0 } = {}) => {
    console.error(r), t && q1((i) => {
      r instanceof m && r.response && (i.setTag("api_url", r.response.url), i.setTag("api_response_status", r.response.status)), K1(r);
    }), n && (mr.remove(), r instanceof m && r.response?.status === 418 || (r instanceof J && r.data?.errors[0] ? U({
...
const Hr = async (t) => {
  if (t.status === 0)
    throw new Y();
  if (t.status === 503)
    throw new H1(t, await t.text());
  if (t.status === 415)
    throw new xr(t, await t.text());
  if (t.status === 413)
    throw new Ar(t, await t.text());
  if (t.ok)
    return t.status === 204 ? void 0 : t.headers.get("content-type")?.includes("text/csv") ? await t.text() : await t.json();
  {
    ...
    throw o.errors?.[0]?.type === "VersionMismatchError" ? new yr(t, o) : o.errors?.[0]?.type === "ValidationError" ? new J(t, o) : o.errors?.[0]?.type === "NoPermissionError" ? new J(t, o) : o.errors?.[0]?.type === "ThemeValidationError" ? new Sr(t, o) : o.errors?.[0]?.type === "HostLimitError" ? new Pr(t, o) : o.errors?.[0]?.type === "EmailError" ? new Or(t, o) : new H(t, o);
  }
}, zr = (t) => {
...
`) || [];
  ...
  return o;
}, Tr = (t) => new Response(t.response, {
  status: t.status,
  statusText: t.statusText,
  headers: zr(t)
}), Wr = (t, o, { method: r, headers: n, credentials: i, body: s, signal: l }) => new Promise((a, c) => {
  const d = () => {
  ...
  const { ghostVersion: t, sentryDSN: o } = e1();
  return async (r, {
    method: n = "GET",
    headers: i = {},
    body: s,
    ...
    let g = 0, p = 0;
    const w = Date.now(), k = 15e3, v = [500, 1e3], V = [Y, H1, TypeError], R = (C, M) => {
      const S = {
        errorName: C?.name,
        attempts: g,
        totalSeconds: p / 1e3,
      ...
      return r.toString().includes("/ghost/api/") && (S.server = M?.headers.get("server")), S;
    }, _ = d ? Wr.bind(null, d) : fetch, z = a ? setTimeout(() => u.abort(), a) : void 0;
    try {
      for (; g === 0 || c; )
        try {
          const C = await _(r, h);
          ...
          if (p = Date.now() - w, c && V.some((S) => C instanceof S) && p <= k) {
            await new Promise((S) => {
              setTimeout(S, v[g] || v[v.length - 1]);
            }), g += 1;
            continue;
          }
          if (g !== 0 && o && Y1("Request failed after multiple attempts", { extra: R() }), C && typeof C == "object" && "name" in C && C.name === "AbortError")
            throw new Mr();
          let M = C;
          throw C instanceof m || (M = new Y({ cause: C })), M;
        }
    } finally {
      clearTimeout(z);
    }
  };
}, { apiRoot: Dr, activityPubRoot: Vr } = Br(), W = (t, o = {}, r = !1) => {
  const n = r ? Vr : Dr, i = new URL(`${n}${t}`, window.location.origin);
  return i.search = new URLSearchParams(o).toString(), i.toString();
}, Rr = "UsersResponseType", z1 = W("/users/me/", { include: "roles" }), Qr = [Rr, z1], Ir = () => {
  const t = E(), o = r1(), r = M1({
    queryKey: Qr,
    queryFn: () => t(z1),
    select: (n) => n.users[0]
...
}, Er = (t) => ({ searchParams: o, ...r } = {}) => {
  const n = W(t.path, o || t.defaultSearchParams, t?.useActivityPub), i = E(), s = r1(), l = T1(t.permissions), a = M1({
    ...r,
...
}, Ur = (t) => ({ searchParams: o, getNextPageParams: r, ...n } = {}) => {
  const i = E(), s = r1(), l = T1(t.permissions), a = r || t.defaultNextPageParams || (() => ({})), c = Ce({
    ...n,
...
}, Gr = (t) => (o, { searchParams: r, ...n } = {}) => Er({ ...t, path: t.path(o) })({ searchParams: r || t.defaultSearchParams, ...n }), Fr = ({ fetchApi: t, path: o, payload: r, searchParams: n, options: i }) => {
...
}, Nr = ({ path: t, searchParams: o, defaultSearchParams: r, updateQueries: n, invalidateQueries: i, ...s }) => () => {
  const l = E(), a = $(), { onUpdate: c, onInvalidate: d, onDelete: u } = e1(), h = T((g, p) => {
    if (i && "dataType" in i ? (a.invalidateQueries([i.dataType]), d(i.dataType)) : i && a.invalidateQueries(i.filters, i.options), n) {
      if (a.setQueriesData([n.dataType], (w) => n.update(g, w, p)), n.emberUpdateType === "createOrUpdate")
        c(n.dataType, g);
  ...
  return ve({
    mutationFn: (g) => Fr({ fetchApi: l, path: t(g), payload: g, searchParams: o?.(g) || r, options: s }),
    onSuccess: h
  });
};
export {
...
//# sourceMappingURL=hooks-muBZfhoU.mjs.map
