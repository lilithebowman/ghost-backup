import { a7 as Xn, R as Y, j as n, t as Nn, b as y, e as F, be as In, bf as Pn, B as $, bH as Gn, bg as Fn, bI as ne, c as U, bJ as ee, X as yn, d as Ln, bK as hn, S as _, P as te, A as ae, g as wn, r as oe, h as re, ab as ie, aW as de, k as mn, F as cn, i as sn, bL as ce, bM as B, bN as jn, ad as se, a as le, u as ge, l as pe, L as ue, D as he, n as me, o as ke, p as fe, bO as be, bP as xe, bQ as ve, aF as Cn, aG as ye } from "./index-iRncUrZR.mjs";
import { u as we, D as je, A as Ce, S as zn } from "./deleted-feed-item-Bthg1CYK.mjs";
import { T as ze } from "./topic-filter-CUsMQtiT.mjs";
import { S as Se } from "./separator-BhXvs9Vo.mjs";
import { I as Sn } from "./inbox-lkOfXJ3b.mjs";
const _e = [["path", { d: "M5 12h14", key: "1ays0h" }]], Ee = Xn("minus", _e), On = Y.forwardRef(({ children: t, className: r, ...a }, s) => /* @__PURE__ */ n.jsx(
  "div",
  {
    ref: s,
...
const kn = Y.forwardRef(({ children: t, className: r, title: a, description: s, actions: i, ...h }, d) => /* @__PURE__ */ n.jsxs("div", { ref: d, className: Nn("flex flex-col items-center justify-center space-y-3 text-center", r), ...h, children: [
...
const fn = ["1.5rem", "1.6rem", "1.7rem", "1.8rem", "2rem"], V = {
  ...
  const [t, r] = y(() => localStorage.getItem(V.BACKGROUND_COLOR)?.toUpperCase() || "SYSTEM"), [a, s] = y(() => {
    const o = localStorage.getItem(V.FONT_SIZE);
    return o ? parseInt(o) : 2;
  }), [i, h] = y(() => localStorage.getItem(V.FONT_STYLE) || "sans"), d = (o) => {
    r(o), localStorage.setItem(V.BACKGROUND_COLOR, P[o].id);
  };
  return F(() => {
    localStorage.setItem(V.FONT_SIZE, a.toString());
  }, [a]), F(() => {
    localStorage.setItem(V.FONT_STYLE, i);
  }, [i]), {
    backgroundColor: t,
  ...
  onColorChange: s,
  onFontStyleChange: i,
  currentFontSizeIndex: h,
  onDecreaseFontSize: d,
  onIncreaseFontSize: p,
  onResetFontSize: x,
  onOpenChange: u
}) => /* @__PURE__ */ n.jsxs(In, { modal: !1, onOpenChange: u, children: [
  /* @__PURE__ */ n.jsx(Pn, { asChild: !0, children: /* @__PURE__ */ n.jsx($, { className: `size-9 rounded-full ${P[t].button}`, variant: "ghost", children: /* @__PURE__ */ n.jsx(Gn.Typography, { className: "size-[18px]!" }) }) }),
  ...
  const [h, d] = y(null), p = Y.useRef(!1), x = (u) => {
    if (!r?.contentDocument)
      return;
    const o = r.contentDocument.getElementById(u);
    o && a.current && (p.current = !0, d(u), a.current.scrollTo({
      top: o.offsetTop - 20,
      behavior: "smooth"
    }), setTimeout(() => {
      p.current = !1;
  ...
  return F(() => {
    ...
    const o = () => {
      ...
      if (!c)
        return;
      const E = u.scrollTop, L = 100, q = t.map((z) => c.getElementById(z.id)).filter((z) => z !== null).map((z) => ({
        id: z.id,
        top: z.offsetTop
      }));
      if (!q.length)
        return;
      const O = q.reduce((z, A) => A.top - L <= E ? A : z);
      d(O?.id || null);
    }, l = () => {
      requestAnimationFrame(o);
    };
    return u.addEventListener("scroll", l), o(), () => {
  ...
  2: "pl-6",
  3: "pl-10"
}, Oe = ({ items: t, activeHeading: r, onItemClick: a, onOpenChange: s }) => {
  const [i, h] = y(!1), d = Y.useRef();
  if (Y.useEffect(() => () => {
    d.current && clearTimeout(d.current);
  }, []), t.length === 0)
    return null;
  const p = (c) => Math.min(c, 3), x = (c) => Fe[p(c)], u = (c) => Le[p(c)], o = () => {
    d.current && clearTimeout(d.current), h(!0), s?.(!0);
  }, l = () => {
    d.current = setTimeout(() => {
      h(!1), s?.(!1);
    }, 100);
  };
  return /* @__PURE__ */ n.jsxs(In, { modal: !1, open: i, onOpenChange: h, children: [
        ...
        children: /* @__PURE__ */ n.jsx(
          "nav",
          {
            ...
            children: t.map((c) => /* @__PURE__ */ n.jsx(
              "button",
              {
                className: `line-clamp-2 block w-full cursor-pointer rounded py-1 text-left text-sm leading-tight ${r === c.id ? "text-black dark:text-white" : "text-gray-700 dark:text-gray-600"} hover:bg-gray-75 hover:text-gray-900 dark:hover:bg-grey-925 dark:hover:text-white ${u(c.level)}`,
                type: "button",
                onClick: () => a(c.id),
...
`, Me = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: Te
}, Symbol.toStringTag, { value: "Module" })), Ae = `(function() {
...
`, He = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: qe
}, Symbol.toStringTag, { value: "Module" })), Ue = `.kg-audio-card,
.kg-audio-card * {
    box-sizing: border-box;
}
...
`, We = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: Ue
}, Symbol.toStringTag, { value: "Module" })), Ke = `.kg-blockquote-alt {
  font-size: 1.5em;
  font-style: italic;
  line-height: 1.7em;
  text-align: center;
...
`, Ve = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: Ke
}, Symbol.toStringTag, { value: "Module" })), Ye = `.kg-bookmark-card,
.kg-bookmark-card * {
    box-sizing: border-box;
}
...
`, Qe = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: Ye
}, Symbol.toStringTag, { value: "Module" })), Ze = `.kg-button-card,
.kg-button-card * {
    box-sizing: border-box;
}
...
.kg-callout-card + .kg-callout-card {
  ...
  __proto__: null,
  default: Xe
}, Symbol.toStringTag, { value: "Module" })), nt = `.kg-collection-card {
    width: 100%;
    margin-top: 6vmin;
}
...
@media (min-width: 1280px) {
  ...
  __proto__: null,
  default: nt
}, Symbol.toStringTag, { value: "Module" })), tt = `.kg-cta-card,
.kg-cta-card * {
    box-sizing: border-box;
}
...
`, at = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: tt
}, Symbol.toStringTag, { value: "Module" })), ot = `.kg-file-card,
.kg-file-card * {
    box-sizing: border-box;
}
...
`, rt = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: ot
}, Symbol.toStringTag, { value: "Module" })), it = `.kg-gallery-card,
.kg-gallery-card * {
    box-sizing: border-box;
}
...
`, st = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: ct
}, Symbol.toStringTag, { value: "Module" })), lt = `.kg-header-card.kg-v2 {
    position: relative;
    padding: 0;
    min-height: initial;
    text-align: initial;
...
`, gt = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: lt
}, Symbol.toStringTag, { value: "Module" })), pt = `.kg-nft-card,
.kg-nft-card * {
    box-sizing: border-box;
}
...
.kg-nft-card p.kg-nft-description {
  ...
  __proto__: null,
  default: pt
}, Symbol.toStringTag, { value: "Module" })), ht = `.kg-product-card,
.kg-product-card * {
    box-sizing: border-box;
}
...
`, mt = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: ht
}, Symbol.toStringTag, { value: "Module" })), kt = `.kg-signup-card {
    position: relative;
}
...
`, ft = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: kt
}, Symbol.toStringTag, { value: "Module" })), bt = `.kg-toggle-card,
.kg-toggle-card * {
    box-sizing: border-box;
}
...
`, xt = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: bt
}, Symbol.toStringTag, { value: "Module" })), vt = `.kg-transistor-card {
    display: flex;
    justify-content: center;
}
...
`, yt = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: vt
}, Symbol.toStringTag, { value: "Module" })), wt = `.kg-video-card,
.kg-video-card * {
    box-sizing: border-box;
}
...
`, jt = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: wt
}, Symbol.toStringTag, { value: "Module" })), Ct = /* @__PURE__ */ Object.assign({ "../../ghost/core/core/frontend/src/cards/js/audio.js": Me, "../../ghost/core/core/frontend/src/cards/js/gallery.js": $e, "../../ghost/core/core/frontend/src/cards/js/toggle.js": Be, "../../ghost/core/core/frontend/src/cards/js/video.js": He }), zt = /* @__PURE__ */ Object.assign({ "../../ghost/core/core/frontend/src/cards/css/audio.css": We, "../../ghost/core/core/frontend/src/cards/css/blockquote.css": Ve, "../../ghost/core/core/frontend/src/cards/css/bookmark.css": Qe, "../../ghost/core/core/frontend/src/cards/css/button.css": Je, "../../ghost/core/core/frontend/src/cards/css/callout.css": Ge, "../../ghost/core/core/frontend/src/cards/css/collection.css": et, "../../ghost/core/core/frontend/src/cards/css/cta.css": at, "../../ghost/core/core/frontend/src/cards/css/file.css": rt, "../../ghost/core/core/frontend/src/cards/css/gallery.css": dt, "../../ghost/core/core/frontend/src/cards/css/header.css": st, "../../ghost/core/core/frontend/src/cards/css/header_v2.css": gt, "../../ghost/core/core/frontend/src/cards/css/nft.css": ut, "../../ghost/core/core/frontend/src/cards/css/product.css": mt, "../../ghost/core/core/frontend/src/cards/css/signup.css": ft, "../../ghost/core/core/frontend/src/cards/css/toggle.css": xt, "../../ghost/core/core/frontend/src/cards/css/transistor.css": yt, "../../ghost/core/core/frontend/src/cards/css/video.css": jt }), St = Object.values(Ct).map((t) => t.default).join(`

`), _t = Object.values(zt).map((t) => t.default).join(`
...
`), Et = ({
  ...
  fontSize: p,
  fontStyle: x,
  onHeadingsExtracted: u,
  onIframeLoad: o,
  onLoadingChange: l,
  isPopoverOpen: c
}) => {
  const E = U(null), [L, q] = y(!0), [O, z] = y("0px"), A = document.documentElement.classList.contains("dark") && d === "SYSTEM" || d === "DARK", Q = Re(), k = `
        <html class="has-${A ? "light" : "dark"}-text has-${x}-body ${d === "SEPIA" && "has-sepia-bg"}">
        <head>
            ${Q}
            <style>
                :root {
        ...
        <body>
            <header class='gh-article-header gh-canvas'>
                ...
                ${s ? `<p class='gh-article-excerpt'>${B(s)}</p>` : ""}
                <a href="${t && jn(t) ? B(t) : "#"}" target="_blank" rel="noopener noreferrer" class="gh-article-meta">
                    ${i && i.length > 0 ? `
                    ...
                    <div class="gh-article-meta-wrapper">
                        ${i && i.length > 0 ? `
                            <span class="gh-article-author-name">
                                ${i.length > 1 ? `${B(i[0].name)} and ${i.length - 1} ${i.length - 1 === 1 ? "other" : "others"}` : B(i[0].name)}
                            </span>
                        ` : ""}
                        <span class="gh-article-source">${t && jn(t) ? B(new URL(t).hostname) : ""} <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-external-link-icon lucide-external-link"><path d="M15 3h6v6"/><path d="M10 14 21 3"/><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"/></svg></span>
                    </div>
                </a>
                ${a ? `
  ...
  return F(() => {
    ...
    g.srcdoc || (g.srcdoc = k);
    const R = (f) => {
      if (f.data.type === "resize") {
        const N = `${f.data.bodyHeight + 24}px`;
        z(N), g.style.height = N, f.data.isLoaded && q(!1);
      }
    }, j = (f) => {
      if (f.key === "Escape") {
      ...
      const f = g.contentWindow;
      f && f.addEventListener("keydown", j);
    };
    return g.addEventListener("load", S), window.addEventListener("message", R), () => {
      window.removeEventListener("message", R), g.removeEventListener("load", S);
      const f = g.contentWindow;
    ...
    if (!g)
      return;
    const R = g.contentDocument || g.contentWindow?.document;
    if (!R)
      return;
    const j = R.documentElement;
    j.style.setProperty("--font-size", p), j.classList.remove("has-sans-body", "has-serif-body"), j.classList.add(`has-${x}-body`), j.classList.remove("has-dark-text", "has-light-text"), j.classList.add(`has-${A ? "light" : "dark"}-text`), d === "SEPIA" ? j.classList.add("has-sepia-bg") : j.classList.remove("has-sepia-bg");
    const S = g.contentWindow;
    if (S && typeof S.resizeIframe == "function")
      S.resizeIframe();
    else {
      const f = new Event("resize");
      R.dispatchEvent(f);
    }
  }, [p, x, d, A]), F(() => {
    const g = E.current;
    ...
    const R = () => {
      ...
      if (j.length === 0)
        return;
      const S = Math.min(
        ...j.map((N) => parseInt(N.tagName[1]))
      ), f = j.map((N, G) => {
        const T = `heading-${G}`;
        N.id = T;
        const nn = parseInt(N.tagName[1]) - S + 1;
        return {
          id: T,
          text: N.textContent || "",
          level: nn,
    ...
    return g.addEventListener("load", R), () => g.removeEventListener("load", R);
  }, [u, o]), F(() => {
    l?.(L);
    ...
    L && /* @__PURE__ */ n.jsxs("div", { className: "mx-auto mt-6 w-full max-w-[640px] max-lg:px-4", children: [
      /* @__PURE__ */ n.jsxs("div", { className: "mb-6 flex flex-col gap-2", children: [
        /* @__PURE__ */ n.jsx(_, { className: "h-8" }),
        /* @__PURE__ */ n.jsx(_, { className: "h-8 w-full max-w-md" })
      ] }),
      /* @__PURE__ */ n.jsx(_, { className: "mt-2 h-4", count: 4, randomize: !0 }),
      /* @__PURE__ */ n.jsx(_, { className: "mt-8 h-[400px]" }),
      /* @__PURE__ */ n.jsx(_, { className: "mt-2 h-4", containerClassName: "block mt-7 mb-4", count: 8, randomize: !0 })
    ] }),
    /* @__PURE__ */ n.jsx(
      "iframe",
      {
...
}, En = () => /* @__PURE__ */ n.jsx("div", { className: "h-px bg-black/[8%] dark:bg-gray-950" }), X = /* @__PURE__ */ new Map(), Nt = ({
  postId: t = null,
  onClose: r
}) => {
  const {
    ...
    decreaseFontSize: u,
    resetFontSize: o
  } = Ne(), l = U(null), [c, E] = y(!1), [L, q] = y(!1), [O, z] = y(/* @__PURE__ */ new Set()), [A, Q] = y(/* @__PURE__ */ new Set()), [k, g] = y(/* @__PURE__ */ new Set()), [R, j] = y(!1), S = U(null), f = U(null), {
    post: N,
    processedReplies: G,
    isLoading: T,
    loadMoreChildren: ln,
    loadMoreChildReplies: nn,
    hasMoreChildren: en,
    hasMoreChildReplies: tn
  } = we(t ?? "", { includeAncestors: !1 }), gn = N, b = gn?.object, H = gn?.actor, Rn = gn?.object?.metadata?.ghostAuthors, Tn = b?.replyCount ?? 0;
  F(() => {
    if (!en)
      return;
    ...
    const e = l.current;
    if (e)
      return S.current = new IntersectionObserver(async (w) => {
        if (w[0].isIntersecting && en && !R) {
          j(!0);
          try {
            await ln();
          } catch (m) {
        ...
        root: e,
        rootMargin: "200px"
      }), f.current && S.current.observe(f.current), () => {
        S.current && S.current.disconnect();
      };
  }, [en, R, ln]);
  function pn() {
  ...
  function Mn(e) {
    z((w) => {
      const m = new Set(w);
      return m.has(e) ? m.delete(e) : (m.add(e), Q((C) => {
        const M = new Set(C);
        return M.add(e), M;
      })), m;
    });
  }
  async function An(e, w) {
    if (!k.has(e)) {
      g((m) => new Set(m).add(e));
      try {
        nn && await nn(w);
  ...
  const $n = () => {
  }, Dn = U(null), Bn = "904px", W = "640px", [bn, qn] = y(0), [Z, Hn] = y(!0), [un] = ee(qn, 100), xn = 1;
  F(() => {
    const e = l.current, w = document.getElementById("object-content"), m = () => {
      if (Z || !e || !w)
        return;
      const M = w.getBoundingClientRect(), K = e.getBoundingClientRect();
      if (M.height <= K.height) {
        un(100);
        return;
      }
      const D = Math.max(0, K.top - M.top), v = w.offsetHeight - e.offsetHeight, I = Math.min(Math.max(D / v * 100, 0), 100), dn = Math.round(I / xn) * xn;
      un(dn);
    };
    if (Z)
      return;
    ...
    return w && C.observe(w, {
      ...
      e?.removeEventListener("scroll", m), C.disconnect();
    };
  }, [Z, un]);
  const [an, Un] = y([]), [Wn, Kn] = y(null), [on, Vn] = y(null), Yn = yn((e) => {
    Un(e);
  }, []), Qn = yn((e) => {
    Vn(e);
  }, []);
  F(() => {
    if (!on?.contentDocument || !an.length)
      return;
    const w = setTimeout(() => {
      const m = l.current;
      if (!m)
        return;
      const C = () => {
        const M = on.contentDocument;
        if (!M || !M.documentElement)
          return;
        const K = m.scrollTop, J = an.map((I) => M.getElementById(I.id)).filter((I) => I !== null).map((I) => ({
          element: I,
          id: I.id,
          top: I.offsetTop
        }));
      ...
      return m.addEventListener("scroll", C), C(), () => {
  ...
  return F(() => {
  ...
  }, [Z, T, t]), T ? /* @__PURE__ */ n.jsx("div", { className: `max-h-full overflow-auto rounded-md ${a === "DARK" && "dark"} ${(a === "LIGHT" || a === "SEPIA") && "light"} ${P[a].background}`, children: /* @__PURE__ */ n.jsx("div", { className: "flex h-full flex-col", children: /* @__PURE__ */ n.jsxs("div", { className: "relative flex-1", children: [
      ...
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ n.jsxs("div", { className: "col-[2/3] mx-auto flex w-full items-center gap-3 max-md:hidden", children: [
            /* @__PURE__ */ n.jsx(_, { className: "size-10 rounded-full" }),
            /* @__PURE__ */ n.jsxs("div", { className: "grow pt-1", children: [
              /* @__PURE__ */ n.jsx(_, { className: "w-full" }),
              /* @__PURE__ */ n.jsx(_, { className: "w-2/3" })
            ] })
          ] }),
  ...
  ] }) }) }) : N ? /* @__PURE__ */ n.jsx("div", { ref: l, className: `max-h-full overflow-auto rounded-md ${a === "DARK" && "dark"} ${(a === "LIGHT" || a === "SEPIA") && "light"} ${P[a].background}`, "data-scrollable-container": !0, children: /* @__PURE__ */ n.jsx(n.Fragment, { children: /* @__PURE__ */ n.jsxs("div", { className: "flex h-full flex-col", children: [
    /* @__PURE__ */ n.jsxs("div", { className: "relative flex-1", children: [
            ...
            /* @__PURE__ */ n.jsxs("div", { className: "col-[2/3] mx-auto flex w-full items-center justify-between gap-3 max-md:hidden", children: [
              /* @__PURE__ */ n.jsx(te, { actor: H, isCurrentUser: b.authored, children: /* @__PURE__ */ n.jsxs("div", { className: "flex cursor-pointer items-center gap-3", children: [
                ...
                /* @__PURE__ */ n.jsxs("div", { className: "relative z-10 mt-0.5 flex min-w-0 cursor-pointer flex-col overflow-visible text-[1.5rem]", onClick: (e) => re(H, rn, e), children: [
                  /* @__PURE__ */ n.jsx("div", { className: "flex w-full", children: /* @__PURE__ */ n.jsx("span", { className: "min-w-0 truncate font-semibold whitespace-nowrap text-black hover:underline dark:text-white", children: T ? /* @__PURE__ */ n.jsx(_, { className: "w-20" }) : H.name }) }),
                  /* @__PURE__ */ n.jsxs("div", { className: "flex w-full", children: [
                    !T && /* @__PURE__ */ n.jsx("span", { className: 'truncate text-gray-700 after:mx-1 after:font-normal after:text-gray-700 after:content-["·"]', children: wn(H) }),
                    /* @__PURE__ */ n.jsx("span", { className: "text-gray-700", children: T ? /* @__PURE__ */ n.jsx(_, { className: "w-[120px]" }) : oe(b, !b.authored) })
                  ] })
                ] })
              ] }) }),
              !b.authored && !T && /* @__PURE__ */ n.jsx(
                ie,
                {
      ...
      /* @__PURE__ */ n.jsxs("div", { className: "relative flex-1", children: [
        ...
        !T && /* @__PURE__ */ n.jsx("div", { className: "grow overflow-y-auto", children: /* @__PURE__ */ n.jsxs("div", { className: "mx-auto px-6 pt-5 pb-10", style: { maxWidth: Bn }, children: [
          ...
          b.type === "Tombstone" && /* @__PURE__ */ n.jsx(je, { last: !0 }),
          ...
          /* @__PURE__ */ n.jsxs("div", { ref: Dn, className: "mx-auto w-full", style: { maxWidth: W }, children: [
            G.map((e, w) => {
              const m = w === G.length - 1, C = e.mainReply.id, M = O.has(C), K = A.has(C), J = k.has(C), D = e.chain.length > 0;
              return /* @__PURE__ */ n.jsxs(Y.Fragment, { children: [
                /* @__PURE__ */ n.jsx(
                  cn,
                  {
                    ...
                    onClick: () => {
                      const v = l.current;
                      v && t && X.set(t, v.scrollTop), rn(`/notes/${encodeURIComponent(e.mainReply.id)}`);
                    },
                    onDelete: pn
                  }
                ),
                D && e.chain[0] && /* @__PURE__ */ n.jsx(
                  cn,
                  {
                    ...
                    onClick: () => {
                      const v = l.current;
                      v && t && X.set(t, v.scrollTop), rn(`/notes/${encodeURIComponent(e.chain[0].id)}`);
                    },
                    onDelete: pn
                  },
                  e.chain[0].id
                ),
                D && M && e.chain.slice(1).map((v, I) => {
                  const dn = I === e.chain.slice(1).length - 1, Zn = tn && tn(w), Jn = dn && Zn;
                  return /* @__PURE__ */ n.jsx(
                    cn,
                    {
                      actor: v.actor,
                      allowDelete: v.object.authored,
                      commentCount: v.object.replyCount ?? 0,
                      isChainContinuation: !0,
                      isPending: sn(v.id),
                      last: dn && !Jn,
                      layout: "reply",
                      likeCount: v.object.likeCount ?? 0,
                      object: v.object,
                      parentId: b.id,
                      repostCount: v.object.repostCount ?? 0,
                      type: "Note",
                      onClick: () => {
                        const vn = l.current;
                        vn && t && X.set(t, vn.scrollTop), rn(`/notes/${encodeURIComponent(v.id)}`);
                      },
                      onDelete: pn
                    },
                    v.id
            ...
            R && /* @__PURE__ */ n.jsx("div", { className: "flex flex-col items-center justify-center text-center", children: /* @__PURE__ */ n.jsx(mn, { size: "md" }) })
          ] }),
          en && /* @__PURE__ */ n.jsx("div", { ref: f, className: "h-1" })
        ] }) })
      ] })
    ] }),
  ...
  const p = Ln(), { canGoBack: x, goBack: u } = le(), [o, l] = y(!1), c = ge(), { topicsQuery: E } = pe(), { data: L } = E, q = L && L.topics.length > 0;
  F(() => {
    l(!!c.postId);
  }, [c.postId]);
  const O = U(null), z = U(null), A = U(null);
  F(() => (O.current && O.current.disconnect(), O.current = new IntersectionObserver((k) => {
    k[0].isIntersecting && i && !h && s();
  }), z.current && O.current.observe(z.current), A.current && O.current.observe(A.current), () => {
    O.current && O.current.disconnect();
  }), [i, h, s]);
  const Q = Math.max(0, Math.floor(r.length * 0.75) - 1);
  return /* @__PURE__ */ n.jsxs(ue, { children: [
    q && /* @__PURE__ */ n.jsx(ze, { currentTopic: a, excludeTopics: ["top"], onTopicChange: d }),
    /* @__PURE__ */ n.jsx("div", { className: "flex w-full flex-col", children: /* @__PURE__ */ n.jsx("div", { className: "w-full", children: r.length > 0 ? /* @__PURE__ */ n.jsx("div", { className: "my-4", children: /* @__PURE__ */ n.jsx("div", { className: "mx-auto flex min-h-[calc(100dvh_-_117px)] items-start gap-11", children: /* @__PURE__ */ n.jsx("div", { className: "flex w-full min-w-0 flex-col items-center", children: /* @__PURE__ */ n.jsxs("div", { className: "flex w-full min-w-0 flex-col items-start", children: [
            ...
            children: [
              /* @__PURE__ */ n.jsx(
                cn,
                {
                  ...
                  type: k.type,
                  onClick: () => {
                    p(`/reader/${encodeURIComponent(k.id)}`);
                  }
                }
              ),
              g < r.length - 1 && /* @__PURE__ */ n.jsx(Se, {}),
              g === Q && /* @__PURE__ */ n.jsx("div", { ref: z, className: "h-1" })
            ]
          },
          `${k.id}-${k.type}-${g}`
        )),
        h && /* @__PURE__ */ n.jsx("li", { className: "flex flex-col items-center justify-center gap-4 text-center", children: /* @__PURE__ */ n.jsx(mn, { size: "md" }) })
      ] }),
      ...
      kn,
      {
        actions: q ? /* @__PURE__ */ n.jsx($, { onClick: () => p("/explore"), children: "Find accounts to follow →" }) : /* @__PURE__ */ n.jsx($, { asChild: !0, children: /* @__PURE__ */ n.jsx("a", { href: "https://explore.ghost.org/social-web", rel: "noopener noreferrer", target: "_blank", children: "Find accounts to follow →" }) }),
    ...
    /* @__PURE__ */ n.jsx(
      he,
      {
        ...
        children: /* @__PURE__ */ n.jsxs(me, { className: "inset-y-3 h-[calc(100vh-24px)] w-screen max-w-[calc(100vw-24px)] animate-none! p-0 focus:outline-hidden dark:bg-gray-950", children: [
          /* @__PURE__ */ n.jsxs(ke, { className: "hidden", children: [
            /* @__PURE__ */ n.jsx(fe, { children: "Reader" }),
            /* @__PURE__ */ n.jsx(be, { children: "Ghost reader for long form articles" })
          ] }),
          c.postId && /* @__PURE__ */ n.jsx(Nt, { postId: c.postId, onClose: () => {
            x ? u() : p("/reader");
          } })
        ] })
      }
  ...
  const [t, r] = y("following"), { inboxQuery: a } = xe({ enabled: t === "following" }), { discoveryFeedQuery: s } = ve({ enabled: t !== "following", topic: t }), i = t === "following" ? a : s, { data: h, error: d, fetchNextPage: p, hasNextPage: x, isFetchingNextPage: u, isLoading: o } = i, l = d && Cn(d) && d.statusCode === 404 && t !== "following";
  if (d && Cn(d) && !l)
    return /* @__PURE__ */ n.jsx(ye, { errorCode: d.code, statusCode: d.statusCode });
  const c = l ? [] : h?.pages.flatMap((E) => E.posts) ?? Array.from({ length: 5 }, (E, L) => ({ id: `placeholder-${L}`, object: {} }));
  return /* @__PURE__ */ n.jsx(
    It,
    {
      activities: c,
...
//# sourceMappingURL=index-BAiZ4YZQ.mjs.map
