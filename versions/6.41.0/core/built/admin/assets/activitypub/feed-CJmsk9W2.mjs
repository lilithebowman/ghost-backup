import { j as e, az as k, A as N, c as p, d as y, b, aA as P, e as _, H as z, B as f, aB as R, C as B, aa as I, S as w, P as M, ab as W, L as A, F as E, i as U, k as $, E as D, f as H, aC as O, aD as Q, aE as V, aF as G, aG as T } from "./index-iRncUrZR.mjs";
import { S as C } from "./separator-BhXvs9Vo.mjs";
import { H as X } from "./hash-DYOzyaoU.mjs";
const v = ({ user: l }) => /* @__PURE__ */ e.jsx(k, { children: /* @__PURE__ */ e.jsxs("div", { className: "relative my-5 w-full hover:cursor-pointer", children: [
  /* @__PURE__ */ e.jsx("div", { className: "pointer-events-none absolute top-4 left-4", children: /* @__PURE__ */ e.jsx(N, { author: l }) }),
  ...
  const l = p(null), o = y(), [c, d] = b(!1), [x, i] = b(!0), { suggestedProfilesQuery: m, updateSuggestedProfile: r } = P("index", 10), { data: n = [], isLoading: a } = m, h = () => {
    const s = l.current;
    if (!s)
      return;
  ...
  return /* @__PURE__ */ e.jsxs(e.Fragment, { children: [
    /* @__PURE__ */ e.jsxs("div", { className: "pt-4 pb-7", children: [
      /* @__PURE__ */ e.jsxs("div", { className: "mb-3 flex items-center justify-between", children: [
        /* @__PURE__ */ e.jsx(z, { className: "text-lg font-semibold text-black dark:text-white", children: "More people to follow" }),
      ...
      /* @__PURE__ */ e.jsxs("div", { className: "relative", children: [
        ...
        x && /* @__PURE__ */ e.jsx(
          f,
          {
            ...
            variant: "ghost",
            onClick: L,
            children: /* @__PURE__ */ e.jsx(B, { className: "size-6!" })
          }
        ),
        /* @__PURE__ */ e.jsx(
          "div",
              ...
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ e.jsxs("div", { className: "flex flex-col items-center text-center", children: [
                    /* @__PURE__ */ e.jsx("div", { className: "mb-3", children: a ? /* @__PURE__ */ e.jsx(w, { className: "size-16 rounded-full" }) : /* @__PURE__ */ e.jsx(M, { actor: s, align: "center", children: /* @__PURE__ */ e.jsx("div", { children: /* @__PURE__ */ e.jsx(
                      N,
                      {
                        author: {
                    ...
                    /* @__PURE__ */ e.jsx("span", { className: "mb-6 w-full truncate font-semibold text-black dark:text-white", children: a ? /* @__PURE__ */ e.jsx(w, { className: "h-5 w-32" }) : s?.name || "" }),
                    a ? /* @__PURE__ */ e.jsx(w, { className: "h-8 w-16" }) : /* @__PURE__ */ e.jsx(
                      W,
                      {
  ...
  return /* @__PURE__ */ e.jsx(A, { children: /* @__PURE__ */ e.jsx("div", { className: "flex w-full flex-col", children: /* @__PURE__ */ e.jsx("div", { className: "w-full", children: o.length > 0 ? /* @__PURE__ */ e.jsx("div", { className: "my-4", children: /* @__PURE__ */ e.jsx("div", { className: "mx-auto flex items-start gap-11", children: /* @__PURE__ */ e.jsx("div", { className: "flex w-full min-w-0 flex-col items-center", children: /* @__PURE__ */ e.jsxs("div", { className: "flex w-full max-w-[620px] min-w-0 flex-col items-start", children: [
      ...
      o.map((t, u) => /* @__PURE__ */ e.jsxs(
        "li",
        {
          ...
          children: [
            ...
            u === 3 && /* @__PURE__ */ e.jsx(q, {}),
            u === h && /* @__PURE__ */ e.jsx("div", { ref: n, className: "h-1" })
          ]
        },
        `${t.id}-${t.type}-${u}`
      )),
      i && /* @__PURE__ */ e.jsx("li", { className: "flex flex-col items-center justify-center gap-4 text-center", children: /* @__PURE__ */ e.jsx($, { size: "md" }) })
    ] }),
    ...
    /* @__PURE__ */ e.jsx("div", { className: "mt-[-128px]", children: /* @__PURE__ */ e.jsxs(D, { children: [
      ...
      /* @__PURE__ */ e.jsx(k, { children: /* @__PURE__ */ e.jsxs(f, { className: "text-white dark:text-black", children: [
        /* @__PURE__ */ e.jsx(O, {}),
  ...
  const { feedQuery: l } = Q({ enabled: !0 }), { data: o, error: c, fetchNextPage: d, hasNextPage: x, isFetchingNextPage: i, isLoading: m } = l, r = o?.pages.flatMap((a) => a.posts) ?? Array.from({ length: 5 }, (a, h) => ({ id: `placeholder-${h}`, object: {} })), { data: n } = V("index");
  return c && G(c) ? /* @__PURE__ */ e.jsx(T, { errorCode: c.code, statusCode: c.statusCode }) : /* @__PURE__ */ e.jsx(
    J,
    {
      activities: r,
      fetchNextPage: d,
...
//# sourceMappingURL=feed-CJmsk9W2.mjs.map
