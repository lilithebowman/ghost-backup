import { c as Me, f as R, j as e, S as Ae, a as x, R as D, u as ie, b as q, d as L, e as W, g as ne, h as g, i as J, k as Z, l as ee, m as A, A as Le } from "./index-BaZyVSji.mjs";
import { B as T, X as De, C as $e, a as Ee, L as Re, H as le, b as F, c as S, d as I, e as B, f as H, S as y, g as We, P as Fe, h as Se, G as E, U as oe, M as Y, i as Ie, E as X, F as ce, j as Be, T as He, k as Pe, l as Ve, m as V, n as Oe, o as K, p as Q, q as Ue, I as Ge, r as Ye, s as se, t as te, u as Ke, v as Qe, w as qe, x as Xe, y as Je, z as $, A as Ze, D as O, J as es, K as ss, N as ts, O as as, Q as rs, R as is } from "./stats-B-gFnH1Q.mjs";
import { R as ns, T as ls, P as os, C as de, a as me, D as ue, O as xe, g as he, b as cs } from "./audience-DNHbvZ_-.mjs";
import { u as ds } from "./use-growth-stats-Ro09fx4n.mjs";
...
const js = ns, bs = ls, vs = os, fe = R(({ className: s, ...a }, t) => /* @__PURE__ */ e.jsx(
  xe,
  {
    ref: t,
    className: x(
...
fe.displayName = xe.displayName;
const ge = R(({ className: s, children: a, ...t }, r) => /* @__PURE__ */ e.jsx(vs, { children: /* @__PURE__ */ e.jsxs("div", { className: Ae, children: [
  /* @__PURE__ */ e.jsx(fe, {}),
  /* @__PURE__ */ e.jsx(
    de,
    {
...
const ye = D.forwardRef(({ className: s, ...a }, t) => /* @__PURE__ */ e.jsx(
  ...
  {
    ref: t,
    className: x("max-h-[calc(100vh-16vmin)] max-w-[540px] overflow-y-auto p-8", s),
    ...a
  }
));
...
const Ce = D.forwardRef(({
  ...
  {
    ref: l,
    className: x("flex flex-col items-stretch overflow-hidden border transition-all hover:border-muted-foreground/40", s),
    href: a,
    rel: t,
    target: r,
    ...i
...
function _s({ className: s, layout: a = "footer", links: t, ...r }) {
  return a === "stacked" ? /* @__PURE__ */ e.jsx("div", { className: x("flex gap-2", s), ...r, children: t.map((i) => /* @__PURE__ */ e.jsx(T, { className: "flex-1", id: i.id, variant: "outline", asChild: !0, children: /* @__PURE__ */ e.jsxs("a", { "aria-label": i.label, href: i.href, rel: "noreferrer", target: "_blank", title: i.title || i.label, children: [
    /* @__PURE__ */ e.jsx(ae, { service: i.service }),
    /* @__PURE__ */ e.jsx("span", { className: "sr-only", children: i.label })
  ] }) }, i.id ?? i.href)) }) : /* @__PURE__ */ e.jsx("div", { className: x("flex items-center gap-2", s), ...r, children: t.map((i) => /* @__PURE__ */ e.jsx("a", { "aria-label": i.label, className: "flex h-(--control-height) w-14 items-center justify-center rounded-xs bg-muted px-3 hover:bg-muted-foreground/20 [&_svg]:h-4", href: i.href, rel: "noopener noreferrer", target: "_blank", title: i.title || i.label, children: /* @__PURE__ */ e.jsx(ae, { service: i.service }) }, i.id ?? i.href)) });
}
function zs({
  children: s,
  copyURL: a,
  ...
  return /* @__PURE__ */ e.jsx(
    T,
    {
      ...
      ...c,
      children: s || /* @__PURE__ */ e.jsxs(e.Fragment, { children: [
        o ? /* @__PURE__ */ e.jsx($e, {}) : /* @__PURE__ */ e.jsx(h, {}),
        o ? m : i
      ] })
    }
  );
...
function Ts({ className: s, ...a }) {
  return /* @__PURE__ */ e.jsx(
    be,
    {
      className: x("justify-between gap-6", s),
      ...a
    }
  );
}
const k = {
  ...
  secondaryTitle: h = "Spread the word!",
  siteTitle: n = "",
  ...p
}) => {
  const j = encodeURIComponent(o), f = encodeURIComponent(u), w = encodeURIComponent(`${o} ${u}`), C = r ? [] : [
    {
      href: `https://twitter.com/intent/tweet?text=${j}%0A${f}`,
      label: "Share on X",
      service: "x"
    },
    {
    ...
    {
      href: `https://www.facebook.com/sharer/sharer.php?u=${f}`,
      label: "Share on Facebook",
      service: "facebook"
    },
    {
      href: `https://www.linkedin.com/shareArticle?mini=true&title=${j}&url=${f}`,
    ...
    /* @__PURE__ */ e.jsxs(k.Content, { children: [
      ...
      /* @__PURE__ */ e.jsxs(k.Header, { className: "relative -mt-5", children: [
        /* @__PURE__ */ e.jsxs(k.Title, { className: "text-3xl leading-[1.15em] font-bold", children: [
          ...
          d && h && /* @__PURE__ */ e.jsx("br", {}),
          h && /* @__PURE__ */ e.jsx("span", { children: h })
        ] }),
  ...
  const t = q(), [r, i] = ie(!1), { site: l, settings: m } = L(), { appSettings: c } = W(), {
    ...
    emailTrackOpens: u,
    webAnalytics: d = !1,
    membersTrackSources: h = !1
  } = c?.analytics || {}, n = l.title || String(m.find((N) => N.key === "title")?.value || "Ghost Site"), p = String(m.find((N) => N.key === "timezone")?.value || "Etc/UTC"), j = s ? gs(s, {
    membersTrackSources: h
  }) : null, f = "group mr-2 flex flex-col gap-1.5 hover:cursor-pointer", w = !!s?.email, C = he({ postId: s?.id, hasEmailData: w, analytics: { webAnalytics: d, membersTrackSources: h } }), _ = C.startsWith("/editor/");
  return /* @__PURE__ */ e.jsxs(F, { className: "group/card bg-gradient-to-tr from-muted/40 to-muted/0 to-50%", "data-testid": "latest-post", children: [
    /* @__PURE__ */ e.jsxs(S, { children: [
      /* @__PURE__ */ e.jsx(I, { className: "flex items-baseline justify-between leading-snug font-medium text-muted-foreground", children: "Latest post performance" }),
      /* @__PURE__ */ e.jsx(B, { className: "hidden", children: "How your last post did" })
    ] }),
    /* @__PURE__ */ e.jsxs(H, { className: "flex flex-col gap-6 px-0 lg:flex-row xl:grid xl:grid-cols-3", children: [
      ...
      !a && s && j ? /* @__PURE__ */ e.jsxs(e.Fragment, { children: [
        ...
        /* @__PURE__ */ e.jsx("div", { className: "-ml-4 flex w-full flex-col items-stretch gap-2 pr-6 text-sm xl:h-full xl:max-w-none", children: /* @__PURE__ */ e.jsxs("div", { className: "grid grid-cols-2 gap-6 pl-10 lg:border-l xl:h-full", children: [
          j.showWebMetrics && d && /* @__PURE__ */ e.jsxs("div", { className: f, "data-testid": "latest-post-visitors", onClick: () => {
            ...
            /* @__PURE__ */ e.jsx("span", { className: "text-[2.2rem] leading-none font-semibold tracking-tighter", children: g(s.visitors) })
          ] }),
          j.showMemberGrowth && /* @__PURE__ */ e.jsxs("div", { className: x(
            f,
          ...
          j.showEmailMetrics && s.email && /* @__PURE__ */ e.jsxs(e.Fragment, { children: [
            u && /* @__PURE__ */ e.jsxs("div", { className: f, onClick: () => {
            ...
            o && /* @__PURE__ */ e.jsxs("div", { className: f, onClick: () => {
              t(`/posts/analytics/${s.id}/newsletter`, { crossApp: !0 });
            }, children: [
              /* @__PURE__ */ e.jsxs("div", { className: "flex items-center gap-1.5 font-medium text-muted-foreground transition-all group-hover:text-foreground", children: [
...
), $s = ({ children: s, className: a, color: t, ...r }) => /* @__PURE__ */ e.jsxs("div", { className: x("flex h-[22px] items-center gap-1.5 text-base font-medium text-muted-foreground [&_svg]:size-4", a), ...r, children: [
  ...
  const { range: d } = L(), h = a && Ue[a], n = D.useMemo(() => {
    if (!i || i === "empty" || d === Z.allTime.value || !l)
      return "";
    const p = i === "up" ? "up" : i === "down" ? "down" : "at", f = Q(d).replace("in the ", "").replace(/^\(|\)$/g, "");
    return i === "same" ? /* @__PURE__ */ e.jsxs("span", { children: [
      ...
      " compared to the ",
      /* @__PURE__ */ e.jsx("span", { className: "font-semibold", children: f })
    ...
    /* @__PURE__ */ e.jsxs(Ds, { className: "relative flex grow flex-row items-start justify-between gap-5 border-none pb-2 xl:pb-4", children: [
      /* @__PURE__ */ e.jsxs("div", { className: "flex grow flex-col gap-1.5 border-none pb-0", children: [
        /* @__PURE__ */ e.jsxs($s, { className: u && "transition-all group-hover:text-foreground", children: [
          ...
          h && /* @__PURE__ */ e.jsx(h, { size: 16, strokeWidth: 1.5 }),
          s
        ] }),
        /* @__PURE__ */ e.jsx(
          Es,
  ...
  if (c)
    return /* @__PURE__ */ e.jsx(Pe, { className: "flex h-[calc(10vw+116px)] max-h-[416px] min-h-20 items-center justify-center hover:cursor-pointer!", children: /* @__PURE__ */ e.jsx(Ve, {}) });
  const j = d?.analytics.webAnalytics, f = n && !j, w = !0, C = d?.paidMembersEnabled, _ = [j, f, w, C].filter(Boolean).length;
  let N = "lg:grid-cols-3";
  _ === 2 ? N = "lg:grid-cols-2" : _ === 1 && (N = "lg:grid-cols-1");
  const P = `flex flex-col lg:grid ${N} gap-6`;
  return /* @__PURE__ */ e.jsxs("div", { className: P, children: [
    ...
    f && /* @__PURE__ */ e.jsxs(F, { children: [
      /* @__PURE__ */ e.jsxs(S, { className: "hidden", children: [
        /* @__PURE__ */ e.jsx(I, { children: "Unlock web analytics" }),
        /* @__PURE__ */ e.jsx(B, { children: "Get the full picture of what's working with detailed, cookie-free traffic analytics." })
      ] }),
      /* @__PURE__ */ e.jsx(H, { className: "flex h-full items-center justify-center p-6", children: /* @__PURE__ */ e.jsx(
        X,
        {
    ...
    /* @__PURE__ */ e.jsx(
      U,
      {
        ...
        formattedValue: g(r.totalMembers),
        iconName: "User",
        linkto: "/analytics/growth/",
        title: "Members",
        trendingFromValue: `${g(i[0].value)}`,
        onClick: () => {
    ...
    C && /* @__PURE__ */ e.jsx(
      U,
      {
        ...
        formattedValue: `${m}${g(K(r.mrr))}`,
        iconName: "Coins",
        linkto: "/analytics/growth/",
        title: "MRR",
        trendingFromValue: `${m}${g(l[0].value)}`,
        onClick: () => {
  ...
  className: s
}) => /* @__PURE__ */ e.jsx("div", { className: x("rounded-sm bg-muted dark:bg-[#36373a] flex flex-col items-center justify-center gap-1 p-6", s), children: /* @__PURE__ */ e.jsx(Ge, { className: "text-muted-foreground/50", size: 18, strokeWidth: 1.5 }) }), G = ({
  className: s,
  metrics: a,
  title: t
}) => /* @__PURE__ */ e.jsx(e.Fragment, { children: /* @__PURE__ */ e.jsxs("div", { className: x("pointer-events-none absolute bottom-[calc(100%+2px)] left-1/2 z-50 min-w-[160px] -translate-x-1/2 rounded-md bg-background p-3 text-sm opacity-0 shadow-md transition-all group-hover/tooltip:bottom-[calc(100%+12px)] group-hover/tooltip:opacity-100", s), children: [
  ...
  const t = q(), { range: r, settings: i } = L(), { appSettings: l } = W(), m = String(i.find((n) => n.key === "timezone")?.value || "Etc/UTC"), {
    ...
    emailTrackOpens: d = !1
  } = l?.analytics || {}, h = "flex items-center justify-end gap-1 rounded-md px-2 py-1 font-mono text-gray-800 hover:bg-muted-foreground/10 group-hover:text-foreground";
  return /* @__PURE__ */ e.jsxs(F, { className: "group/card w-full lg:col-span-2", "data-testid": "top-posts-card", children: [
    /* @__PURE__ */ e.jsxs(S, { children: [
      /* @__PURE__ */ e.jsxs(I, { className: "flex items-baseline justify-between leading-snug  font-medium text-muted-foreground", children: [
        "Top posts ",
        Q(r)
      ] }),
      /* @__PURE__ */ e.jsx(B, { className: "hidden", children: "Most viewed posts in this period" })
    ] }),
    /* @__PURE__ */ e.jsx(H, { children: a ? /* @__PURE__ */ e.jsx(Ye, { className: "mt-6" }) : /* @__PURE__ */ e.jsxs(e.Fragment, { children: [
      s?.stats?.map((n) => /* @__PURE__ */ e.jsxs("div", { className: 'group relative flex w-full items-start justify-between gap-5 border-t border-border/50 py-4 before:absolute before:-inset-x-4 before:inset-y-0 before:z-0 before:hidden before:rounded-md before:bg-accent before:opacity-80 before:content-[""] first:border-border! hover:cursor-pointer hover:border-transparent hover:before:block md:items-center dark:before:bg-accent/50 [&+div]:hover:border-transparent', children: [
        /* @__PURE__ */ e.jsxs("div", { className: "z-10 flex min-w-[160px] grow items-start gap-4 md:items-center lg:min-w-[320px]", onClick: () => {
          ...
          /* @__PURE__ */ e.jsxs("div", { className: "flex flex-col", children: [
            /* @__PURE__ */ e.jsx("span", { className: "line-clamp-2 text-lg leading-[1.35em] font-semibold", children: n.title }),
            ...
            /* @__PURE__ */ e.jsx("span", { className: "text-sm text-muted-foreground", children: xs(n) })
          ] })
        ] }),
              ...
              G,
              {
                ...
                metrics: [
                  ...
                  ...u ? [{
                    ...
                    label: "Clicks",
                    metric: g(n.clicked_count || 0)
                  }] : []
                ],
                title: "Newsletter performance"
              }
            ),
            /* @__PURE__ */ e.jsx("div", { className: h, children: d ? /* @__PURE__ */ e.jsxs(e.Fragment, { children: [
                ...
                metrics: [
                  {
                    ...
                    label: "Free",
                    metric: n.free_members > 0 ? `+${g(n.free_members)}` : "0"
                  },
                  ...
                  ...l?.paidMembersEnabled ? [{
                    ...
                    label: "Paid",
                    metric: n.paid_members > 0 ? `+${g(n.paid_members)}` : "0"
                  }] : []
                ],
                title: "New members"
              }
  ...
  const { appSettings: s } = W(), { statsConfig: a, isLoading: t, range: r } = L(), { startDate: i, endDate: l, timezone: m } = Xe(r), { isLoading: c, chartData: o, totals: u, currencySymbol: d } = ds(r), { data: h, isLoading: n } = Is(), { data: p, isLoading: j } = Je({
    searchParams: {
      date_from: $(i),
      date_to: $(l),
      limit: "5",
    ...
    return v = O(o, r, "value", "exact"), v.map((b) => ({
      date: b.date,
      value: b.free + b.paid,
      formattedValue: g(b.free + b.paid),
      label: "Members"
    }));
  }, [o, r]), _e = A(() => {
...
//# sourceMappingURL=index-jP4A4tTY.mjs.map
