"use strict";(globalThis.webpackChunk_ember_auto_import_=globalThis.webpackChunk_ember_auto_import_||[]).push([[864],{81864(t,e,i){i.d(e,{Ay:()=>qf})
var n=i(58070),s=i(22585),o=i(14523)
let r=[],l=[]
...
class Ie extends Et{constructor(t,e){super(),this.tagName=t,this.attributes=e}eq(t){return t==this||t instanceof Ie&&this.tagName==t.tagName&&Se(this.attributes,t.attributes)}static create(t){return new Ie(t.tagName,t.attributes||ke)}static set(t,e=!1){return Pt.of(t,e)}}function Pe(t){let e
...
for(let _f of["()","[]","{}"]){let t=_f.charCodeAt(0),e=_f.charCodeAt(1)
...
class Pi{constructor(t,e="nearest",i="nearest",n=5,s=5,o=!1){this.range=t,this.y=e,this.x=i,this.yMargin=n,this.xMargin=s,this.isSnapshot=o}map(t){return t.empty?this:new Pi(this.range.map(t),this.y,this.x,this.yMargin,this.xMargin,this.isSnapshot)}clip(t){return this.range.to<=t.doc.length?this:new Pi(q.cursor(t.doc.length),this.y,this.x,this.yMargin,this.xMargin,this.isSnapshot)}}const Ni=vt.define({map:(t,e)=>t.map(e)}),Wi=vt.define()
...
o.flags|=8,n.append(o)}addInlineWidget(t,e,i){let n=this.afterWidget&&48&t.flags&&(48&this.afterWidget.flags)==(48&t.flags)
n||this.flushBuffer()
...
for(let t=this.blockWrappers;t.value&&t.from<=this.pos;t.next())if(t.to>=this.pos){let e=new vn(t.from,t.to,t.value,t.rank),i=this.wrappers.length
for(;i>0&&(this.wrappers[i-1].rank-e.rank||this.wrappers[i-1].to-e.to)<0;)i--
this.wrappers.splice(i,0,e)}this.wrapperPos=this.pos}getBlockPos(){var t
...
for(let _f=0;_f<yn.length;_f++)yn[_f].bucket=_f
...
if("nearest"==s)e.top<t.top?(g=e.top-(t.top+r),i>0&&e.bottom>t.bottom+g&&(g=e.bottom-t.bottom+r)):e.bottom>t.bottom&&(g=e.bottom-t.bottom+r,i<0&&e.top-g<t.top&&(g=e.top-(t.top+r)))
else{let n=e.bottom-e.top,o=t.bottom-t.top
g=("center"==s&&n<=o?e.top+n/2-o/2:"start"==s||"center"==s&&i<0?e.top-r:e.bottom-o+r)-t.top}if("nearest"==n?e.left<t.left?(m=e.left-(t.left+o),i>0&&e.right>t.right+m&&(m=e.right-t.right+o)):e.right>t.right&&(m=e.right-t.right+o,i<0&&e.left<t.left+m&&(m=e.left-(t.left+o))):m=("center"==n?e.left+(e.right-e.left)/2-(t.right-t.left)/2:"start"==n==l?e.left-o:e.right-(t.right-t.left)+o)-t.left,m||g)if(d)h.scrollBy(m,g)
else{let t=0,i=0
...
return i.length>1||i.length&&(i[0].level!=this.baseDir||i[0].to+n.from<e)}scan(t,e){let i,n,s,o=0,r=t.length-1,l=new Set,a=this.bidiIn(t[0],t[r]),h=-1,c=1e9
t:for(;o<r;){let u=r-o,d=o+r>>1
e:if(l.has(d)){let t=o+Math.floor(Math.random()*u)
for(let e=0;e<u;e++){if(!l.has(t)){d=t
break e}t++,t==r&&(t=o)}break t}l.add(d)
let f=e(d)
if(f)for(let e=0;e<f.length;e++){let l=f[e],u=0
if(!(0==l.width&&f.length>1)){if(l.bottom<this.y)(!i||i.bottom<l.bottom)&&(i=l),u=1
else if(l.top>this.y)(!n||n.top>l.top)&&(n=l),u=-1
else{let t=l.left>this.x?this.x-l.left:l.right<this.x?this.x-l.right:0,e=Math.abs(t)
e<c&&(h=d,c=e,s=l),t&&(u=t<0==(this.baseDir==si.LTR)?-1:1)}-1!=u||a&&!this.baseDirAt(t[d],1)?1!=u||a&&!this.baseDirAt(t[d+1],-1)||(o=d+1):r=d}}}if(!s){let s=i&&(!n||this.y-i.bottom<n.top-this.y)?i:n
return this.y=(s.top+s.bottom)/2,this.scan(t,e)}let u=(a?this.dirAt(t[h],1):this.baseDir)==si.LTR
return{i:h,after:this.x>(s.left+s.right)/2==u}}scanText(t,e){let i=[]
...
n<0?i++:this.heightSamples[Math.floor(10*n)]||(e=!0,this.heightSamples[Math.floor(10*n)]=!0)}return e}refresh(t,e,i,n,s,o){let r=Ss.indexOf(t)>-1,l=Math.abs(e-this.lineHeight)>.3||this.lineWrapping!=r||Math.abs(i-this.charWidth)>.1
...
this.plugins=[],this.inputState.destroy(),this.docView.destroy(),this.dom.remove(),this.observer.destroy(),this.measureScheduled>-1&&this.win.cancelAnimationFrame(this.measureScheduled),this.destroyed=!0}static scrollIntoView(t,e={}){return Ni.of(new Pi("number"==typeof t?q.cursor(t):t,e.y,e.x,e.yMargin,e.xMargin))}scrollSnapshot(){let{scrollTop:t,scrollLeft:e}=this.scrollDOM,i=this.viewState.scrollAnchorAt(t)
...
e.remove(),e=t}this.drawn=t,ye.safari&&ye.safari_version>=26&&(this.dom.style.display=this.dom.firstChild?"":"none")}}destroy(){this.layer.destroy&&this.layer.destroy(this.dom,this.view),this.dom.remove()}}const Bo=j.define()
...
return null!==(e=t.end)&&void 0!==e?e:t.pos})),create:mr.create,above:e[0].above,arrow:e.some(t=>t.arrow)}})
class vr{constructor(t,e,i,n,s){this.view=t,this.source=e,this.field=i,this.setHover=n,this.hoverTime=s,this.hoverTimeout=-1,this.restartTimeout=-1,this.pending=null,this.lastMove={x:0,y:0,target:t.dom,time:0},this.checkHover=this.checkHover.bind(this),t.dom.addEventListener("mouseleave",this.mouseleave=this.mouseleave.bind(this)),t.dom.addEventListener("mousemove",this.mousemove=this.mousemove.bind(this))}update(){this.pending&&(this.pending=null,clearTimeout(this.restartTimeout),this.restartTimeout=setTimeout(()=>this.startHover(),20))}get active(){return this.view.state.field(this.field)}checkHover(){if(this.hoverTimeout=-1,this.active.length)return
...
s=e.x<i.left?-r:r}let o=this.source(t,n,s)
if(null==o?void 0:o.then){let e=this.pending={pos:n}
o.then(i=>{this.pending==e&&(this.pending=null,!i||Array.isArray(i)&&!i.length||t.dispatch({effects:this.setHover.of(Array.isArray(i)?i:[i])}))},e=>Hi(t.state,e,"hover tooltip"))}else!o||Array.isArray(o)&&!o.length||t.dispatch({effects:this.setHover.of(Array.isArray(o)?o:[o])})}get tooltip(){let t=this.view.plugin(cr),e=t?t.manager.tooltips.findIndex(t=>t.create==mr.create):-1
...
if(n.length&&s&&!function(t,e){let i,{left:n,right:s,top:o,bottom:r}=t.getBoundingClientRect()
...
t.addEventListener("mouseleave",e)}destroy(){clearTimeout(this.hoverTimeout),clearTimeout(this.restartTimeout),this.view.dom.removeEventListener("mouseleave",this.mouseleave),this.view.dom.removeEventListener("mousemove",this.mousemove)}}function wr(t,e){let i=t.plugin(cr)
if(!i)return null
let n=i.manager.tooltips.indexOf(e)
return n<0?null:i.manager.tooltipViews[n]}const br=vt.define(),yr=j.define({combine(t){let e,i
for(let n of t)e=e||n.topContainer,i=i||n.bottomContainer
return{topContainer:e,bottomContainer:i}}})
function xr(t,e){let i=t.plugin(kr),n=i?i.specs.indexOf(e):-1
return n>-1?i.panels[n]:null}const kr=qi.fromClass(class{constructor(t){this.input=t.state.facet(Mr),this.specs=this.input.filter(t=>t),this.panels=this.specs.map(e=>e(t))
let e=t.state.facet(yr)
this.top=new Sr(t,!0,e.topContainer),this.bottom=new Sr(t,!1,e.bottomContainer),this.top.sync(this.panels.filter(t=>t.top)),this.bottom.sync(this.panels.filter(t=>!t.top))
for(let i of this.panels)i.dom.classList.add("cm-panel"),i.mount&&i.mount()}update(t){let e=t.state.facet(yr)
this.top.container!=e.topContainer&&(this.top.sync([]),this.top=new Sr(t.view,!0,e.topContainer)),this.bottom.container!=e.bottomContainer&&(this.bottom.sync([]),this.bottom=new Sr(t.view,!1,e.bottomContainer)),this.top.syncClasses(),this.bottom.syncClasses()
let i=t.state.facet(Mr)
...
class Sr{constructor(t,e,i){this.view=t,this.top=e,this.container=i,this.dom=void 0,this.classes="",this.panels=[],this.syncClasses()}sync(t){for(let e of this.panels)e.destroy&&t.indexOf(e)<0&&e.destroy()
...
for(let e of this.panels)if(e.dom.parentNode==this.dom){for(;t!=e.dom;)t=Cr(t)
t=t.nextSibling}else this.dom.insertBefore(e.dom,t)
for(;t;)t=Cr(t)}scrollMargin(){return!this.dom||this.container?0:Math.max(0,this.top?this.dom.getBoundingClientRect().bottom-Math.max(0,this.view.scrollDOM.getBoundingClientRect().top):Math.min(innerHeight,this.view.scrollDOM.getBoundingClientRect().bottom)-this.dom.getBoundingClientRect().top)}syncClasses(){if(this.container&&this.classes!=this.view.themeClasses){for(let t of this.classes.split(" "))t&&this.container.classList.remove(t)
for(let t of(this.classes=this.view.themeClasses).split(" "))t&&this.container.classList.add(t)}}}function Cr(t){let e=t.nextSibling
return t.remove(),e}const Mr=j.define({enables:kr}),Ar=Q.define({create:()=>[],update(t,e){for(let i of e.effects)i.is(Tr)?t=[i.value].concat(t):i.is(Or)&&(t=t.filter(t=>t!=i.value))
return t},provide:t=>Mr.computeN([t],e=>e.field(t))}),Tr=vt.define(),Or=vt.define()
class Dr extends Et{compare(t){return this==t||this.constructor==t.constructor&&this.eq(t)}eq(t){return!1}destroy(t){}}Dr.prototype.elementClass="",Dr.prototype.toDOM=void 0,Dr.prototype.mapMode=R.TrackBefore,Dr.prototype.startSide=Dr.prototype.endSide=-1,Dr.prototype.point=!0
const Er=j.define(),Br=j.define(),Rr={class:"",renderEmptyElements:!1,elementStyle:"",markers:()=>Pt.empty,lineMarker:()=>null,widgetMarker:()=>null,lineMarkerChange:null,initialSpacer:null,updateSpacer:null,domEventHandlers:{},side:"before"},Lr=j.define()
function Ir(t){return[Nr(),Lr.of({...Rr,...t})]}const Pr=j.define({combine:t=>t.some(t=>t)})
function Nr(t){let e=[Wr]
return t&&!1===t.fixed&&e.push(Pr.of(!0)),e}const Wr=qi.fromClass(class{constructor(t){this.view=t,this.domAfter=null,this.prevViewport=t.viewport,this.dom=document.createElement("div"),this.dom.className="cm-gutters cm-gutters-before",this.dom.setAttribute("aria-hidden","true"),this.dom.style.minHeight=this.view.contentHeight/this.view.scaleY+"px",this.gutters=t.state.facet(Lr).map(e=>new zr(t,e)),this.fixed=!t.state.facet(Pr)
...
this.dom.style.minHeight=t,this.domAfter&&(this.domAfter.style.minHeight=t)}this.view.state.facet(Pr)!=!this.fixed&&(this.fixed=!this.fixed,this.dom.style.position=this.fixed?"sticky":"",this.domAfter&&(this.domAfter.style.position=this.fixed?"sticky":"")),this.prevViewport=t.view.viewport}syncGutters(t){let e=this.dom.nextSibling
t&&(this.dom.remove(),this.domAfter&&this.domAfter.remove())
let i=Pt.iter(this.view.state.facet(Er),this.view.viewport.from),n=[],s=this.gutters.map(t=>new Fr(t,this.view.viewport,-this.view.documentPadding.top))
for(let o of this.view.viewportLineBlocks)if(n.length&&(n=[]),Array.isArray(o.type)){let t=!0
for(let e of o.type)if(e.type==Te.Text&&t){Vr(i,n,e.from)
for(let t of s)t.line(this.view,e,n)
t=!1}else if(e.widget)for(let t of s)t.widget(this.view,e)}else if(o.type==Te.Text){Vr(i,n,o.from)
for(let t of s)t.line(this.view,o,n)}else if(o.widget)for(let t of s)t.widget(this.view,o)
for(let o of s)o.finish()
t&&(this.view.scrollDOM.insertBefore(this.dom,e),this.domAfter&&this.view.scrollDOM.appendChild(this.domAfter))}updateGutters(t){let e=t.startState.facet(Lr),i=t.state.facet(Lr),n=t.docChanged||t.heightChanged||t.viewportChanged||!Pt.eq(t.startState.facet(Er),t.state.facet(Er),t.view.viewport.from,t.view.viewport.to)
if(e==i)for(let s of this.gutters)s.update(t)&&(n=!0)
else{n=!0
let s=[]
for(let n of i){let i=e.indexOf(n)
i<0?s.push(new zr(this.view,n)):(this.gutters[i].update(t),s.push(this.gutters[i]))}for(let t of this.gutters)t.dom.remove(),s.indexOf(t)<0&&t.destroy()
...
function Hr(t){return Array.isArray(t)?t:[t]}function Vr(t,e,i){for(;t.value&&t.from<=i;)t.from==i&&e.push(t.value),t.next()}class Fr{constructor(t,e,i){this.gutter=t,this.height=i,this.i=0,this.cursor=Pt.iter(t.markers,e.from)}addElement(t,e,i){let{gutter:n}=this,s=(e.top-this.height)/t.scaleY,o=e.height/t.scaleY
if(this.i==n.elements.length){let e=new qr(t,o,s,i)
...
Vr(this.cursor,n,e.from),i.length&&(n=n.concat(i))
...
for(let s of t.state.facet(Br)){let i=s(t,e.widget,e)
i&&(n||(n=[])).push(i)}n&&this.addElement(t,e,n)}finish(){let t=this.gutter
for(;t.elements.length>this.i;){let e=t.elements.pop()
t.dom.removeChild(e.dom),e.destroy()}}}class zr{constructor(t,e){this.view=t,this.config=e,this.elements=[],this.spacer=null,this.dom=document.createElement("div"),this.dom.className="cm-gutter"+(this.config.class?" "+this.config.class:"")
...
this.markers=Hr(e.markers(t)),e.initialSpacer&&(this.spacer=new qr(t,0,0,[e.initialSpacer(t)]),this.dom.appendChild(this.spacer.dom),this.spacer.dom.style.cssText+="visibility: hidden; pointer-events: none")}update(t){let e=this.markers
if(this.markers=Hr(this.config.markers(t.view)),this.spacer&&this.config.updateSpacer){let e=this.config.updateSpacer(this.spacer.markers[0],t)
e!=this.spacer.markers[0]&&this.spacer.update(t.view,0,0,[e])}let i=t.view.viewport
return!Pt.eq(this.markers,e,i.from,i.to)||!!this.config.lineMarkerChange&&this.config.lineMarkerChange(t)}destroy(){for(let t of this.elements)t.destroy()}}class qr{constructor(t,e,i,n){this.height=-1,this.above=0,this.markers=[],this.dom=document.createElement("div"),this.dom.className="cm-gutterElement",this.update(t,e,i,n)}update(t,e,i,n){this.height!=e&&(this.height=e,this.dom.style.height=e+"px"),this.above!=i&&(this.dom.style.marginTop=(this.above=i)?i+"px":""),function(t,e){if(t.length!=e.length)return!1
...
l.toDOM&&(a?n=n.nextSibling:this.dom.insertBefore(l.toDOM(t),n)),a&&o++}this.dom.className=i,this.markers=e}destroy(){this.setMarkers(null,[])}}const _r=j.define(),Kr=j.define(),jr=j.define({combine:t=>Dt(t,{formatNumber:String,domEventHandlers:{}},{domEventHandlers(t,e){let i=Object.assign({},t)
for(let n in e){let t=i[n],s=e[n]
i[n]=t?(e,i,n)=>t(e,i,n)||s(e,i,n):s}return i}})})
class $r extends Dr{constructor(t){super(),this.number=t}eq(t){return this.number==t.number}toDOM(){return document.createTextNode(this.number)}}function Ur(t,e){return t.state.facet(jr).formatNumber(e,t.state)}const Yr=Lr.compute([jr],t=>({class:"cm-lineNumbers",renderEmptyElements:!1,markers:t=>t.state.facet(_r),lineMarker:(t,e,i)=>i.some(t=>t.toDOM)?null:new $r(Ur(t,t.state.doc.lineAt(e.from).number)),widgetMarker:(t,e,i)=>{for(let n of t.state.facet(Kr)){let s=n(t,e,i)
if(s)return s}return null},lineMarkerChange:t=>t.startState.facet(jr)!=t.state.facet(jr),initialSpacer:t=>new $r(Ur(t,Gr(t.state.doc.lines))),updateSpacer(t,e){let i=Ur(e.view,Gr(e.view.state.doc.lines))
return i==t.number?t:new $r(i)},domEventHandlers:t.facet(jr).domEventHandlers,side:"before"}))
function Gr(t){let e=9
for(;e<t;)e=10*e+9
return e}const Jr=new class extends Dr{constructor(){super(...arguments),this.elementClass="cm-activeLineGutter"}},Xr=Er.compute(["selection"],t=>{let e=[],i=-1
for(let n of t.selection.ranges){let s=t.doc.lineAt(n.head).from
s>i&&(i=s,e.push(Jr.range(s)))}return Pt.of(e)}),Qr=1024
let Zr=0
class tl{constructor(t,e){this.from=t,this.to=e}}class el{constructor(t={}){this.id=Zr++,this.perNode=!!t.perNode,this.deserialize=t.deserialize||(()=>{throw new Error("This node type doesn't define a deserialize function")}),this.combine=t.combine||null}add(t){if(this.perNode)throw new RangeError("Can't add per-node props to node types")
return"function"!=typeof t&&(t=sl.match(t)),e=>{let i=t(e)
return void 0===i?null:[this,i]}}}el.closedBy=new el({deserialize:t=>t.split(" ")}),el.openedBy=new el({deserialize:t=>t.split(" ")}),el.group=new el({deserialize:t=>t.split(" ")}),el.isolate=new el({deserialize:t=>{if(t&&"rtl"!=t&&"ltr"!=t&&"auto"!=t)throw new RangeError("Invalid value for isolate: "+t)
return t||"auto"}}),el.contextHash=new el({perNode:!0}),el.lookAhead=new el({perNode:!0}),el.mounted=new el({perNode:!0})
class il{constructor(t,e,i,n=!1){this.tree=t,this.overlay=e,this.parser=i,this.bracketed=n}static get(t){return t&&t.props&&t.props[el.mounted.id]}}const nl=Object.create(null)
class sl{constructor(t,e,i,n=0){this.name=t,this.props=e,this.id=i,this.flags=n}static define(t){let e=t.props&&t.props.length?Object.create(null):nl,i=(t.top?1:0)|(t.skipped?2:0)|(t.error?4:0)|(null==t.name?8:0),n=new sl(t.name||"",e,t.id,i)
...
return t=>{for(let i=t.prop(el.group),n=-1;n<(i?i.length:0);n++){let s=e[n<0?t.name:i[n]]
if(s)return s}}}}sl.none=new sl("",Object.create(null),0,8)
const ol=new WeakMap,rl=new WeakMap
var ll
!function(t){t[t.ExcludeBuffers=1]="ExcludeBuffers",t[t.IncludeAnonymous=2]="IncludeAnonymous",t[t.IgnoreMounts=4]="IgnoreMounts",t[t.IgnoreOverlays=8]="IgnoreOverlays",t[t.EnterBracketed=16]="EnterBracketed"}(ll||(ll={}))
class al{constructor(t,e,i,n,s){if(this.type=t,this.children=e,this.positions=i,this.length=n,this.props=null,s&&s.length){this.props=Object.create(null)
for(let[t,e]of s)this.props["number"==typeof t?t:t.id]=e}}toString(){let t=il.get(this)
if(t&&!t.overlay)return t.tree.toString()
let e=""
for(let i of this.children){let t=i.toString()
t&&(e&&(e+=","),e+=t)}return this.type.name?(/\W/.test(this.type.name)&&!this.type.isError?JSON.stringify(this.type.name):this.type.name)+(e.length?"("+e+")":""):e}cursor(t=0){return new xl(this.topNode,t)}cursorAt(t,e=0,i=0){let n=ol.get(this)||this.topNode,s=new xl(n)
return s.moveTo(t,e),ol.set(this,s._tree),s}get topNode(){return new pl(this,0,0,null)}resolve(t,e=0){let i=dl(ol.get(this)||this.topNode,t,e,!1)
return ol.set(this,i),i}resolveInner(t,e=0){let i=dl(rl.get(this)||this.topNode,t,e,!0)
return rl.set(this,i),i}resolveStack(t,e=0){return function(t,e,i){let n=t.resolveInner(e,i),s=null
for(let o=n instanceof pl?n:n.context.parent;o;o=o.parent)if(o.index<0){let t=o.parent;(s||(s=[n])).push(t.resolve(e,i)),o=t}else{let t=il.get(o.tree)
if(t&&t.overlay&&t.overlay[0].from<=e&&t.overlay[t.overlay.length-1].to>=e){let r=new pl(t.tree,t.overlay[0].from+o.from,-1,o);(s||(s=[n])).push(dl(r,e,i,!1))}}return s?bl(s):n}(this,t,e)}iterate(t){let{enter:e,leave:i,from:n=0,to:s=this.length}=t,o=t.mode||0,r=(o&ll.IncludeAnonymous)>0
for(let l=this.cursor(o|ll.IncludeAnonymous);;){let t=!1
...
return t}balance(t={}){return this.children.length<=8?this:Ml(sl.none,this.children,this.positions,0,this.children.length,0,this.length,(t,e,i)=>new al(this.type,t,e,i,this.propValues),t.makeTree||((t,e,i)=>new al(sl.none,t,e,i)))}static build(t){return function(t){var e
let{buffer:i,nodeSet:n,maxBufferLength:s=Qr,reused:o=[],minRepeatType:r=n.types.length}=t,l=Array.isArray(i)?new hl(i,i.length):i,a=n.types,h=0,c=0
...
M=new cl(e,x-A.start,n),O=A.start-t}else{let t=l.pos-k
l.next()
...
if(a>=0&&(o=i[a])instanceof al){if(!a&&o.type==t&&o.length==s)return o;(r=o.prop(el.lookAhead))&&(l=n[a]+o.length+r)}return p(t,i,n,s,l,e)}}(T,C)
M=Ml(T,e,i,0,e.length,0,x-y,t,t)}else M=p(T,e,i,x-y,S-x,C)}i.push(M),g.push(O)}function d(t,e,i,o){let r=[],a=0,h=-1
...
i.push(new cl(e,r[2]-s,n)),o.push(s-t)}}function f(t,e,i,s,o,r,l,a,h){let c=[],u=[]
for(;t.length>s;)c.push(t.pop()),u.push(e.pop()+i-o)
t.push(p(n.types[l],c,u,r-o,a-r,h)),e.push(o-i)}function p(t,e,i,n,s,o,r){if(o){let t=[el.contextHash,o]
r=r?[t].concat(r):[t]}if(s>25){let t=[el.lookAhead,s]
r=r?[t].concat(r):[t]}return new al(t,e,i,n,r)}function m(t,e,i){let{id:n,start:s,end:o,size:a}=l
...
return new al(a[t.topID],g.reverse(),v.reverse(),w)}(t)}}al.empty=new al(sl.none,[],[],0)
class hl{constructor(t,e){this.buffer=t,this.index=e}get id(){return this.buffer[this.index-4]}get start(){return this.buffer[this.index-3]}get end(){return this.buffer[this.index-2]}get size(){return this.buffer[this.index-1]}get pos(){return this.index}next(){this.index-=4}fork(){return new hl(this.buffer,this.index)}}class cl{constructor(t,e,i){this.buffer=t,this.length=e,this.set=i}get type(){return sl.none}toString(){let t=[]
...
for(let l=t;l!=e&&!(ul(s,n,o[l+1],o[l+2])&&(r=l,i>0));l=o[l+3]);return r}slice(t,e,i){let n=this.buffer,s=new Uint16Array(e-t),o=0
for(let r=t,l=0;r<e;){s[l++]=n[r++],s[l++]=n[r++]-i
let e=s[l++]=n[r++]-i
s[l++]=n[r++]-t,o=Math.max(o,e)}return new cl(s,o,this.set)}}function ul(t,e,i,n){switch(t){case-2:return i<e
case-1:return n>=e&&i<e
case 0:return i<e&&n>e
case 1:return i<=e&&n>e
case 2:return n>e
case 4:return!0}}function dl(t,e,i,n){for(var s;t.from==t.to||(i<1?t.from>=e:t.from>e)||(i>-1?t.to<=e:t.to<e);){let e=!n&&t instanceof pl&&t.index<0?null:t.parent
if(!e)return t
t=e}let o=n?0:ll.IgnoreOverlays
if(n)for(let r=t,l=r.parent;l;r=l,l=r.parent)r instanceof pl&&r.index<0&&(null===(s=l.enter(e,i,o))||void 0===s?void 0:s.from)!=r.from&&(t=l)
for(;;){let n=t.enter(e,i,o)
if(!n)return t
t=n}}class fl{cursor(t=0){return new xl(this,t)}getChild(t,e=null,i=null){let n=ml(this,t,e,i)
return n.length?n[0]:null}getChildren(t,e=null,i=null){return ml(this,t,e,i)}resolve(t,e=0){return dl(this,t,e,!1)}resolveInner(t,e=0){return dl(this,t,e,!0)}matchContext(t){return gl(this.parent,t)}enterUnfinishedNodesBefore(t){let e=this.childBefore(t),i=this
...
if(s&ll.EnterBracketed&&h instanceof al&&(a=il.get(h))&&!a.overlay&&a.bracketed&&i>=c&&i<=c+h.length||ul(n,i,c,c+h.length))if(h instanceof cl){if(s&ll.ExcludeBuffers)continue
let r=h.findChild(0,h.buffer.length,e,i-c,n)
if(r>-1)return new wl(new vl(o,h,t,c),null,r)}else if(s&ll.IncludeAnonymous||!h.type.isAnonymous||kl(h)){let r
if(!(s&ll.IgnoreMounts)&&(r=il.get(h))&&!r.overlay)return new pl(r.tree,c,t,o)
let l=new pl(h,c,t,o)
return s&ll.IncludeAnonymous||!l.type.isAnonymous?l:l.nextChild(e<0?h.children.length-1:0,e,i,n,s)}}if(s&ll.IncludeAnonymous||!o.type.isAnonymous)return null
...
if(!(i&ll.IgnoreOverlays)&&(n=il.get(this._tree))&&n.overlay){let s=t-this.from,o=i&ll.EnterBracketed&&n.bracketed
for(let{from:t,to:i}of n.overlay)if((e>0||o?t<=s:t<s)&&(e<0||o?i>=s:i>s))return new pl(n.tree,n.overlay[0].from+this.from,-1,this)}return this.nextChild(0,1,t,e,i)}nextSignificantParent(){let t=this
for(;t.type.isAnonymous&&t._parent;)t=t._parent
return t}get parent(){return this._parent?this._parent.nextSignificantParent():null}get nextSibling(){return this._parent&&this.index>=0?this._parent.nextChild(this.index+1,1,0,4):null}get prevSibling(){return this._parent&&this.index>=0?this._parent.nextChild(this.index-1,-1,0,4):null}get tree(){return this._tree}toTree(){return this._tree}toString(){return this._tree.toString()}}function ml(t,e,i,n){let s=t.cursor(),o=[]
...
if(s.type.is(e)&&o.push(s.node),!s.nextSibling())return null==n?o:[]}}function gl(t,e,i=e.length-1){for(let n=t;i>=0;n=n.parent){if(!n)return!1
if(!n.type.isAnonymous){if(e[i]&&e[i]!=n.name)return!1
i--}}return!0}class vl{constructor(t,e,i,n){this.parent=t,this.buffer=e,this.index=i,this.start=n}}class wl extends fl{get name(){return this.type.name}get from(){return this.context.start+this.context.buffer.buffer[this.index+1]}get to(){return this.context.start+this.context.buffer.buffer[this.index+2]}constructor(t,e,i){super(),this.context=t,this._parent=e,this.index=i,this.type=t.buffer.set.types[t.buffer.buffer[i]]}child(t,e,i){let{buffer:n}=this.context,s=n.findChild(this.index+4,n.buffer[this.index+3],t,e-this.context.start,i)
return s<0?null:new wl(this.context,this,s)}get firstChild(){return this.child(1,0,4)}get lastChild(){return this.child(-1,0,4)}childAfter(t){return this.child(1,t,2)}childBefore(t){return this.child(-1,t,-2)}prop(t){return this.type.prop(t)}enter(t,e,i=0){if(i&ll.ExcludeBuffers)return null
let{buffer:n}=this.context,s=n.findChild(this.index+4,n.buffer[this.index+3],e>0?1:-1,t-this.context.start,e)
return s<0?null:new wl(this.context,this,s)}get parent(){return this._parent||this.context.parent.nextSignificantParent()}externalSibling(t){return this._parent?null:this.context.parent.nextChild(this.context.index+t,t,0,4)}get nextSibling(){let{buffer:t}=this.context,e=t.buffer[this.index+3]
return e<(this._parent?t.buffer[this._parent.index+3]:t.buffer.length)?new wl(this.context,this._parent,e):this.externalSibling(1)}get prevSibling(){let{buffer:t}=this.context,e=this._parent?this._parent.index+4:0
return this.index==e?this.externalSibling(-1):new wl(this.context,this._parent,t.findChild(e,this.index,-1,0,4))}get tree(){return null}toTree(){let t=[],e=[],{buffer:i}=this.context,n=this.index+4,s=i.buffer[this.index+3]
if(s>n){let o=i.buffer[this.index+1]
t.push(i.slice(n,s,o)),e.push(0)}return new al(this.type,t,e,this.to-this.from)}toString(){return this.context.buffer.childString(this.index)}}function bl(t){if(!t.length)return null
let e=0,i=t[0]
for(let o=1;o<t.length;o++){let n=t[o];(n.from>i.from||n.to<i.to)&&(i=n,e=o)}let n=i instanceof pl&&i.index<0?null:i.parent,s=t.slice()
return n?s[e]=n:s.splice(e,1),new yl(s,i)}class yl{constructor(t,e){this.heads=t,this.node=e}get next(){return bl(this.heads)}}class xl{get name(){return this.type.name}constructor(t,e=0){if(this.buffer=null,this.stack=[],this.index=0,this.bufferNode=null,this.mode=e&~ll.EnterBracketed,t instanceof pl)this.yieldNode(t)
...
return this.type=e||n.set.types[n.buffer[t]],this.from=i+n.buffer[t+1],this.to=i+n.buffer[t+2],!0}yield(t){return!!t&&(t instanceof pl?(this.buffer=null,this.yieldNode(t)):(this.buffer=t.context,this.yieldBuf(t.index,t.type)))}toString(){return this.buffer?this.buffer.buffer.childString(this.index):this._tree.toString()}enterChild(t,e,i){if(!this.buffer)return this.yield(this._tree.nextChild(t<0?this._tree._tree.children.length-1:0,t,e,i,this.mode))
...
let t=this.mode&ll.IncludeAnonymous?this.buffer.parent:this.buffer.parent.nextSignificantParent()
...
if(this.mode&ll.IncludeAnonymous||t instanceof cl||!t.type.isAnonymous||kl(t))return!1}return!0}move(t,e){if(e&&this.enterChild(t,0,4))return!0
...
e=o,i=s+1
break t}n=this.stack[--s]}for(let n=i;n<this.stack.length;n++)e=new wl(this.buffer,e,this.stack[n])
return this.bufferNode=new wl(this.buffer,e,this.index)}get tree(){return this.buffer?null:this._tree._tree}iterate(t,e){for(let i=0;;){let n=!1
...
this.parent(),i--,n=!0}}}matchContext(t){if(!this.buffer)return gl(this.node.parent,t)
let{buffer:e}=this.buffer,{types:i}=e.set
for(let n=t.length-1,s=this.stack.length-1;n>=0;s--){if(s<0)return gl(this._tree,t,n)
let o=i[e.buffer[this.stack[s]]]
if(!o.isAnonymous){if(t[n]&&t[n]!=o.name)return!1
n--}}return!0}}function kl(t){return t.children.some(t=>t instanceof cl||!t.type.isAnonymous||kl(t))}const Sl=new WeakMap
function Cl(t,e){if(!t.isAnonymous||e instanceof cl||e.type!=t)return 1
let i=Sl.get(e)
if(null==i){i=1
for(let n of e.children){if(n.type!=t||!(n instanceof al)){i=1
break}i+=Cl(t,n)}Sl.set(e,i)}return i}function Ml(t,e,i,n,s,o,r,l,a){let h=0
for(let f=n;f<s;f++)h+=Cl(t,e[f])
let c=Math.ceil(1.5*h/8),u=[],d=[]
return function e(i,n,s,r,l){for(let h=s;h<r;){let s=h,f=n[h],p=Cl(t,i[h])
for(h++;h<r;h++){let e=Cl(t,i[h])
if(p+e>=c)break
...
u.push(Ml(t,i,n,s,h,f,e,null,a))}d.push(f+l-o)}}(e,i,n,s,0),(l||a)(u,d,r)}class Al{constructor(t,e,i,n,s=!1,o=!1){this.from=t,this.to=e,this.tree=i,this.offset=n,this.open=(s?1:0)|(o?2:0)}get openStart(){return(1&this.open)>0}get openEnd(){return(2&this.open)>0}static addTree(t,e=[],i=!1){let n=[new Al(0,t.length,t,0,!1,i)]
...
e=t>=i?null:new Al(t,i,e.tree,e.offset+a,r>0,!!h)}if(e&&n.push(e),o.to>c)break
o=s<t.length?t[s++]:null}if(!h)break
l=h.toA,a=h.toA-h.toB}return n}}class Tl{startParse(t,e,i){return"string"==typeof t&&(t=new Ol(t)),i=i?i.length?i.map(t=>new tl(t.from,t.to)):[new tl(0,0)]:[new tl(0,t.length)],this.createParse(t,e||[],i)}parse(t,e,i){let n=this.startParse(t,e,i)
for(;;){let t=n.advance()
if(t)return t}}}class Ol{constructor(t){this.string=t}get length(){return this.string.length}chunk(t){return this.string.slice(t)}get lineChunks(){return!1}read(t,e){return this.string.slice(t,e)}}new el({perNode:!0})
let Dl=0
class El{constructor(t,e,i,n){this.name=t,this.set=e,this.base=i,this.modified=n,this.id=Dl++}toString(){let{name:t}=this
for(let e of this.modified)e.name&&(t=`${e.name}(${t})`)
return t}static define(t,e){let i="string"==typeof t?t:"?"
if(t instanceof El&&(e=t),null==e?void 0:e.base)throw new Error("Can not derive from a modified tag")
let n=new El(i,[],null,[])
if(n.set.push(n),e)for(let s of e.set)n.set.push(s)
return n}static defineModifier(t){let e=new Rl(t)
return t=>t.modified.indexOf(e)>-1?t:Rl.get(t.base||t,t.modified.concat(e).sort((t,e)=>t.id-e.id))}}let Bl=0
class Rl{constructor(t){this.name=t,this.instances=[],this.id=Bl++}static get(t,e){if(!e.length)return t
let i=e[0].instances.find(i=>{return i.base==t&&(n=e,s=i.modified,n.length==s.length&&n.every((t,e)=>t==s[e]))
var n,s})
if(i)return i
let n=[],s=new El(t.name,n,t,e)
...
for(let r of t.set)if(!r.modified.length)for(let t of o)n.push(Rl.get(r,t))
return s}}function Ll(t){let e=Object.create(null)
...
let a=new Pl(n,s,r>0?i.slice(0,r):null)
e[l]=a.sort(e[l])}}return Il.add(e)}const Il=new el({combine(t,e){let i,n,s
for(;t||e;){if(!t||e&&t.depth>=e.depth?(s=e,e=e.next):(s=t,t=t.next),i&&i.mode==s.mode&&!s.context&&!i.context)continue
let o=new Pl(s.tags,s.mode,s.context)
i?i.next=o:n=o,i=o}return n}})
class Pl{constructor(t,e,i,n){this.tags=t,this.mode=e,this.context=i,this.next=n}get opaque(){return 0==this.mode}get inherit(){return 1==this.mode}sort(t){return!t||t.depth<this.depth?(this.next=t,this):(t.next=this.sort(t.next),t)}get depth(){return this.context?this.context.length:0}}function Nl(t,e){let i=Object.create(null)
...
if(n){e=e?e+" "+n:n
break}}return e},scope:n}}function Wl(t,e,i,n=0,s=t.length){let o=new Hl(n,Array.isArray(e)?e:[e],i)
o.highlightRange(t.cursor(),n,s,"",o.highlighters),o.flush(s)}Pl.empty=new Pl([],2,null)
class Hl{constructor(t,e,i){this.at=t,this.highlighters=e,this.span=i,this.class=""}startSpan(t,e){e!=this.class&&(this.flush(t),t>this.at&&(this.at=t),this.class=e)}flush(t){t>this.at&&this.class&&this.span(this.at,t,this.class)}highlightRange(t,e,i,n,s){let{type:o,from:r,to:l}=t
if(r>=i||l<=e)return
o.isTop&&(s=this.highlighters.filter(t=>!t.scope||t.scope(o)))
let a=n,h=function(t){let e=t.type.prop(Il)
for(;e&&e.context&&!t.matchContext(e.context);)e=e.next
return e||null}(t)||Pl.empty,c=function(t,e){let i=null
...
let u=t.tree&&t.tree.prop(el.mounted)
...
t.parent()}}}const Vl=El.define,Fl=Vl(),zl=Vl(),ql=Vl(zl),_l=Vl(zl),Kl=Vl(),jl=Vl(Kl),$l=Vl(Kl),Ul=Vl(),Yl=Vl(Ul),Gl=Vl(),Jl=Vl(),Xl=Vl(),Ql=Vl(Xl),Zl=Vl(),ta={comment:Fl,lineComment:Vl(Fl),blockComment:Vl(Fl),docComment:Vl(Fl),name:zl,variableName:Vl(zl),typeName:ql,tagName:Vl(ql),propertyName:_l,attributeName:Vl(_l),className:Vl(zl),labelName:Vl(zl),namespace:Vl(zl),macroName:Vl(zl),literal:Kl,string:jl,docString:Vl(jl),character:Vl(jl),attributeValue:Vl(jl),number:$l,integer:Vl($l),float:Vl($l),bool:Vl(Kl),regexp:Vl(Kl),escape:Vl(Kl),color:Vl(Kl),url:Vl(Kl),keyword:Gl,self:Vl(Gl),null:Vl(Gl),atom:Vl(Gl),unit:Vl(Gl),modifier:Vl(Gl),operatorKeyword:Vl(Gl),controlKeyword:Vl(Gl),definitionKeyword:Vl(Gl),moduleKeyword:Vl(Gl),operator:Jl,derefOperator:Vl(Jl),arithmeticOperator:Vl(Jl),logicOperator:Vl(Jl),bitwiseOperator:Vl(Jl),compareOperator:Vl(Jl),updateOperator:Vl(Jl),definitionOperator:Vl(Jl),typeOperator:Vl(Jl),controlOperator:Vl(Jl),punctuation:Xl,separator:Vl(Xl),bracket:Ql,angleBracket:Vl(Ql),squareBracket:Vl(Ql),paren:Vl(Ql),brace:Vl(Ql),content:Ul,heading:Yl,heading1:Vl(Yl),heading2:Vl(Yl),heading3:Vl(Yl),heading4:Vl(Yl),heading5:Vl(Yl),heading6:Vl(Yl),contentSeparator:Vl(Ul),list:Vl(Ul),quote:Vl(Ul),emphasis:Vl(Ul),strong:Vl(Ul),link:Vl(Ul),monospace:Vl(Ul),strikethrough:Vl(Ul),inserted:Vl(),deleted:Vl(),changed:Vl(),invalid:Vl(),meta:Zl,documentMeta:Vl(Zl),annotation:Vl(Zl),processingInstruction:Vl(Zl),definition:El.defineModifier("definition"),constant:El.defineModifier("constant"),function:El.defineModifier("function"),standard:El.defineModifier("standard"),local:El.defineModifier("local"),special:El.defineModifier("special")}
for(let _f in ta){let t=ta[_f]
t instanceof El&&(t.name=_f)}var ea
Nl([{tag:ta.link,class:"tok-link"},{tag:ta.heading,class:"tok-heading"},{tag:ta.emphasis,class:"tok-emphasis"},{tag:ta.strong,class:"tok-strong"},{tag:ta.keyword,class:"tok-keyword"},{tag:ta.atom,class:"tok-atom"},{tag:ta.bool,class:"tok-bool"},{tag:ta.url,class:"tok-url"},{tag:ta.labelName,class:"tok-labelName"},{tag:ta.inserted,class:"tok-inserted"},{tag:ta.deleted,class:"tok-deleted"},{tag:ta.literal,class:"tok-literal"},{tag:ta.string,class:"tok-string"},{tag:ta.number,class:"tok-number"},{tag:[ta.regexp,ta.escape,ta.special(ta.string)],class:"tok-string2"},{tag:ta.variableName,class:"tok-variableName"},{tag:ta.local(ta.variableName),class:"tok-variableName tok-local"},{tag:ta.definition(ta.variableName),class:"tok-variableName tok-definition"},{tag:ta.special(ta.variableName),class:"tok-variableName2"},{tag:ta.definition(ta.propertyName),class:"tok-propertyName tok-definition"},{tag:ta.typeName,class:"tok-typeName"},{tag:ta.namespace,class:"tok-namespace"},{tag:ta.className,class:"tok-className"},{tag:ta.macroName,class:"tok-macroName"},{tag:ta.propertyName,class:"tok-propertyName"},{tag:ta.operator,class:"tok-operator"},{tag:ta.comment,class:"tok-comment"},{tag:ta.meta,class:"tok-meta"},{tag:ta.invalid,class:"tok-invalid"},{tag:ta.punctuation,class:"tok-punctuation"}])
const ia=new el,na=new el
class sa{constructor(t,e,i=[],n=""){this.data=t,this.name=n,Ot.prototype.hasOwnProperty("tree")||Object.defineProperty(Ot.prototype,"tree",{get(){return ra(this)}}),this.parser=e,this.extension=[ma.of(this),Ot.languageData.of((t,e,i)=>{let n=oa(t,e,i),s=n.type.prop(ia)
if(!s)return[]
let o=t.facet(s),r=n.type.prop(na)
if(r){let s=n.resolve(e-n.from,i)
for(let e of r)if(e.test(s,t)){let i=t.facet(e.facet)
return"replace"==e.type?i:i.concat(o)}}return o})].concat(i)}isActiveAt(t,e,i=-1){return oa(t,e,i).type.prop(ia)==this.data}findRegions(t){let e=t.facet(ma)
if((null==e?void 0:e.data)==this.data)return[{from:0,to:t.doc.length}]
if(!e||!e.allowsNesting)return[]
let i=[],n=(t,e)=>{if(t.prop(ia)==this.data)return void i.push({from:e,to:e+t.length})
let s=t.prop(el.mounted)
if(s){if(s.tree.prop(ia)==this.data){if(s.overlay)for(let t of s.overlay)i.push({from:t.from+e,to:t.to+e})
...
s instanceof al&&n(s,t.positions[i]+e)}}
return n(ra(t),0),i}get allowsNesting(){return!0}}function oa(t,e,i){let n=t.facet(ma),s=ra(t).topNode
if(!n||n.allowsNesting)for(let o=s;o;o=o.enter(e,i,ll.ExcludeBuffers|ll.EnterBracketed))o.type.isTop&&(s=o)
return s}function ra(t){let e=t.field(sa.state,!1)
return e?e.tree:al.empty}sa.setState=vt.define()
class la{constructor(t){this.doc=t,this.cursorPos=0,this.string="",this.cursor=t.iter()}get length(){return this.doc.length}syncTo(t){return this.string=this.cursor.next(t-this.cursorPos).value,this.cursorPos=t+this.string.length,this.cursorPos-this.string.length}chunk(t){return this.syncTo(t),this.string}get lineChunks(){return!0}read(t,e){let i=this.cursorPos-this.string.length
return t<i||e>=this.cursorPos?this.doc.sliceString(t,e):this.string.slice(t-i,e-i)}}let aa=null
class ha{constructor(t,e,i=[],n,s,o,r,l){this.parser=t,this.state=e,this.fragments=i,this.tree=n,this.treeLen=s,this.viewport=o,this.skipped=r,this.scheduleOn=l,this.parse=null,this.tempSkipped=[]}static create(t,e,i){return new ha(t,e,[],al.empty,0,i,[],null)}startParse(){return this.parser.startParse(new la(this.state.doc),this.fragments)}work(t,e){return null!=e&&e>=this.state.doc.length&&(e=void 0),this.tree!=al.empty&&this.isDone(null!=e?e:this.state.doc.length)?(this.takeTree(),!0):this.withContext(()=>{var i
...
if(n){if(this.fragments=this.withoutTempSkipped(Al.addTree(n,this.fragments,null!=this.parse.stoppedAt)),this.treeLen=null!==(i=this.parse.stoppedAt)&&void 0!==i?i:this.state.doc.length,this.tree=n,this.parse=null,!(this.treeLen<(null!=e?e:this.state.doc.length)))return!0
this.parse=this.startParse()}if(t())return!1}})}takeTree(){let t,e
this.parse&&(t=this.parse.parsedPos)>=this.treeLen&&((null==this.parse.stoppedAt||this.parse.stoppedAt>t)&&this.parse.stopAt(t),this.withContext(()=>{for(;!(e=this.parse.advance()););}),this.treeLen=t,this.tree=e,this.fragments=this.withoutTempSkipped(Al.addTree(this.tree,this.fragments,!0)),this.parse=null)}withContext(t){let e=aa
aa=this
try{return t()}finally{aa=e}}withoutTempSkipped(t){for(let e;e=this.tempSkipped.pop();)t=ca(t,e.from,e.to)
return t}changes(t,e){let{fragments:i,tree:n,treeLen:s,viewport:o,skipped:r}=this
if(this.takeTree(),!t.empty){let e=[]
if(t.iterChangedRanges((t,i,n,s)=>e.push({fromA:t,toA:i,fromB:n,toB:s})),i=Al.applyChanges(i,e),n=al.empty,s=0,o={from:t.mapPos(o.from,-1),to:t.mapPos(o.to,1)},this.skipped.length){r=[]
for(let e of this.skipped){let i=t.mapPos(e.from,1),n=t.mapPos(e.to,-1)
i<n&&r.push({from:i,to:n})}}}return new ha(this.parser,e,i,n,s,o,r,this.scheduleOn)}updateViewport(t){if(this.viewport.from==t.from&&this.viewport.to==t.to)return!1
this.viewport=t
let e=this.skipped.length
for(let i=0;i<this.skipped.length;i++){let{from:e,to:n}=this.skipped[i]
e<t.to&&n>t.from&&(this.fragments=ca(this.fragments,e,n),this.skipped.splice(i--,1))}return!(this.skipped.length>=e||(this.reset(),0))}reset(){this.parse&&(this.takeTree(),this.parse=null)}skipUntilInView(t,e){this.skipped.push({from:t,to:e})}static getSkippingParser(t){return new class extends Tl{createParse(e,i,n){let s=n[0].from,o=n[n.length-1].to
return{parsedPos:s,advance(){let e=aa
if(e){for(let t of n)e.tempSkipped.push(t)
t&&(e.scheduleOn=e.scheduleOn?Promise.all([e.scheduleOn,t]):t)}return this.parsedPos=o,new al(sl.none,[],[],o-s)},stoppedAt:null,stopAt(){}}}}}isDone(t){t=Math.min(t,this.state.doc.length)
let e=this.fragments
return this.treeLen>=t&&e.length&&0==e[0].from&&e[0].to>=t}static get(){return aa}}function ca(t,e,i){return Al.applyChanges(t,[{fromA:e,toA:i,fromB:e,toB:i}])}class ua{constructor(t){this.context=t,this.tree=t.tree}apply(t){if(!t.docChanged&&this.tree==this.context.tree)return this
...
return e.work(20,i)||e.takeTree(),new ua(e)}static init(t){let e=Math.min(3e3,t.doc.length),i=ha.create(t.facet(ma).parser,t,{from:0,to:e})
return i.work(20,e)||i.takeTree(),new ua(i)}}sa.state=Q.define({create:ua.init,update(t,e){for(let i of e.effects)if(i.is(sa.setState))return i.value
return e.startState.facet(ma)!=e.state.facet(ma)?ua.init(e.state):t.apply(e)}})
let da=t=>{let e=setTimeout(()=>t(),500)
return()=>clearTimeout(e)}
"undefined"!=typeof requestIdleCallback&&(da=t=>{let e=-1,i=setTimeout(()=>{e=requestIdleCallback(t,{timeout:400})},100)
return()=>e<0?clearTimeout(i):cancelIdleCallback(e)})
const fa="undefined"!=typeof navigator&&(null===(ea=navigator.scheduling)||void 0===ea?void 0:ea.isInputPending)?()=>navigator.scheduling.isInputPending():null,pa=qi.fromClass(class{constructor(t){this.view=t,this.working=null,this.workScheduled=0,this.chunkEnd=-1,this.chunkBudget=-1,this.work=this.work.bind(this),this.scheduleWork()}update(t){let e=this.view.state.field(sa.state).context;(e.updateViewport(t.view.viewport)||this.view.viewport.to>e.treeLen)&&this.scheduleWork(),(t.docChanged||t.selectionSet)&&(this.view.hasFocus&&(this.chunkBudget+=50),this.scheduleWork()),this.checkAsyncSchedule(e)}scheduleWork(){if(this.working)return
let{state:t}=this.view,e=t.field(sa.state)
e.tree==e.context.tree&&e.context.isDone(t.doc.length)||(this.working=da(this.work))}work(t){this.working=null
let e=Date.now()
...
let o=Date.now()+Math.min(this.chunkBudget,100,t&&!fa?Math.max(25,t.timeRemaining()-5):1e9),r=s.context.treeLen<n&&i.doc.length>n+1e3,l=s.context.work(()=>fa&&fa()||Date.now()>o,n+(r?0:1e5))
this.chunkBudget-=Date.now()-e,(l||this.chunkBudget<=0)&&(s.context.takeTree(),this.view.dispatch({effects:sa.setState.of(new ua(s.context))})),this.chunkBudget>0&&(!l||r)&&this.scheduleWork(),this.checkAsyncSchedule(s.context)}checkAsyncSchedule(t){t.scheduleOn&&(this.workScheduled++,t.scheduleOn.then(()=>this.scheduleWork()).catch(t=>Hi(this.view.state,t)).then(()=>this.workScheduled--),t.scheduleOn=null)}destroy(){this.working&&this.working()}isWorking(){return!!(this.working||this.workScheduled>0)}},{eventHandlers:{focus(){this.scheduleWork()}}}),ma=j.define({combine:t=>t.length?t[0]:null,enables:t=>[sa.state,pa,po.contentAttributes.compute([t],e=>{let i=e.facet(t)
return i&&i.name?{"data-language":i.name}:{}})]}),ga=j.define(),va=j.define({combine:t=>{if(!t.length)return"  "
let e=t[0]
if(!e||/\S/.test(e)||Array.from(e).some(t=>t!=e[0]))throw new Error("Invalid indent unit: "+JSON.stringify(t[0]))
return e}})
function wa(t){let e=t.facet(va)
return 9==e.charCodeAt(0)?t.tabSize*e.length:e.length}function ba(t,e){let i="",n=t.tabSize,s=t.facet(va)[0]
if("\t"==s){for(;e>=n;)i+="\t",e-=n
s=" "}for(let o=0;o<e;o++)i+=s
return i}function ya(t,e){t instanceof Ot&&(t=new xa(t))
for(let n of t.state.facet(ga)){let i=n(t,e)
if(void 0!==i)return i}let i=ra(t.state)
...
for(let e=t.length-1;e>=0;e--)n={node:t[e],next:n}}return Sa(n,t,i)}(t,i,e):null}class xa{constructor(t,e={}){this.state=t,this.options=e,this.unit=wa(t)}lineAt(t,e=1){let i=this.state.doc.lineAt(t),{simulateBreak:n,simulateDoubleBreak:s}=this.options
...
if(s){let t=s(n)
if(t>-1)return t}return this.countColumn(i,i.search(/\S|$/))}get simulatedBreak(){return this.options.simulateBreak||null}}const ka=new el
function Sa(t,e,i){for(let n=t;n;n=n.next){let t=Ca(n.node)
if(t)return t(Aa.create(e,i,n))}return 0}function Ca(t){let e=t.type.prop(ka)
if(e)return e
let i,n=t.firstChild
if(n&&(i=n.type.prop(el.closedBy))){let e=t.lastChild,n=e&&i.indexOf(e.name)>-1
...
return a?l?t.column(a.from):t.column(a.to):t.baseIndent+(l?0:1*t.unit)}(t,0,0,0,n&&!function(t){return t.pos==t.options.simulateBreak&&t.options.simulateDoubleBreak}(t)?e.from:void 0)}return null==t.parent?Ma:null}function Ma(){return 0}class Aa extends xa{constructor(t,e,i){super(t.state,t.options),this.base=t,this.pos=e,this.context=i}get node(){return this.context.node}static create(t,e,i){return new Aa(t,e,i)}get textAfter(){return this.textAfterPos(this.pos)}get baseIndent(){return this.baseIndentFor(this.node)}baseIndentFor(t){let e=this.state.doc.lineAt(t.from)
for(;;){let i=t.resolve(e.from)
for(;i.parent&&i.parent.from==i.from;)i=i.parent
if(Ta(i,t))break
e=this.state.doc.lineAt(i.from)}return this.lineIndent(e.from)}continue(){return Sa(this.context.next,this.base,this.pos)}}function Ta(t,e){for(let i=e;i;i=i.parent)if(t==i)return!0
return!1}const Oa=j.define(),Da=new el
function Ea(t){let e=t.lastChild
return e&&e.to==t.to&&e.type.isError}function Ba(t,e,i){for(let n of t.facet(Oa)){let s=n(t,e,i)
if(s)return s}return function(t,e,i){let n=ra(t)
if(n.length<i)return null
let s=null
for(let o=n.resolveStack(i,1);o;o=o.next){let r=o.node
if(r.to<=i||r.from>i)continue
if(s&&r.from<e)break
let l=r.type.prop(Da)
if(l&&(r.to<n.length-50||n.length==t.doc.length||!Ea(r))){let n=l(r,t)
n&&n.from<=i&&n.from>=e&&n.to>i&&(s=n)}}return s}(t,e,i)}function Ra(t,e){let i=e.mapPos(t.from,1),n=e.mapPos(t.to,-1)
return i>=n?void 0:{from:i,to:n}}const La=vt.define({map:Ra}),Ia=vt.define({map:Ra})
function Pa(t){let e=[]
for(let{head:i}of t.state.selection.ranges)e.some(t=>t.from<=i&&t.to>=i)||e.push(t.lineBlockAt(i))
return e}const Na=Q.define({create:()=>Oe.none,update(t,e){e.isUserEvent("delete")&&e.changes.iterChangedRanges((e,i)=>t=Wa(t,e,i)),t=t.map(e.changes)
for(let i of e.effects)if(i.is(La)&&!Va(t,i.value.from,i.value.to)){let{preparePlaceholder:n}=e.state.facet(Ka),s=n?Oe.replace({widget:new Ya(n(e.state,i.value))}):Ua
t=t.update({add:[s.range(i.value.from,i.value.to)]})}else i.is(Ia)&&(t=t.update({filter:(t,e)=>i.value.from!=t||i.value.to!=e,filterFrom:i.value.from,filterTo:i.value.to}))
return e.selection&&(t=Wa(t,e.selection.main.head)),t},provide:t=>po.decorations.from(t),toJSON(t,e){let i=[]
...
e.push(Ua.range(n,s))}return Oe.set(e,!0)}})
function Wa(t,e,i=e){let n=!1
return t.between(e,i,(t,s)=>{t<i&&s>e&&(n=!0)}),n?t.update({filterFrom:e,filterTo:i,filter:(t,n)=>t>=i||n<=e}):t}function Ha(t,e,i){var n
let s=null
return null===(n=t.field(Na,!1))||void 0===n||n.between(e,i,(t,e)=>{(!s||s.from>t)&&(s={from:t,to:e})}),s}function Va(t,e,i){let n=!1
return t.between(e,e,(t,s)=>{t==e&&s==i&&(n=!0)}),n}function Fa(t,e){return t.field(Na,!1)?e:e.concat(vt.appendConfig.of(ja()))}function za(t,e,i=!0){let n=t.state.doc.lineAt(e.from).number,s=t.state.doc.lineAt(e.to).number
return po.announce.of(`${t.state.phrase(i?"Folded lines":"Unfolded lines")} ${n} ${t.state.phrase("to")} ${s}.`)}const qa=[{key:"Ctrl-Shift-[",mac:"Cmd-Alt-[",run:t=>{for(let e of Pa(t)){let i=Ba(t.state,e.from,e.to)
if(i)return t.dispatch({effects:Fa(t.state,[La.of(i),za(t,i)])}),!0}return!1}},{key:"Ctrl-Shift-]",mac:"Cmd-Alt-]",run:t=>{if(!t.state.field(Na,!1))return!1
let e=[]
for(let i of Pa(t)){let n=Ha(t.state,i.from,i.to)
n&&e.push(Ia.of(n),za(t,n,!1))}return e.length&&t.dispatch({effects:e}),e.length>0}},{key:"Ctrl-Alt-[",run:t=>{let{state:e}=t,i=[]
for(let n=0;n<e.doc.length;){let s=t.lineBlockAt(n),o=Ba(e,s.from,s.to)
o&&i.push(La.of(o)),n=(o?t.lineBlockAt(o.to):s).to+1}return i.length&&t.dispatch({effects:Fa(t.state,i)}),!!i.length}},{key:"Ctrl-Alt-]",run:t=>{let e=t.state.field(Na,!1)
if(!e||!e.size)return!1
let i=[]
return e.between(0,t.state.doc.length,(t,e)=>{i.push(Ia.of({from:t,to:e}))}),t.dispatch({effects:i}),!0}}],_a={placeholderDOM:null,preparePlaceholder:null,placeholderText:"…"},Ka=j.define({combine:t=>Dt(t,_a)})
function ja(t){let e=[Na,Xa]
return t&&e.push(Ka.of(t)),e}function $a(t,e){let{state:i}=t,n=i.facet(Ka),s=e=>{let i=t.lineBlockAt(t.posAtDOM(e.target)),n=Ha(t.state,i.from,i.to)
n&&t.dispatch({effects:Ia.of(n)}),e.preventDefault()}
if(n.placeholderDOM)return n.placeholderDOM(t,s,e)
let o=document.createElement("span")
return o.textContent=n.placeholderText,o.setAttribute("aria-label",i.phrase("folded code")),o.title=i.phrase("unfold"),o.className="cm-foldPlaceholder",o.onclick=s,o}const Ua=Oe.replace({widget:new class extends Ae{toDOM(t){return $a(t,null)}}})
class Ya extends Ae{constructor(t){super(),this.value=t}eq(t){return this.value==t.value}toDOM(t){return $a(t,this.value)}}const Ga={openText:"⌄",closedText:"›",markerDOM:null,domEventHandlers:{},foldingChanged:()=>!1}
class Ja extends Dr{constructor(t,e){super(),this.config=t,this.open=e}eq(t){return this.config==t.config&&this.open==t.open}toDOM(t){if(this.config.markerDOM)return this.config.markerDOM(this.open)
let e=document.createElement("span")
return e.textContent=this.open?this.config.openText:this.config.closedText,e.title=t.state.phrase(this.open?"Fold line":"Unfold line"),e}}const Xa=po.baseTheme({".cm-foldPlaceholder":{backgroundColor:"#eee",border:"1px solid #ddd",color:"#888",borderRadius:".2em",margin:"0 1px",padding:"0 1px",cursor:"pointer"},".cm-foldGutter span":{padding:"0 1px",cursor:"pointer"}})
class Qa{constructor(t,e){let i
...
this.scope=o instanceof sa?t=>t.prop(ia)==o.data:o?t=>t==o:void 0,this.style=Nl(t.map(t=>({tag:t.tag,class:t.class||n(Object.assign({},t,{tag:null}))})),{all:s}).style,this.module=i?new Qt(i):null,this.themeType=e.themeType}static define(t,e){return new Qa(t,e||{})}}const Za=j.define(),th=j.define({combine:t=>t.length?[t[0]]:null})
function eh(t){let e=t.facet(Za)
return e.length?e:t.facet(th)}function ih(t,e){let i,n=[nh]
return t instanceof Qa&&(t.module&&n.push(po.styleModule.of(t.module)),i=t.themeType),(null==e?void 0:e.fallback)?n.push(th.of(t)):i?n.push(Za.computeN([po.darkTheme],e=>e.facet(po.darkTheme)==("dark"==i)?[t]:[])):n.push(Za.of(t)),n}const nh=tt.high(qi.fromClass(class{constructor(t){this.markCache=Object.create(null),this.tree=ra(t.state),this.decorations=this.buildDeco(t,eh(t.state)),this.decoratedTo=t.viewport.to}update(t){let e=ra(t.state),i=eh(t.state),n=i!=eh(t.startState),{viewport:s}=t.view,o=t.changes.mapPos(this.decoratedTo,1)
...
let i=new Nt
for(let{from:n,to:s}of t.visibleRanges)Wl(this.tree,e,(t,e,n)=>{i.add(t,e,this.markCache[n]||(this.markCache[n]=Oe.mark({class:n})))},n,s)
return i.finish()}},{decorations:t=>t.decorations})),sh=Qa.define([{tag:ta.meta,color:"#404740"},{tag:ta.link,textDecoration:"underline"},{tag:ta.heading,textDecoration:"underline",fontWeight:"bold"},{tag:ta.emphasis,fontStyle:"italic"},{tag:ta.strong,fontWeight:"bold"},{tag:ta.strikethrough,textDecoration:"line-through"},{tag:ta.keyword,color:"#708"},{tag:[ta.atom,ta.bool,ta.url,ta.contentSeparator,ta.labelName],color:"#219"},{tag:[ta.literal,ta.inserted],color:"#164"},{tag:[ta.string,ta.deleted],color:"#a11"},{tag:[ta.regexp,ta.escape,ta.special(ta.string)],color:"#e40"},{tag:ta.definition(ta.variableName),color:"#00f"},{tag:ta.local(ta.variableName),color:"#30a"},{tag:[ta.typeName,ta.namespace],color:"#085"},{tag:ta.className,color:"#167"},{tag:[ta.special(ta.variableName),ta.macroName],color:"#256"},{tag:ta.definition(ta.propertyName),color:"#00c"},{tag:ta.comment,color:"#940"},{tag:ta.invalid,color:"#f00"}]),oh=po.baseTheme({"&.cm-focused .cm-matchingBracket":{backgroundColor:"#328c8252"},"&.cm-focused .cm-nonmatchingBracket":{backgroundColor:"#bb555544"}}),rh="()[]{}",lh=j.define({combine:t=>Dt(t,{afterCursor:!0,brackets:rh,maxScanDistance:1e4,renderMatch:ch})}),ah=Oe.mark({class:"cm-matchingBracket"}),hh=Oe.mark({class:"cm-nonmatchingBracket"})
function ch(t){let e=[],i=t.matched?ah:hh
return e.push(i.range(t.start.from,t.start.to)),t.end&&e.push(i.range(t.end.from,t.end.to)),e}function uh(t){let e=[],i=t.facet(lh)
for(let n of t.selection.ranges){if(!n.empty)continue
let s=gh(t,n.head,-1,i)||n.head>0&&gh(t,n.head-1,1,i)||i.afterCursor&&(gh(t,n.head,1,i)||n.head<t.doc.length&&gh(t,n.head+1,-1,i))
s&&(e=e.concat(i.renderMatch(s,t)))}return Oe.set(e,!0)}const dh=[qi.fromClass(class{constructor(t){this.paused=!1,this.decorations=uh(t.state)}update(t){(t.docChanged||t.selectionSet||this.paused)&&(t.view.composing?(this.decorations=this.decorations.map(t.changes),this.paused=!0):(this.decorations=uh(t.state),this.paused=!1))}},{decorations:t=>t.decorations}),oh],fh=new el
function ph(t,e,i){let n=t.prop(e<0?el.openedBy:el.closedBy)
if(n)return n
if(1==t.name.length){let n=i.indexOf(t.name)
if(n>-1&&n%2==(e<0?1:0))return[i[n+e]]}return null}function mh(t){let e=t.type.prop(fh)
return e?e(t.node):t}function gh(t,e,i,n={}){let s=n.maxScanDistance||1e4,o=n.brackets||rh,r=ra(t),l=r.resolveInner(e,i)
for(let a=l;a;a=a.parent){let t=ph(a.type,i,o)
if(t&&a.from<a.to){let n=mh(a)
if(n&&(i>0?e>=n.from&&e<n.to:e>n.from&&e<=n.to))return vh(0,0,i,a,n,t,o)}}return function(t,e,i,n,s,o,r){if(i<0?!e:e==t.doc.length)return null
...
u--}}i>0&&(d+=t.length)}return c.done?{start:h,matched:!1}:null}(t,e,i,r,l.type,s,o)}function vh(t,e,i,n,s,o,r){let l=n.parent,a={from:s.from,to:s.to},h=0,c=null==l?void 0:l.cursor()
if(c&&(i<0?c.childBefore(n.from):c.childAfter(n.to)))do{if(i<0?c.to<=n.from:c.from>=n.to){if(0==h&&o.indexOf(c.type.name)>-1&&c.from<c.to){let t=mh(c)
return{start:a,end:t?{from:t.from,to:t.to}:void 0,matched:!0}}if(ph(c.type,i,r))h++
else if(ph(c.type,-i,r)){if(0==h){let t=mh(c)
return{start:a,end:t&&t.from<t.to?{from:t.from,to:t.to}:void 0,matched:!1}}h--}}}while(i<0?c.prevSibling():c.nextSibling())
return{start:a,matched:!1}}const wh=Object.create(null),bh=[sl.none],yh=[],xh=Object.create(null),kh=Object.create(null)
for(let[_f,Kf]of[["variable","variableName"],["variable-2","variableName.special"],["string-2","string.special"],["def","variableName.definition"],["tag","tagName"],["attribute","attributeName"],["type","typeName"],["builtin","variableName.standard"],["qualifier","modifier"],["error","invalid"],["header","heading"],["property","propertyName"]])kh[_f]=Ch(wh,Kf)
function Sh(t,e){yh.indexOf(t)>-1||(yh.push(t),console.warn(e))}function Ch(t,e){let i=[]
for(let l of e.split(" ")){let e=[]
for(let i of l.split(".")){let n=t[i]||ta[i]
n?"function"==typeof n?e.length?e=e.map(n):Sh(i,`Modifier ${i} used at start of tag`):e.length?Sh(i,`Tag ${i} used as modifier`):e=Array.isArray(n)?n:[n]:Sh(i,`Unknown highlighting tag ${i}`)}for(let t of e)i.push(t)}if(!i.length)return 0
let n=e.replace(/ /g,"_"),s=n+" "+i.map(t=>t.id),o=xh[s]
if(o)return o.id
let r=xh[s]=sl.define({id:bh.length,name:n,props:[Ll({[n]:i})]})
return bh.push(r),r.id}function Mh(t,e){return({state:i,dispatch:n})=>{if(i.readOnly)return!1
let s=t(e,i)
return!!s&&(n(i.update(s)),!0)}}si.RTL,si.LTR
const Ah=Mh(function(t,e,i=e.selection.ranges){let n=[],s=-1
t:for(let{from:o,to:r}of i){let t,i=n.length,l=1e9
for(let a=o;a<=r;){let i=e.doc.lineAt(a)
if(null==t&&(t=Dh(e,i.from).line,!t))continue t
...
" "==e.text[o-e.from]&&o++,t.push({from:n,to:o})}return{changes:t}}return null},0),Th=Mh(Eh,0),Oh=Mh((t,e)=>Eh(t,e,function(t){let e=[]
...
function Dh(t,e){let i=t.languageDataAt("commentTokens",e,1)
return i.length?i[0]:{}}function Eh(t,e,i=e.selection.ranges){let n=i.map(t=>Dh(e,t.from).block)
...
t.push({from:o.pos-s.open.length,to:o.pos+o.margin},{from:r.pos-r.margin,to:r.pos+s.close.length})}return{changes:t}}return null}const Bh=pt.define(),Rh=pt.define(),Lh=j.define(),Ih=j.define({combine:t=>Dt(t,{minDepth:100,newGroupDelay:500,joinToEvent:(t,e)=>e},{minDepth:Math.max,newGroupDelay:Math.min,joinToEvent:(t,e)=>(i,n)=>t(i,n)||e(i,n)})}),Ph=Q.define({create:()=>Jh.empty,update(t,e){let i=e.state.facet(Ih),n=e.annotation(Bh)
if(n){let s=zh.fromTransaction(e,n.selection),o=n.side,r=0==o?t.undone:t.done
return r=s?qh(r,r.length,i.minDepth,s):jh(r,e.startState.selection),new Jh(0==o?n.rest:r,0==o?r:n.rest)}let s=e.annotation(Rh)
if("full"!=s&&"before"!=s||(t=t.isolate()),!1===e.annotation(wt.addToHistory))return e.changes.empty?t:t.addMapping(e.changes.desc)
let o=zh.fromTransaction(e),r=e.annotation(wt.time),l=e.annotation(wt.userEvent)
return o?t=t.addChanges(o,r,l,i,e):e.selection&&(t=t.addSelection(e.startState.selection,r,l,i.newGroupDelay)),"full"!=s&&"after"!=s||(t=t.isolate()),t},toJSON:t=>({done:t.done.map(t=>t.toJSON()),undone:t.undone.map(t=>t.toJSON())}),fromJSON:t=>new Jh(t.done.map(zh.fromJSON),t.undone.map(zh.fromJSON))})
function Nh(t,e){return function({state:i,dispatch:n}){if(!e&&i.readOnly)return!1
let s=i.field(Ph,!1)
if(!s)return!1
let o=s.pop(t,i,e)
return!!o&&(n(o),!0)}}const Wh=Nh(0,!1),Hh=Nh(1,!1),Vh=Nh(0,!0),Fh=Nh(1,!0)
class zh{constructor(t,e,i,n,s){this.changes=t,this.effects=e,this.mapped=i,this.startSelection=n,this.selectionsAfter=s}setSelAfter(t){return new zh(this.changes,this.effects,this.mapped,this.startSelection,t)}toJSON(){var t,e,i
return{changes:null===(t=this.changes)||void 0===t?void 0:t.toJSON(),mapped:null===(e=this.mapped)||void 0===e?void 0:e.toJSON(),startSelection:null===(i=this.startSelection)||void 0===i?void 0:i.toJSON(),selectionsAfter:this.selectionsAfter.map(t=>t.toJSON())}}static fromJSON(t){return new zh(t.changes&&I.fromJSON(t.changes),[],t.mapped&&L.fromJSON(t.mapped),t.startSelection&&q.fromJSON(t.startSelection),t.selectionsAfter.map(q.fromJSON))}static fromTransaction(t,e){let i=Kh
for(let n of t.startState.facet(Lh)){let e=n(t)
e.length&&(i=i.concat(e))}return!i.length&&t.changes.empty?null:new zh(t.changes.invert(t.startState.doc),i,void 0,e||t.startState.selection,Kh)}static selection(t){return new zh(void 0,Kh,void 0,void 0,t)}}function qh(t,e,i,n){let s=e+1>i+20?e-i-1:0,o=t.slice(s,e)
return o.push(n),o}function _h(t,e){return t.length?e.length?t.concat(e):t:e}const Kh=[]
function jh(t,e){if(t.length){let i=t[t.length-1],n=i.selectionsAfter.slice(Math.max(0,i.selectionsAfter.length-200))
return n.length&&n[n.length-1].eq(e)?t:(n.push(e),qh(t,t.length-1,1e9,i.setSelAfter(n)))}return[zh.selection([e])]}function $h(t){let e=t[t.length-1],i=t.slice()
...
let i=t.length,n=Kh
for(;i;){let s=Yh(t[i-1],e,n)
if(s.changes&&!s.changes.empty||s.effects.length){let e=t.slice(0,i)
return e[i-1]=s,e}e=s.mapped,i--,n=s.selectionsAfter}return n.length?[zh.selection(n)]:Kh}function Yh(t,e,i){let n=_h(t.selectionsAfter.length?t.selectionsAfter.map(t=>t.map(e)):Kh,i)
if(!t.changes)return zh.selection(n)
let s=t.changes.map(e),o=e.mapDesc(t.changes,!0),r=t.mapped?t.mapped.composeDesc(o):o
return new zh(s,vt.mapEffects(t.effects,e),r,t.startSelection.map(o),n)}const Gh=/^(input\.type|delete)($|\.)/
class Jh{constructor(t,e,i=0,n=void 0){this.done=t,this.undone=e,this.prevTime=i,this.prevUserEvent=n}isolate(){return this.prevTime?new Jh(this.done,this.undone):this}addChanges(t,e,i,n,s){let o=this.done,r=o[o.length-1]
return o=r&&r.changes&&!r.changes.empty&&t.changes&&(!i||Gh.test(i))&&(!r.selectionsAfter.length&&e-this.prevTime<n.newGroupDelay&&n.joinToEvent(s,function(t,e){let i=[],n=!1
return t.iterChangedRanges((t,e)=>i.push(t,e)),e.iterChangedRanges((t,e,s,o)=>{for(let r=0;r<i.length;){let t=i[r++],e=i[r++]
o>=t&&s<=e&&(n=!0)}}),n}(r.changes,t.changes))||"input.type.compose"==i)?qh(o,o.length-1,n.minDepth,new zh(t.changes.compose(r.changes),_h(vt.mapEffects(t.effects,r.changes),r.effects),r.mapped,r.startSelection,Kh)):qh(o,o.length,n.minDepth,t),new Jh(o,Kh,e,i)}addSelection(t,e,i,n){let s=this.done.length?this.done[this.done.length-1].selectionsAfter:Kh
return s.length>0&&e-this.prevTime<n&&i==this.prevUserEvent&&i&&/^select($|\.)/.test(i)&&(o=s[s.length-1],r=t,o.ranges.length==r.ranges.length&&0===o.ranges.filter((t,e)=>t.empty!=r.ranges[e].empty).length)?this:new Jh(jh(this.done,t),this.undone,e,i)
var o,r}addMapping(t){return new Jh(Uh(this.done,t),Uh(this.undone,t),this.prevTime,this.prevUserEvent)}pop(t,e,i){let n=0==t?this.done:this.undone
if(0==n.length)return null
let s=n[n.length-1],o=s.selectionsAfter[0]||(s.startSelection?s.startSelection.map(s.changes.invertedDesc,1):e.selection)
if(i&&s.selectionsAfter.length)return e.update({selection:s.selectionsAfter[s.selectionsAfter.length-1],annotations:Bh.of({side:t,rest:$h(n),selection:o}),userEvent:0==t?"select.undo":"select.redo",scrollIntoView:!0})
if(s.changes){let i=1==n.length?Kh:n.slice(0,n.length-1)
return s.mapped&&(i=Uh(i,s.mapped)),e.update({changes:s.changes,selection:s.startSelection,effects:s.effects,annotations:Bh.of({side:t,rest:i,selection:o}),filter:!1,userEvent:0==t?"undo":"redo",scrollIntoView:!0})}return null}}Jh.empty=new Jh(Kh,Kh)
const Xh=[{key:"Mod-z",run:Wh,preventDefault:!0},{key:"Mod-y",mac:"Mod-Shift-z",run:Hh,preventDefault:!0},{linux:"Ctrl-Shift-z",run:Hh,preventDefault:!0},{key:"Mod-u",run:Vh,preventDefault:!0},{key:"Alt-u",mac:"Mod-Shift-u",run:Fh,preventDefault:!0}]
function Qh(t,e){return q.create(t.ranges.map(e),t.mainIndex)}function Zh(t,e){return t.update({selection:e,scrollIntoView:!0,userEvent:"select"})}function tc({state:t,dispatch:e},i){let n=Qh(t.selection,i)
return!n.eq(t.selection,!0)&&(e(Zh(t,n)),!0)}function ec(t,e){return q.cursor(e?t.to:t.from)}function ic(t,e){return tc(t,i=>i.empty?t.moveByChar(i,e):ec(i,e))}function nc(t){return t.textDirectionAt(t.state.selection.main.head)==si.LTR}const sc=t=>ic(t,!nc(t)),oc=t=>ic(t,nc(t))
function rc(t,e){return tc(t,i=>i.empty?t.moveByGroup(i,e):ec(i,e))}function lc(t,e,i){if(e.type.prop(i))return!0
let n=e.to-e.from
return n&&(n>2||/[^\s,.;:]/.test(t.sliceDoc(e.from,e.to)))||e.firstChild}function ac(t,e,i){let n,s,o=ra(t).resolveInner(e.head),r=i?el.closedBy:el.openedBy
for(let l=e.head;;){let e=i?o.childAfter(l):o.childBefore(l)
if(!e)break
lc(t,e,r)?o=e:l=i?e.to:e.from}return s=o.type.prop(r)&&(n=i?gh(t,o.from,1):gh(t,o.to,-1))&&n.matched?i?n.end.to:n.end.from:i?o.to:o.from,q.cursor(s,i?-1:1)}function hc(t,e){return tc(t,i=>{if(!i.empty)return ec(i,e)
let n=t.moveVertically(i,e)
return n.head!=i.head?n:t.moveToLineBoundary(i,e)})}"undefined"!=typeof Intl&&Intl.Segmenter
const cc=t=>hc(t,!1),uc=t=>hc(t,!0)
function dc(t){let e,i=t.scrollDOM.clientHeight<t.scrollDOM.scrollHeight-2,n=0,s=0
...
return{marginTop:n,marginBottom:s,selfScroll:i,height:Math.max(t.defaultLineHeight,e-5)}}function fc(t,e){let i,n=dc(t),{state:s}=t,o=Qh(s.selection,i=>i.empty?t.moveVertically(i,e,n.height):ec(i,e))
...
e&&e.top>l&&e.bottom<a&&(i=po.scrollIntoView(o.main.head,{y:"start",yMargin:e.top-l}))}return t.dispatch(Zh(s,o),{effects:i}),!0}const pc=t=>fc(t,!1),mc=t=>fc(t,!0)
function gc(t,e,i){let n=t.lineBlockAt(e.head),s=t.moveToLineBoundary(e,i)
...
i&&e.head!=n.from+i&&(s=q.cursor(n.from+i))}return s}function vc(t,e){let i=Qh(t.state.selection,t=>{let i=e(t)
return q.range(t.anchor,i.head,i.goalColumn,i.bidiLevel||void 0,i.assoc)})
return!i.eq(t.state.selection)&&(t.dispatch(Zh(t.state,i)),!0)}function wc(t,e){return vc(t,i=>t.moveByChar(i,e))}const bc=t=>wc(t,!nc(t)),yc=t=>wc(t,nc(t))
function xc(t,e){return vc(t,i=>t.moveByGroup(i,e))}function kc(t,e){return vc(t,i=>t.moveVertically(i,e))}const Sc=t=>kc(t,!1),Cc=t=>kc(t,!0)
function Mc(t,e){return vc(t,i=>t.moveVertically(i,e,dc(t).height))}const Ac=t=>Mc(t,!1),Tc=t=>Mc(t,!0),Oc=({state:t,dispatch:e})=>(e(Zh(t,{anchor:0})),!0),Dc=({state:t,dispatch:e})=>(e(Zh(t,{anchor:t.doc.length})),!0),Ec=({state:t,dispatch:e})=>(e(Zh(t,{anchor:t.selection.main.anchor,head:0})),!0),Bc=({state:t,dispatch:e})=>(e(Zh(t,{anchor:t.selection.main.anchor,head:t.doc.length})),!0)
function Rc(t,e){let{state:i}=t,n=i.selection,s=i.selection.ranges.slice()
...
i=o}}return s.length!=n.ranges.length&&(t.dispatch(Zh(i,q.create(s,s.length-1))),!0)}function Lc(t,e){if(t.state.readOnly)return!1
let i="delete.selection",{state:n}=t,s=n.changeByRange(n=>{let{from:s,to:o}=n
if(s==o){let r=e(n)
r<s?(i="delete.backward",r=Ic(t,r,!1)):r>s&&(i="delete.forward",r=Ic(t,r,!0)),s=Math.min(s,r),o=Math.max(o,r)}else s=Ic(t,s,!1),o=Ic(t,o,!0)
return s==o?{range:n}:{changes:{from:s,to:o},range:q.cursor(s,s<n.head?-1:1)}})
return!s.changes.empty&&(t.dispatch(n.update(s,{scrollIntoView:!0,userEvent:i,effects:"delete.selection"==i?po.announce.of(n.phrase("Selection deleted")):void 0})),!0)}function Ic(t,e,i){if(t instanceof po)for(let n of t.state.facet(po.atomicRanges).map(e=>e(t)))n.between(e,e,(t,n)=>{t<e&&n>e&&(e=i?n:t)})
return e}const Pc=(t,e,i)=>Lc(t,n=>{let s,o,r=n.from,{state:l}=t,a=l.doc.lineAt(r)
if(i&&!e&&r>a.from&&r<a.from+200&&!/[^ \t]/.test(s=a.text.slice(0,r-a.from))){if("\t"==s[s.length-1])return r-1
let t=Ut(s,l.tabSize)%wa(l)||wa(l)
...
return o}),Nc=t=>Pc(t,!1,!0),Wc=t=>Pc(t,!0,!1),Hc=(t,e)=>Lc(t,i=>{let n=i.head,{state:s}=t,o=s.doc.lineAt(n),r=s.charCategorizer(n)
...
if(null!=t&&h!=t)break
" "==a&&n==i.head||(t=h),n=l}return n}),Vc=t=>Hc(t,!1)
function Fc(t){let e=[],i=-1
...
i=o.number+1}return e}function zc(t,e,i){if(t.readOnly)return!1
let n=[],s=[]
for(let o of Fc(t)){if(i?o.to==t.doc.length:0==o.from)continue
...
for(let t of o.ranges)s.push(q.range(t.anchor-r,t.head-r))}}return!!n.length&&(e(t.update({changes:n,scrollIntoView:!0,selection:q.create(s,t.selection.mainIndex),userEvent:"move.line"})),!0)}function qc(t,e,i){if(t.readOnly)return!1
let n=[]
for(let o of Fc(t))i?n.push({from:o.from,insert:t.doc.slice(o.from,o.to)+t.lineBreak}):n.push({from:o.to,insert:t.lineBreak+t.doc.slice(o.from,o.to)})
let s=t.changes(n)
return e(t.update({changes:s,selection:t.selection.map(s,i?1:-1),scrollIntoView:!0,userEvent:"input.copyline"})),!0}const _c=Kc(!1)
function Kc(t){return({state:e,dispatch:i})=>{if(e.readOnly)return!1
...
let i,n=ra(t).resolveInner(e),s=n.childBefore(e),o=n.childAfter(e)
return s&&o&&s.to<=e&&o.from>=e&&(i=s.type.prop(el.closedBy))&&i.indexOf(o.name)>-1&&t.doc.lineAt(s.to).from==t.doc.lineAt(o.from).from&&!/\S/.test(t.sliceDoc(s.to,o.from))?{from:s.to,to:o.from}:null}(e,n)
t&&(n=s=(s<=o.to?o:e.doc.lineAt(s)).to)
let l=new xa(e,{simulateBreak:n,simulateDoubleBreak:!!r}),a=ya(l,n)
...
let h=["",ba(e,a)]
return r&&h.push(ba(e,l.lineIndent(o.from,-1))),{changes:{from:n,to:s,insert:v.of(h)},range:q.cursor(n+1+h[1].length)}})
return i(e.update(n,{scrollIntoView:!0,userEvent:"input"})),!0}}function jc(t,e){let i=-1
...
return{changes:s,range:q.range(o.mapPos(n.anchor,1),o.mapPos(n.head,1))}})}const $c=({state:t,dispatch:e})=>!t.readOnly&&(e(t.update(jc(t,(e,i)=>{i.push({from:e.from,insert:t.facet(va)})}),{userEvent:"input.indent"})),!0),Uc=({state:t,dispatch:e})=>!t.readOnly&&(e(t.update(jc(t,(e,i)=>{let n=/^\s*/.exec(e.text)[0]
if(!n)return
let s=Ut(n,t.tabSize),o=0,r=ba(t,Math.max(0,s-wa(t)))
for(;o<n.length&&o<r.length&&n.charCodeAt(o)==r.charCodeAt(o);)o++
i.push({from:e.from+o,to:e.from+n.length,insert:r.slice(o)})}),{userEvent:"delete.dedent"})),!0),Yc=[{key:"Alt-ArrowLeft",mac:"Ctrl-ArrowLeft",run:t=>tc(t,e=>ac(t.state,e,!nc(t))),shift:t=>vc(t,e=>ac(t.state,e,!nc(t)))},{key:"Alt-ArrowRight",mac:"Ctrl-ArrowRight",run:t=>tc(t,e=>ac(t.state,e,nc(t))),shift:t=>vc(t,e=>ac(t.state,e,nc(t)))},{key:"Alt-ArrowUp",run:({state:t,dispatch:e})=>zc(t,e,!1)},{key:"Shift-Alt-ArrowUp",run:({state:t,dispatch:e})=>qc(t,e,!1)},{key:"Alt-ArrowDown",run:({state:t,dispatch:e})=>zc(t,e,!0)},{key:"Shift-Alt-ArrowDown",run:({state:t,dispatch:e})=>qc(t,e,!0)},{key:"Mod-Alt-ArrowUp",run:t=>Rc(t,!1)},{key:"Mod-Alt-ArrowDown",run:t=>Rc(t,!0)},{key:"Escape",run:({state:t,dispatch:e})=>{let i=t.selection,n=null
return i.ranges.length>1?n=q.create([i.main]):i.main.empty||(n=q.create([q.cursor(i.main.head)])),!!n&&(e(Zh(t,n)),!0)}},{key:"Mod-Enter",run:Kc(!0)},{key:"Alt-l",mac:"Ctrl-l",run:({state:t,dispatch:e})=>{let i=Fc(t).map(({from:e,to:i})=>q.range(e,Math.min(i+1,t.doc.length)))
return e(t.update({selection:q.create(i),userEvent:"select"})),!0}},{key:"Mod-i",run:({state:t,dispatch:e})=>{let i=Qh(t.selection,e=>{let i=ra(t),n=i.resolveStack(e.from,1)
...
return!i.eq(t.selection)&&(e(Zh(t,i)),!0)},preventDefault:!0},{key:"Mod-[",run:Uc},{key:"Mod-]",run:$c},{key:"Mod-Alt-\\",run:({state:t,dispatch:e})=>{if(t.readOnly)return!1
let i=Object.create(null),n=new xa(t,{overrideIndentation:t=>{let e=i[t]
return null==e?-1:e}}),s=jc(t,(e,s,o)=>{let r=ya(n,e.from)
if(null==r)return;/\S/.test(e.text)||(r=0)
let l=/^\s*/.exec(e.text)[0],a=ba(t,r);(l!=a||o.from<e.from+l.length)&&(i[e.from]=r,s.push({from:e.from,to:e.from+l.length,insert:a}))})
return s.changes.empty||e(t.update(s,{userEvent:"indent"})),!0}},{key:"Shift-Mod-k",run:t=>{if(t.state.readOnly)return!1
let{state:e}=t,i=e.changes(Fc(e).map(({from:t,to:i})=>(t>0?t--:i<e.doc.length&&i++,{from:t,to:i}))),n=Qh(e.selection,e=>{let i
...
return t.dispatch({changes:i,selection:n,scrollIntoView:!0,userEvent:"delete.line"}),!0}},{key:"Shift-Mod-\\",run:({state:t,dispatch:e})=>function(t,e){let i=!1,n=Qh(t.selection,e=>{let n=gh(t,e.head,-1)||gh(t,e.head,1)||e.head>0&&gh(t,e.head-1,1)||e.head<t.doc.length&&gh(t,e.head+1,-1)
if(!n||!n.end)return e
i=!0
let s=n.start.from==e.head?n.end.to:n.end.from
return q.cursor(s)})
return!!i&&(e(Zh(t,n)),!0)}(t,e)},{key:"Mod-/",run:t=>{let{state:e}=t,i=e.doc.lineAt(e.selection.main.from),n=Dh(t.state,i.from)
return n.line?Ah(t):!!n.block&&Oh(t)}},{key:"Alt-A",run:Th},{key:"Ctrl-m",mac:"Shift-Alt-m",run:t=>(t.setTabFocusMode(),!0)}].concat([{key:"ArrowLeft",run:sc,shift:bc,preventDefault:!0},{key:"Mod-ArrowLeft",mac:"Alt-ArrowLeft",run:t=>rc(t,!nc(t)),shift:t=>xc(t,!nc(t)),preventDefault:!0},{mac:"Cmd-ArrowLeft",run:t=>tc(t,e=>gc(t,e,!nc(t))),shift:t=>vc(t,e=>gc(t,e,!nc(t))),preventDefault:!0},{key:"ArrowRight",run:oc,shift:yc,preventDefault:!0},{key:"Mod-ArrowRight",mac:"Alt-ArrowRight",run:t=>rc(t,nc(t)),shift:t=>xc(t,nc(t)),preventDefault:!0},{mac:"Cmd-ArrowRight",run:t=>tc(t,e=>gc(t,e,nc(t))),shift:t=>vc(t,e=>gc(t,e,nc(t))),preventDefault:!0},{key:"ArrowUp",run:cc,shift:Sc,preventDefault:!0},{mac:"Cmd-ArrowUp",run:Oc,shift:Ec},{mac:"Ctrl-ArrowUp",run:pc,shift:Ac},{key:"ArrowDown",run:uc,shift:Cc,preventDefault:!0},{mac:"Cmd-ArrowDown",run:Dc,shift:Bc},{mac:"Ctrl-ArrowDown",run:mc,shift:Tc},{key:"PageUp",run:pc,shift:Ac},{key:"PageDown",run:mc,shift:Tc},{key:"Home",run:t=>tc(t,e=>gc(t,e,!1)),shift:t=>vc(t,e=>gc(t,e,!1)),preventDefault:!0},{key:"Mod-Home",run:Oc,shift:Ec},{key:"End",run:t=>tc(t,e=>gc(t,e,!0)),shift:t=>vc(t,e=>gc(t,e,!0)),preventDefault:!0},{key:"Mod-End",run:Dc,shift:Bc},{key:"Enter",run:_c,shift:_c},{key:"Mod-a",run:({state:t,dispatch:e})=>(e(t.update({selection:{anchor:0,head:t.doc.length},userEvent:"select"})),!0)},{key:"Backspace",run:Nc,shift:Nc,preventDefault:!0},{key:"Delete",run:Wc,preventDefault:!0},{key:"Mod-Backspace",mac:"Alt-Backspace",run:Vc,preventDefault:!0},{key:"Mod-Delete",mac:"Alt-Delete",run:t=>Hc(t,!0),preventDefault:!0},{mac:"Mod-Backspace",run:t=>Lc(t,e=>{let i=t.moveToLineBoundary(e,!1).head
return e.head>i?i:Math.max(0,e.head-1)}),preventDefault:!0},{mac:"Mod-Delete",run:t=>Lc(t,e=>{let i=t.moveToLineBoundary(e,!0).head
return e.head<i?i:Math.min(t.state.doc.length,e.head+1)}),preventDefault:!0}].concat([{key:"Ctrl-b",run:sc,shift:bc,preventDefault:!0},{key:"Ctrl-f",run:oc,shift:yc},{key:"Ctrl-p",run:cc,shift:Sc},{key:"Ctrl-n",run:uc,shift:Cc},{key:"Ctrl-a",run:t=>tc(t,e=>q.cursor(t.lineBlockAt(e.head).from,1)),shift:t=>vc(t,e=>q.cursor(t.lineBlockAt(e.head).from))},{key:"Ctrl-e",run:t=>tc(t,e=>q.cursor(t.lineBlockAt(e.head).to,-1)),shift:t=>vc(t,e=>q.cursor(t.lineBlockAt(e.head).to))},{key:"Ctrl-d",run:Wc},{key:"Ctrl-h",run:Nc},{key:"Ctrl-k",run:t=>Lc(t,e=>{let i=t.lineBlockAt(e.head).to
return e.head<i?i:Math.min(t.state.doc.length,e.head+1)})},{key:"Ctrl-Alt-h",run:Vc},{key:"Ctrl-o",run:({state:t,dispatch:e})=>{if(t.readOnly)return!1
...
return!i.changes.empty&&(e(t.update(i,{scrollIntoView:!0,userEvent:"move.character"})),!0)}},{key:"Ctrl-v",run:mc}].map(t=>({mac:t.key,run:t.run,shift:t.shift})))),Gc={key:"Tab",run:$c,shift:Uc},Jc="function"==typeof String.prototype.normalize?t=>t.normalize("NFKD"):t=>t
class Xc{constructor(t,e,i=0,n=t.length,s,o){this.test=o,this.value={from:0,to:0,precise:!1},this.done=!1,this.matches=[],this.buffer="",this.bufferPos=0,this.iter=t.iterRange(i,n),this.bufferStart=i,this.normalize=s?t=>s(Jc(t)):Jc,this.query=this.normalize(e)}peek(){if(this.bufferPos==this.buffer.length){if(this.bufferStart+=this.buffer.length,this.iter.next(),this.iter.done)return-1
...
this.query.charCodeAt(e.index)==t&&(e.index==this.query.length-1?o={from:e.from,to:n,precise:s&&e.precise}:(e.index++,i=!0)),i?r++:this.matches.splice(r,1)}return this.query.charCodeAt(0)==t&&(1==this.query.length?o={from:e,to:n,precise:i&&s}:this.matches.push({from:e,index:1,precise:i})),o&&this.test&&!this.test(o.from,o.to,this.buffer,this.bufferStart)&&(o=null),o}}"undefined"!=typeof Symbol&&(Xc.prototype[Symbol.iterator]=function(){return this})
const Qc={from:-1,to:-1,match:/.*/.exec(""),precise:!0},Zc="gm"+(null==/x/.unicode?"":"u")
class tu{constructor(t,e,i,n=0,s=t.length){if(this.text=t,this.to=s,this.curLine="",this.done=!1,this.value=Qc,/\\[sWDnr]|\n|\r|\[\^/.test(e))return new nu(t,e,i,n,s)
this.re=new RegExp(e,Zc+((null==i?void 0:i.ignoreCase)?"i":"")),this.test=null==i?void 0:i.test,this.iter=t.iter()
let o=t.lineAt(n)
this.curLineStart=o.from,this.matchPos=su(t,n),this.getLine(this.curLineStart)}getLine(t){this.iter.next(t),this.iter.lineBreak?this.curLine="":(this.curLine=this.iter.value,this.curLineStart+this.curLine.length>this.to&&(this.curLine=this.curLine.slice(0,this.to-this.curLineStart)),this.iter.next())}nextLine(){this.curLineStart=this.curLineStart+this.curLine.length+1,this.curLineStart>this.to?this.curLine="":this.getLine(0)}next(){for(let t=this.matchPos-this.curLineStart;;){this.re.lastIndex=t
let e=this.matchPos<=this.to&&this.re.exec(this.curLine)
if(e){let i=this.curLineStart+e.index,n=i+e[0].length
if(this.matchPos=su(this.text,n+(i==n?1:0)),i==this.curLineStart+this.curLine.length&&this.nextLine(),(i<n||i>this.value.to)&&(!this.test||this.test(i,n,e)))return this.value={from:i,to:n,precise:!0,match:e},this
t=this.matchPos-this.curLineStart}else{if(!(this.curLineStart+this.curLine.length<this.to))return this.done=!0,this
this.nextLine(),t=0}}}}const eu=new WeakMap
class iu{constructor(t,e){this.from=t,this.text=e}get to(){return this.from+this.text.length}static get(t,e,i){let n=eu.get(t)
if(!n||n.from>=i||n.to<=e){let n=new iu(e,t.sliceString(e,i))
return eu.set(t,n),n}if(n.from==e&&n.to==i)return n
let{text:s,from:o}=n
return o>e&&(s=t.sliceString(e,o)+s,o=e),n.to<i&&(s+=t.sliceString(n.to,i)),eu.set(t,new iu(o,s)),new iu(e,s.slice(e-o,i-o))}}class nu{constructor(t,e,i,n,s){this.text=t,this.to=s,this.done=!1,this.value=Qc,this.matchPos=su(t,n),this.re=new RegExp(e,Zc+((null==i?void 0:i.ignoreCase)?"i":"")),this.test=null==i?void 0:i.test,this.flat=iu.get(t,n,this.chunkEnd(n+5e3))}chunkEnd(t){return t>=this.to?this.to:this.text.lineAt(t).to}next(){for(;;){let t=this.re.lastIndex=this.matchPos-this.flat.from,e=this.re.exec(this.flat.text)
if(e&&!e[0]&&e.index==t&&(this.re.lastIndex=t+1,e=this.re.exec(this.flat.text)),e){let t=this.flat.from+e.index,i=t+e[0].length
if((this.flat.to>=this.to||e.index+e[0].length<=this.flat.text.length-10)&&(!this.test||this.test(t,i,e)))return this.value={from:t,to:i,precise:!0,match:e},this.matchPos=su(this.text,i+(t==i?1:0)),this}if(this.flat.to==this.to)return this.done=!0,this
this.flat=iu.get(this.text,this.flat.from,this.chunkEnd(this.flat.from+2*this.flat.text.length))}}}function su(t,e){if(e>=t.length)return e
let i,n=t.lineAt(e)
for(;e<n.to&&(i=n.text.charCodeAt(e-n.from))>=56320&&i<57344;)e++
return e}"undefined"!=typeof Symbol&&(tu.prototype[Symbol.iterator]=nu.prototype[Symbol.iterator]=function(){return this})
const ou={highlightWordAroundCursor:!1,minSelectionLength:1,maxMatches:100,wholeWords:!1},ru=j.define({combine:t=>Dt(t,ou,{highlightWordAroundCursor:(t,e)=>t||e,minSelectionLength:Math.min,maxMatches:Math.min})}),lu=Oe.mark({class:"cm-selectionMatch"}),au=Oe.mark({class:"cm-selectionMatch cm-selectionMatch-main"})
function hu(t,e,i,n){return!(0!=i&&t(e.sliceDoc(i-1,i))==Mt.Word||n!=e.doc.length&&t(e.sliceDoc(n,n+1))==Mt.Word)}const cu=qi.fromClass(class{constructor(t){this.decorations=this.getDeco(t)}update(t){(t.selectionSet||t.docChanged||t.viewportChanged)&&(this.decorations=this.getDeco(t.view))}getDeco(t){let e=t.state.facet(ru),{state:i}=t,n=i.selection
...
if(e.wholeWords){if(s=i.sliceDoc(o.from,o.to),r=i.charCategorizer(o.head),!hu(r,i,o.from,o.to)||!function(t,e,i,n){return t(e.sliceDoc(i,i+1))==Mt.Word&&t(e.sliceDoc(n-1,n))==Mt.Word}(r,i,o.from,o.to))return Oe.none}else if(s=i.sliceDoc(o.from,o.to),!s)return Oe.none}let l=[]
for(let a of t.visibleRanges){let t=new Xc(i.doc,s,a.from,a.to)
for(;!t.next().done;){let{from:n,to:s}=t.value
if((!r||hu(r,i,n,s))&&(o.empty&&n<=o.from&&s>=o.to?l.push(au.range(n,s)):(n>=o.to||s<=o.from)&&l.push(lu.range(n,s)),l.length>e.maxMatches))return Oe.none}}return Oe.set(l)}},{decorations:t=>t.decorations}),uu=po.baseTheme({".cm-selectionMatch":{backgroundColor:"#99ff7780"},".cm-searchMatch .cm-selectionMatch":{backgroundColor:"transparent"}}),du=j.define({combine:t=>Dt(t,{top:!1,caseSensitive:!1,literal:!1,regexp:!1,wholeWord:!1,createPanel:t=>new zu(t),scrollToMatch:t=>po.scrollIntoView(t)})})
class fu{constructor(t){this.search=t.search,this.caseSensitive=!!t.caseSensitive,this.literal=!!t.literal,this.regexp=!!t.regexp,this.replace=t.replace||"",this.valid=!!this.search&&(!this.regexp||function(t){try{return new RegExp(t,Zc),!0}catch(t){return!1}}(this.search)),this.unquoted=this.unquote(this.search),this.wholeWord=!!t.wholeWord,this.test=t.test}unquote(t){return this.literal?t:t.replace(/\\([nrt\\])/g,(t,e)=>"n"==e?"\n":"r"==e?"\r":"t"==e?"\t":"\\")}eq(t){return this.search==t.search&&this.replace==t.replace&&this.caseSensitive==t.caseSensitive&&this.regexp==t.regexp&&this.wholeWord==t.wholeWord&&this.test==t.test}create(){return this.regexp?new yu(this):new gu(this)}getCursor(t,e=0,i){let n=t.doc?t:Ot.create({doc:t})
return null==i&&(i=n.doc.length),this.regexp?vu(this,n,e,i):mu(this,n,e,i)}}class pu{constructor(t){this.spec=t}}function mu(t,e,i,n){let s
return t.wholeWord&&(s=function(t,e){return(i,n,s,o)=>((o>i||o+s.length<n)&&(o=Math.max(0,i-2),s=t.sliceString(o,Math.min(t.length,n+2))),!(e(wu(s,i-o))==Mt.Word&&e(bu(s,i-o))==Mt.Word||e(bu(s,n-o))==Mt.Word&&e(wu(s,n-o))==Mt.Word))}(e.doc,e.charCategorizer(e.selection.main.head))),t.test&&(s=function(t,e,i){return(n,s,o,r)=>{if(i&&!i(n,s,o,r))return!1
let l=n>=r&&s<=r+o.length?o.slice(n-r,s-r):e.doc.sliceString(n,s)
return t(l,e,n,s)}}(t.test,e,s)),new Xc(e.doc,t.unquoted,i,n,t.caseSensitive?void 0:t=>t.toLowerCase(),s)}class gu extends pu{constructor(t){super(t)}nextMatch(t,e,i){let n=mu(this.spec,t,i,t.doc.length).nextOverlapping()
if(n.done){let i=Math.min(t.doc.length,e+this.spec.unquoted.length)
n=mu(this.spec,t,0,i).nextOverlapping()}return n.done||n.value.from==e&&n.value.to==i?null:n.value}prevMatchInRange(t,e,i){for(let n=i;;){let i=Math.max(e,n-1e4-this.spec.unquoted.length),s=mu(this.spec,t,i,n),o=null
for(;!s.nextOverlapping().done;)o=s.value
if(o)return o
if(i==e)return null
n-=1e4}}prevMatch(t,e,i){let n=this.prevMatchInRange(t,0,e)
return n||(n=this.prevMatchInRange(t,Math.max(0,i-this.spec.unquoted.length),t.doc.length)),!n||n.from==e&&n.to==i?null:n}getReplacement(t){return this.spec.unquote(this.spec.replace)}matchAll(t,e){let i=mu(this.spec,t,0,t.doc.length),n=[]
for(;!i.next().done;){if(n.length>=e)return null
n.push(i.value)}return n}highlight(t,e,i,n){let s=mu(this.spec,t,Math.max(0,e-this.spec.unquoted.length),Math.min(i+this.spec.unquoted.length,t.doc.length))
for(;!s.next().done;)n(s.value.from,s.value.to)}}function vu(t,e,i,n){let s
var o
return t.wholeWord&&(o=e.charCategorizer(e.selection.main.head),s=(t,e,i)=>!i[0].length||(o(wu(i.input,i.index))!=Mt.Word||o(bu(i.input,i.index))!=Mt.Word)&&(o(bu(i.input,i.index+i[0].length))!=Mt.Word||o(wu(i.input,i.index+i[0].length))!=Mt.Word)),t.test&&(s=function(t,e,i){return(n,s,o)=>(!i||i(n,s,o))&&t(o[0],e,n,s)}(t.test,e,s)),new tu(e.doc,t.search,{ignoreCase:!t.caseSensitive,test:s},i,n)}function wu(t,e){return t.slice(T(t,e,!1),e)}function bu(t,e){return t.slice(e,T(t,e))}class yu extends pu{nextMatch(t,e,i){let n=vu(this.spec,t,i,t.doc.length).next()
return n.done&&(n=vu(this.spec,t,0,e).next()),n.done?null:n.value}prevMatchInRange(t,e,i){for(let n=1;;n++){let s=Math.max(e,i-1e4*n),o=vu(this.spec,t,s,i),r=null
...
if(e>0&&e<t.match.length)return t.match[e]+i.slice(n)}return e})}matchAll(t,e){let i=vu(this.spec,t,0,t.doc.length),n=[]
for(;!i.next().done;){if(n.length>=e)return null
n.push(i.value)}return n}highlight(t,e,i,n){let s=vu(this.spec,t,Math.max(0,e-250),Math.min(i+250,t.doc.length))
for(;!s.next().done;)n(s.value.from,s.value.to)}}const xu=vt.define(),ku=vt.define(),Su=Q.define({create:t=>new Cu(Pu(t).create(),null),update(t,e){for(let i of e.effects)i.is(xu)?t=new Cu(i.value.create(),t.panel):i.is(ku)&&(t=new Cu(t.query,i.value?Iu:null))
return t},provide:t=>Mr.from(t,t=>t.panel)})
class Cu{constructor(t,e){this.query=t,this.panel=e}}const Mu=Oe.mark({class:"cm-searchMatch"}),Au=Oe.mark({class:"cm-searchMatch cm-searchMatch-selected"}),Tu=qi.fromClass(class{constructor(t){this.view=t,this.decorations=this.highlight(t.state.field(Su))}update(t){let e=t.state.field(Su);(e!=t.startState.field(Su)||t.docChanged||t.selectionSet||t.viewportChanged)&&(this.decorations=this.highlight(e))}highlight({query:t,panel:e}){if(!e||!t.spec.valid)return Oe.none
...
n.add(t,e,s?Au:Mu)})}return n.finish()}},{decorations:t=>t.decorations})
function Ou(t){return e=>{let i=e.state.field(Su,!1)
return i&&i.query.spec.valid?t(e,i):Hu(e)}}const Du=Ou((t,{query:e})=>{let{to:i}=t.state.selection.main,n=e.nextMatch(t.state,i,i)
if(!n)return!1
let s=q.single(n.from,n.to),o=t.state.facet(du)
return t.dispatch({selection:s,effects:[Ku(t,n),o.scrollToMatch(s.main,t)],userEvent:"select.search"}),Wu(t),!0}),Eu=Ou((t,{query:e})=>{let{state:i}=t,{from:n}=i.selection.main,s=e.prevMatch(i,n,n)
if(!s)return!1
let o=q.single(s.from,s.to),r=t.state.facet(du)
return t.dispatch({selection:o,effects:[Ku(t,s),r.scrollToMatch(o.main,t)],userEvent:"select.search"}),Wu(t),!0}),Bu=Ou((t,{query:e})=>{let i=e.matchAll(t.state,1e3)
return!(!i||!i.length||(t.dispatch({selection:q.create(i.map(t=>q.range(t.from,t.to))),userEvent:"select.search.matches"}),0))}),Ru=Ou((t,{query:e})=>{let{state:i}=t,{from:n,to:s}=i.selection.main
...
return a&&(r=q.single(a.from,a.to).map(u),c.push(Ku(t,a)),c.push(i.facet(du).scrollToMatch(r.main,t))),t.dispatch({changes:u,selection:r,effects:c,userEvent:"input.replace"}),!0}),Lu=Ou((t,{query:e})=>{if(t.state.readOnly)return!1
let i=[]
...
function Iu(t){return t.state.facet(du).createPanel(t)}function Pu(t,e){var i,n,s,o,r
let l=t.selection.main,a=l.empty||l.to>l.from+100?"":t.sliceDoc(l.from,l.to)
if(e&&!a)return e
let h=t.facet(du)
return new fu({search:(null!==(i=null==e?void 0:e.literal)&&void 0!==i?i:h.literal)?a:a.replace(/\n/g,"\\n"),caseSensitive:null!==(n=null==e?void 0:e.caseSensitive)&&void 0!==n?n:h.caseSensitive,literal:null!==(s=null==e?void 0:e.literal)&&void 0!==s?s:h.literal,regexp:null!==(o=null==e?void 0:e.regexp)&&void 0!==o?o:h.regexp,wholeWord:null!==(r=null==e?void 0:e.wholeWord)&&void 0!==r?r:h.wholeWord})}function Nu(t){let e=xr(t,Iu)
return e&&e.dom.querySelector("[main-field]")}function Wu(t){let e=Nu(t)
e&&e==t.root.activeElement&&e.select()}const Hu=t=>{let e=t.state.field(Su,!1)
if(e&&e.panel){let i=Nu(t)
if(i&&i!=t.root.activeElement){let n=Pu(t.state,e.query.spec)
n.valid&&t.dispatch({effects:xu.of(n)}),i.focus(),i.select()}}else t.dispatch({effects:[ku.of(!0),e?xu.of(Pu(t.state,e.query.spec)):vt.appendConfig.of($u)]})
return!0},Vu=t=>{let e=t.state.field(Su,!1)
if(!e||!e.panel)return!1
let i=xr(t,Iu)
return i&&i.dom.contains(t.root.activeElement)&&t.focus(),t.dispatch({effects:ku.of(!1)}),!0},Fu=[{key:"Mod-f",run:Hu,scope:"editor search-panel"},{key:"F3",run:Du,shift:Eu,scope:"editor search-panel",preventDefault:!0},{key:"Mod-g",run:Du,shift:Eu,scope:"editor search-panel",preventDefault:!0},{key:"Escape",run:Vu,scope:"editor search-panel"},{key:"Mod-Shift-l",run:({state:t,dispatch:e})=>{let i=t.selection
if(i.ranges.length>1||i.main.empty)return!1
let{from:n,to:s}=i.main,o=[],r=0
for(let l=new Xc(t.doc,t.sliceDoc(n,s));!l.next().done;){if(o.length>1e3)return!1
...
t.state.field(Ar,!1)?t.dispatch({effects:Tr.of(s)}):t.dispatch({effects:vt.appendConfig.of(Ar.init(()=>[s]))})
let o=Or.of(s)
return{close:o,result:n.then(e=>((t.win.queueMicrotask||(e=>t.win.setTimeout(e,10)))(()=>{t.state.field(Ar).indexOf(s)>-1&&t.dispatch({effects:o})}),e))}}(t,{label:e.phrase("Go to line"),input:{type:"text",name:"line",value:i},focus:!0,submitLabel:e.phrase("go")})
...
for(let r=!1,l=new Xc(t.doc,e,n[n.length-1].to);;){if(l.next(),!l.done){if(r&&n.some(t=>t.from==l.value.from))continue
if(o){let e=t.wordAt(l.value.from)
if(!e||e.from!=l.value.from||e.to!=l.value.to)continue}return l.value}if(r)return null
l=new Xc(t.doc,e,0,Math.max(0,n[n.length-1].from-1)),r=!0}}(t,n)
...
class zu{constructor(t){this.view=t
let e=this.query=t.state.field(Su).query.spec
function i(t,e,i){return le("button",{class:"cm-button",name:t,onclick:e,type:"button"},i)}this.commit=this.commit.bind(this),this.searchField=le("input",{value:e.search,placeholder:qu(t,"Find"),"aria-label":qu(t,"Find"),class:"cm-textfield",name:"search",form:"","main-field":"true",onchange:this.commit,onkeyup:this.commit}),this.replaceField=le("input",{value:e.replace,placeholder:qu(t,"Replace"),"aria-label":qu(t,"Replace"),class:"cm-textfield",name:"replace",form:"",onchange:this.commit,onkeyup:this.commit}),this.caseField=le("input",{type:"checkbox",name:"case",form:"",checked:e.caseSensitive,onchange:this.commit}),this.reField=le("input",{type:"checkbox",name:"re",form:"",checked:e.regexp,onchange:this.commit}),this.wordField=le("input",{type:"checkbox",name:"word",form:"",checked:e.wholeWord,onchange:this.commit}),this.dom=le("div",{onkeydown:t=>this.keydown(t),class:"cm-search"},[this.searchField,i("next",()=>Du(t),[qu(t,"next")]),i("prev",()=>Eu(t),[qu(t,"previous")]),i("select",()=>Bu(t),[qu(t,"all")]),le("label",null,[this.caseField,qu(t,"match case")]),le("label",null,[this.reField,qu(t,"regexp")]),le("label",null,[this.wordField,qu(t,"by word")]),...t.state.readOnly?[]:[le("br"),this.replaceField,i("replace",()=>Ru(t),[qu(t,"replace")]),i("replaceAll",()=>Lu(t),[qu(t,"replace all")])],le("button",{name:"close",onclick:()=>Vu(t),"aria-label":qu(t,"close"),type:"button"},["×"])])}commit(){let t=new fu({search:this.searchField.value,caseSensitive:this.caseField.checked,regexp:this.reField.checked,wholeWord:this.wordField.checked,replace:this.replaceField.value})
t.eq(this.query)||(this.query=t,this.view.dispatch({effects:xu.of(t)}))}keydown(t){var e,i
i=t,Ao(So((e=this.view).state),i,e,"search-panel")?t.preventDefault():13==t.keyCode&&t.target==this.searchField?(t.preventDefault(),(t.shiftKey?Eu:Du)(this.view)):13==t.keyCode&&t.target==this.replaceField&&(t.preventDefault(),Ru(this.view))}update(t){for(let e of t.transactions)for(let t of e.effects)t.is(xu)&&!t.value.eq(this.query)&&this.setQuery(t.value)}setQuery(t){this.query=t,this.searchField.value=t.search,this.replaceField.value=t.replace,this.caseField.checked=t.caseSensitive,this.reField.checked=t.regexp,this.wordField.checked=t.wholeWord}mount(){this.searchField.select()}get pos(){return 80}get top(){return this.view.state.facet(du).top}}function qu(t,e){return t.state.phrase(e)}const _u=/[\s\.,:;?!]/
function Ku(t,{from:e,to:i}){let n=t.state.doc.lineAt(e),s=t.state.doc.lineAt(i).to,o=Math.max(n.from,e-30),r=Math.min(s,i+30),l=t.state.sliceDoc(o,r)
if(o!=n.from)for(let a=0;a<30;a++)if(!_u.test(l[a+1])&&_u.test(l[a])){l=l.slice(a)
break}if(r!=s)for(let a=l.length-1;a>l.length-30;a--)if(!_u.test(l[a-1])&&_u.test(l[a])){l=l.slice(0,a)
break}return po.announce.of(`${t.state.phrase("current match")}. ${l} ${t.state.phrase("on line")} ${n.number}.`)}const ju=po.baseTheme({".cm-panel.cm-search":{padding:"2px 6px 4px",position:"relative","& [name=close]":{position:"absolute",top:"0",right:"4px",backgroundColor:"inherit",border:"none",font:"inherit",padding:0,margin:0},"& input, & button, & label":{margin:".2em .6em .2em 0"},"& input[type=checkbox]":{marginRight:".2em"},"& label":{fontSize:"80%",whiteSpace:"pre"}},"&light .cm-searchMatch":{backgroundColor:"#ffff0054"},"&dark .cm-searchMatch":{backgroundColor:"#00ffff8a"},"&light .cm-searchMatch-selected":{backgroundColor:"#ff6a0054"},"&dark .cm-searchMatch-selected":{backgroundColor:"#ff00ff8a"}}),$u=[Su,tt.low(Tu),ju]
class Uu{constructor(t,e,i,n){this.state=t,this.pos=e,this.explicit=i,this.view=n,this.abortListeners=[],this.abortOnDocChange=!1}tokenBefore(t){let e=ra(this.state).resolveInner(this.pos,-1)
for(;e&&t.indexOf(e.name)<0;)e=e.parent
return e?{from:e.from,to:this.pos,text:this.state.sliceDoc(e.from,this.pos),type:e.type}:null}matchBefore(t){let e=this.state.doc.lineAt(this.pos),i=Math.max(e.from,this.pos-250),n=e.text.slice(i-e.from,this.pos-e.from),s=n.search(Xu(t,!1))
return s<0?null:{from:i+s,to:this.pos,text:n.slice(s)}}get aborted(){return null==this.abortListeners}addEventListener(t,e,i){"abort"==t&&this.abortListeners&&(this.abortListeners.push(e),i&&i.onDocChange&&(this.abortOnDocChange=!0))}}function Yu(t){let e=Object.keys(t).join(""),i=/\w/.test(e)
return i&&(e=e.replace(/\w/g,"")),`[${i?"\\w":""}${e.replace(/[^\w\s]/g,"\\$&")}]`}class Gu{constructor(t,e,i,n){this.completion=t,this.source=e,this.match=i,this.score=n}}function Ju(t){return t.selection.main.from}function Xu(t,e){var i
let{source:n}=t,s=e&&"^"!=n[0],o="$"!=n[n.length-1]
return s||o?new RegExp(`${s?"^":""}(?:${n})${o?"$":""}`,null!==(i=t.flags)&&void 0!==i?i:t.ignoreCase?"i":""):t}const Qu=pt.define()
function Zu(t,e,i,n){let{main:s}=t.selection,o=i-s.from,r=n-s.from
return{...t.changeByRange(l=>{if(l!=s&&i!=n&&t.sliceDoc(l.from+o,l.from+r)!=t.sliceDoc(i,n))return{range:l}
let a=t.toText(e)
return{changes:{from:l.from+o,to:n==s.from?l.to:l.from+r,insert:a},range:q.cursor(l.from+o+a.length)}}),scrollIntoView:!0,userEvent:"input.complete"}}const td=new WeakMap
function ed(t){if(!Array.isArray(t))return t
let e=td.get(t)
return e||td.set(t,e=function(t){let e=t.map(t=>"string"==typeof t?{label:t}:t),[i,n]=e.every(t=>/^\w+$/.test(t.label))?[/\w*$/,/\w+$/]:function(t){let e=Object.create(null),i=Object.create(null)
...
return s||t.explicit?{from:s?s.from:t.pos,options:e,validFor:i}:null}}(t)),e}const id=vt.define(),nd=vt.define()
class sd{constructor(t){this.pattern=t,this.chars=[],this.folded=[],this.any=[],this.precise=[],this.byWord=[],this.score=0,this.matched=[]
...
s&&n[s-1]==o?n[s-1]=t:(n[s++]=o,n[s++]=t)}return this.ret(t-i.length,n)}}class od{constructor(t){this.pattern=t,this.matched=[],this.score=0,this.folded=t.toLowerCase()}match(t){if(t.length<this.pattern.length)return null
let e=t.slice(0,this.pattern.length),i=e==this.pattern?0:e.toLowerCase()==this.folded?-200:null
return null==i?null:(this.matched=[0,e.length],this.score=i+(t.length==this.pattern.length?0:-100),this)}}const rd=j.define({combine:t=>Dt(t,{activateOnTyping:!0,activateOnCompletion:()=>!1,activateOnTypingDelay:100,selectOnOpen:!0,override:null,closeOnBlur:!0,maxRenderedOptions:100,defaultKeymap:!0,tooltipClass:()=>"",optionClass:()=>"",aboveCursor:!1,icons:!0,addToOptions:[],positionInfo:ad,filterStrict:!1,compareCompletions:(t,e)=>(t.sortText||t.label).localeCompare(e.sortText||e.label),interactionDelay:75,updateSyncTime:100},{defaultKeymap:(t,e)=>t&&e,closeOnBlur:(t,e)=>t&&e,icons:(t,e)=>t&&e,tooltipClass:(t,e)=>i=>ld(t(i),e(i)),optionClass:(t,e)=>i=>ld(t(i),e(i)),addToOptions:(t,e)=>t.concat(e),filterStrict:(t,e)=>t||e})})
function ld(t,e){return t?e?t+" "+e:t:e}function ad(t,e,i,n,s,o){let r,l,a=t.textDirection==si.RTL,h=a,c=!1,u="top",d=e.left-s.left,f=s.right-e.right,p=n.right-n.left,m=n.bottom-n.top
...
t>=m||t>e.top?r=i.bottom-e.top:(u="bottom",r=e.bottom-i.top)}return{style:`${u}: ${r/((e.bottom-e.top)/o.offsetHeight)}px; max-width: ${l/((e.right-e.left)/o.offsetWidth)}px`,class:"cm-completionInfo-"+(c?a?"left-narrow":"right-narrow":h?"left":"right")}}const hd=vt.define()
function cd(t,e,i){if(t<=i)return{from:0,to:t}
if(e<0&&(e=0),e<=t>>1){let t=Math.floor(e/i)
return{from:t*i,to:(t+1)*i}}let n=Math.floor((t-e)/i)
return{from:t-(n+1)*i,to:t-n*i}}class ud{constructor(t,e,i){this.view=t,this.stateField=e,this.applyCompletion=i,this.info=null,this.infoDestroy=null,this.placeInfoReq={read:()=>this.measureInfo(),write:t=>this.placeInfo(t),key:this},this.space=null,this.currentClass=""
let n=t.state.field(e),{options:s,selected:o}=n.open,r=t.state.facet(rd)
...
let e=document.createElement("span")
return e.className="cm-completionDetail",e.textContent=t.detail,e},position:80}),e.sort((t,e)=>t.position-e.position).map(t=>t.render)}(r),this.optionClass=r.optionClass,this.tooltipClass=r.tooltipClass,this.range=cd(s.length,o,r.maxRenderedOptions),this.dom=document.createElement("div"),this.dom.className="cm-tooltip-autocomplete",this.updateTooltipClass(t.state),this.dom.addEventListener("mousedown",i=>{let{options:n}=t.state.field(e).open
...
n.open&&n.open.options==s||(this.range=cd(s.length,o,t.state.facet(rd).maxRenderedOptions),this.showOptions(s,i.id)),this.updateSel(),r!=(null===(e=n.open)||void 0===e?void 0:e.disabled)&&this.dom.classList.toggle("cm-tooltip-autocomplete-disabled",!!r)}}updateTooltipClass(t){let e=this.tooltipClass(t)
...
this.currentClass=e}}positioned(t){this.space=t,this.info&&this.view.requestMeasure(this.placeInfoReq)}updateSel(){let t=this.view.state.field(this.stateField),e=t.open;(e.selected>-1&&e.selected<this.range.from||e.selected>=this.range.to)&&(this.range=cd(e.options.length,e.selected,this.view.state.facet(rd).maxRenderedOptions),this.showOptions(e.options,t.id))
...
s={left:0,top:0,right:t.clientWidth,bottom:t.clientHeight}}return n.top>Math.min(s.bottom,e.bottom)-10||n.bottom<Math.max(s.top,e.top)+10?null:this.view.state.facet(rd).positionInfo(this.view,e,n,i,s,this.dom)}placeInfo(t){this.info&&(t?(t.style&&(this.info.style.cssText=t.style),this.info.className="cm-tooltip cm-completionInfo "+(t.class||"")):this.info.style.cssText="top: -1e6px")}createListBox(t,e,i){const n=document.createElement("ul")
...
e&&h.appendChild(e)}}return i.from&&n.classList.add("cm-completionListIncompleteTop"),i.to<t.length&&n.classList.add("cm-completionListIncompleteBottom"),n}destroyInfo(){this.info&&(this.infoDestroy&&this.infoDestroy(),this.info.remove(),this.info=null)}destroy(){this.destroyInfo()}}function dd(t){return 100*(t.boost||0)+(t.apply?10:0)+(t.info?5:0)+(t.type?1:0)}class fd{constructor(t,e,i,n,s,o){this.options=t,this.attrs=e,this.tooltip=i,this.timestamp=n,this.selected=s,this.disabled=o}setSelected(t,e){return t==this.selected||t>=this.options.length?this:new fd(this.options,vd(e,t),this.tooltip,this.timestamp,t,this.disabled)}static build(t,e,i,n,s,o){if(n&&!o&&t.some(t=>t.isPending))return n.setDisabled()
let r=function(t,e){let i=[],n=null,s=null,o=t=>{i.push(t)
let{section:e}=t.completion
if(e){n||(n=[])
let t="string"==typeof e?e:e.name
n.some(e=>e.name==t)||n.push("string"==typeof e?{name:t}:e)}},r=e.facet(rd)
for(let c of t)if(c.hasResult()){let t=c.result.getMatch
if(!1===c.result.filter)for(let e of c.result.options)o(new Gu(e,c.source,t?t(e):[],1e9-i.length))
else{let i,n=e.sliceDoc(c.from,c.to),l=r.filterStrict?new od(n):new sd(n)
for(let e of c.result.options)if(i=l.match(e.label)){let n=e.displayLabel?t?t(e,i.matched):[]:i.matched,r=i.score+(e.boost||0)
if(o(new Gu(e,c.source,n,r)),"object"==typeof e.section&&"dynamic"===e.section.rank){let{name:t}=e.section
...
!a||a.label!=t.label||a.detail!=t.detail||null!=a.type&&null!=t.type&&a.type!=t.type||a.apply!=t.apply||a.boost!=t.boost?l.push(c):dd(c.completion)>dd(a)&&(l[l.length-1]=c),a=c.completion}return l}(t,e)
if(!r.length)return n&&t.some(t=>t.isPending)?n.setDisabled():null
let l=e.facet(rd).selectOnOpen?0:-1
if(n&&n.selected!=l&&-1!=n.selected){let t=n.options[n.selected].completion
for(let e=0;e<r.length;e++)if(r[e].completion==t){l=e
break}}return new fd(r,vd(i,l),{pos:t.reduce((t,e)=>e.hasResult()?Math.min(t,e.from):t,1e8),create:Md,above:s.aboveCursor},n?n.timestamp:Date.now(),l,!1)}map(t){return new fd(this.options,this.attrs,{...this.tooltip,pos:t.mapPos(this.tooltip.pos)},this.timestamp,this.selected,this.disabled)}setDisabled(){return new fd(this.options,this.attrs,this.tooltip,this.timestamp,this.selected,!0)}}class pd{constructor(t,e,i){this.active=t,this.id=e,this.open=i}static start(){return new pd(wd,"cm-ac-"+Math.floor(2e6*Math.random()).toString(36),null)}update(t){let{state:e}=t,i=e.facet(rd),n=(i.override||e.languageDataAt("autocomplete",Ju(e)).map(ed)).map(e=>(this.active.find(t=>t.source==e)||new yd(e,this.active.some(t=>0!=t.state)?1:0)).update(t,i))
n.length==this.active.length&&n.every((t,e)=>t==this.active[e])&&(n=this.active)
let s=this.open,o=t.effects.some(t=>t.is(kd))
...
if(s||o)return s==o
if(t[i++].result!=e[n++].result)return!1}}(n,this.active)||o?s=fd.build(n,e,this.id,s,i,o):s&&s.disabled&&!n.some(t=>t.isPending)&&(s=null),!s&&n.every(t=>!t.isPending)&&n.some(t=>t.hasResult())&&(n=n.map(t=>t.hasResult()?new yd(t.source,0):t))
for(let r of t.effects)r.is(hd)&&(s=s&&s.setSelected(r.value,this.id))
return n==this.active&&s==this.open?this:new pd(n,this.id,s)}get tooltip(){return this.open?this.open.tooltip:null}get attrs(){return this.open?this.open.attrs:this.active.length?md:gd}}const md={"aria-autocomplete":"list"},gd={}
function vd(t,e){let i={"aria-autocomplete":"list","aria-haspopup":"listbox","aria-controls":t}
return e>-1&&(i["aria-activedescendant"]=t+"-"+e),i}const wd=[]
function bd(t,e){if(t.isUserEvent("input.complete")){let i=t.annotation(Qu)
if(i&&e.activateOnCompletion(i))return 12}let i=t.isUserEvent("input.type")
return i&&e.activateOnTyping?5:i?1:t.isUserEvent("delete.backward")?2:t.selection?8:t.docChanged?16:0}class yd{constructor(t,e,i=!1){this.source=t,this.state=e,this.explicit=i}hasResult(){return!1}get isPending(){return 1==this.state}update(t,e){let i=bd(t,e),n=this;(8&i||16&i&&this.touches(t))&&(n=new yd(n.source,0)),4&i&&0==n.state&&(n=new yd(this.source,1)),n=n.updateFor(t,i)
for(let s of t.effects)if(s.is(id))n=new yd(n.source,1,s.value)
else if(s.is(nd))n=new yd(n.source,0)
else if(s.is(kd))for(let t of s.value)t.source==n.source&&(n=t)
return n}updateFor(t,e){return this.map(t.changes)}map(t){return this}touches(t){return t.changes.touchesRange(Ju(t.state))}}class xd extends yd{constructor(t,e,i,n,s,o){super(t,3,e),this.limit=i,this.result=n,this.from=s,this.to=o}hasResult(){return!0}updateFor(t,e){var i
if(!(3&e))return this.map(t.changes)
let n=this.result
n.map&&!t.changes.empty&&(n=n.map(n,t.changes))
let s=t.changes.mapPos(this.from),o=t.changes.mapPos(this.to,1),r=Ju(t.state)
if(r>o||!n||2&e&&(Ju(t.startState)==this.from||r<this.limit))return new yd(this.source,4&e?1:0)
let l=t.changes.mapPos(this.limit)
return function(t,e,i,n){if(!t)return!1
let s=e.sliceDoc(i,n)
return"function"==typeof t?t(s,i,n,e):Xu(t,!0).test(s)}(n.validFor,t.state,s,o)?new xd(this.source,this.explicit,l,n,s,o):n.update&&(n=n.update(n,s,o,new Uu(t.state,r,!1)))?new xd(this.source,this.explicit,l,n,n.from,null!==(i=n.to)&&void 0!==i?i:Ju(t.state)):new yd(this.source,1,this.explicit)}map(t){return t.empty?this:(this.result.map?this.result.map(this.result,t):this.result)?new xd(this.source,this.explicit,t.mapPos(this.limit),this.result,t.mapPos(this.from),t.mapPos(this.to,1)):new yd(this.source,0)}touches(t){return t.changes.touchesRange(this.from,this.to)}}const kd=vt.define({map:(t,e)=>t.map(t=>t.map(e))}),Sd=Q.define({create:()=>pd.start(),update:(t,e)=>t.update(e),provide:t=>[fr.from(t,t=>t.tooltip),po.contentAttributes.from(t,t=>t.attrs)]})
function Cd(t,e){const i=e.completion.apply||e.completion.label
let n=t.state.field(Sd).active.find(t=>t.source==e.source)
return n instanceof xd&&("string"==typeof i?t.dispatch({...Zu(t.state,i,n.from,n.to),annotations:Qu.of(e.completion)}):i(t,e.completion,n.from,n.to),!0)}const Md=function(t,e){return i=>new ud(i,t,e)}(Sd,Cd)
function Ad(t,e="option"){return i=>{let n=i.state.field(Sd,!1)
if(!n||!n.open||n.open.disabled||Date.now()-n.open.timestamp<i.state.facet(rd).interactionDelay)return!1
let s,o=1
"page"==e&&(s=wr(i,n.open.tooltip))&&(o=Math.max(2,Math.floor(s.dom.offsetHeight/s.dom.querySelector("li").offsetHeight)-1))
let{length:r}=n.open.options,l=n.open.selected>-1?n.open.selected+o*(t?1:-1):t?0:r-1
return l<0?l="page"==e?0:r-1:l>=r&&(l="page"==e?r-1:0),i.dispatch({effects:hd.of(l)}),!0}}const Td=t=>!!t.state.field(Sd,!1)&&(t.dispatch({effects:id.of(!0)}),!0)
class Od{constructor(t,e){this.active=t,this.context=e,this.time=Date.now(),this.updates=[],this.done=void 0}}const Dd=qi.fromClass(class{constructor(t){this.view=t,this.debounceUpdate=-1,this.running=[],this.debounceAccept=-1,this.pendingStart=!1,this.composing=0
for(let e of t.state.field(Sd).active)e.isPending&&this.startQuery(e)}update(t){let e=t.state.field(Sd),i=t.state.facet(rd)
if(!t.selectionSet&&!t.docChanged&&t.startState.field(Sd)==e)return
let n=t.transactions.some(t=>{let e=bd(t,i)
return 8&e||(t.selection||t.docChanged)&&!(3&e)})
for(let o=0;o<this.running.length;o++){let e=this.running[o]
if(n||e.context.abortOnDocChange&&t.docChanged||e.updates.length+t.transactions.length>50&&Date.now()-e.time>1e3){for(let i of e.context.abortListeners)try{i()}catch(t){Hi(this.view.state,t)}e.context.abortListeners=null,this.running.splice(o--,1)}else e.updates.push(...t.transactions)}this.debounceUpdate>-1&&clearTimeout(this.debounceUpdate),t.transactions.some(t=>t.effects.some(t=>t.is(id)))&&(this.pendingStart=!0)
...
let{state:t}=this.view,e=t.field(Sd)
for(let i of e.active)i.isPending&&!this.running.some(t=>t.active.source==i.source)&&this.startQuery(i)
this.running.length&&e.open&&e.open.disabled&&(this.debounceAccept=setTimeout(()=>this.accept(),this.view.state.facet(rd).updateSyncTime))}startQuery(t){let{state:e}=this.view,i=Ju(e),n=new Uu(e,i,t.explicit,this.view),s=new Od(t,n)
this.running.push(s),Promise.resolve(t.source(n)).then(t=>{s.context.aborted||(s.done=t||null,this.scheduleAccept())},t=>{this.view.dispatch({effects:nd.of(null)}),Hi(this.view.state,t)})}scheduleAccept(){this.running.every(t=>void 0!==t.done)?this.accept():this.debounceAccept<0&&(this.debounceAccept=setTimeout(()=>this.accept(),this.view.state.facet(rd).updateSyncTime))}accept(){var t
this.debounceAccept>-1&&clearTimeout(this.debounceAccept),this.debounceAccept=-1
let e=[],i=this.view.state.facet(rd),n=this.view.state.field(Sd)
for(let s=0;s<this.running.length;s++){let o=this.running[s]
if(void 0===o.done)continue
if(this.running.splice(s--,1),o.done){let n=Ju(o.updates.length?o.updates[0].startState:this.view.state),s=Math.min(n,o.done.from+(o.active.explicit?0:1)),r=new xd(o.active.source,o.active.explicit,s,o.done,o.done.from,null!==(t=o.done.to)&&void 0!==t?t:n)
for(let t of o.updates)r=r.update(t,i)
if(r.hasResult()){e.push(r)
continue}}let r=n.active.find(t=>t.source==o.active.source)
if(r&&r.isPending)if(null==o.done){let t=new yd(o.active.source,0)
for(let e of o.updates)t=t.update(e,i)
t.isPending||e.push(t)}else this.startQuery(r)}(e.length||n.open&&n.open.disabled)&&this.view.dispatch({effects:kd.of(e)})}},{eventHandlers:{blur(t){let e=this.view.state.field(Sd,!1)
if(e&&e.tooltip&&this.view.state.facet(rd).closeOnBlur){let i=e.open&&wr(this.view,e.open.tooltip)
i&&i.dom.contains(t.relatedTarget)||setTimeout(()=>this.view.dispatch({effects:nd.of(null)}),10)}},compositionstart(){this.composing=1},compositionend(){3==this.composing&&setTimeout(()=>this.view.dispatch({effects:id.of(!1)}),20),this.composing=0}}}),Ed="object"==typeof navigator&&/Win/.test(navigator.platform),Bd=tt.highest(po.domEventHandlers({keydown(t,e){let i=e.state.field(Sd,!1)
if(!i||!i.open||i.open.disabled||i.open.selected<0||t.key.length>1||t.ctrlKey&&(!Ed||!t.altKey)||t.metaKey)return!1
...
return o&&o.indexOf(t.key)>-1&&Cd(e,n),!1}})),Rd=po.baseTheme({".cm-tooltip.cm-tooltip-autocomplete":{"& > ul":{fontFamily:"monospace",whiteSpace:"nowrap",overflow:"hidden auto",maxWidth_fallback:"700px",maxWidth:"min(700px, 95vw)",minWidth:"250px",maxHeight:"10em",height:"100%",listStyle:"none",margin:0,padding:0,"& > li, & > completion-section":{padding:"1px 3px",lineHeight:1.2},"& > li":{overflowX:"hidden",textOverflow:"ellipsis",cursor:"pointer"},"& > completion-section":{display:"list-item",borderBottom:"1px solid silver",paddingLeft:"0.5em",opacity:.7}}},"&light .cm-tooltip-autocomplete ul li[aria-selected]":{background:"#17c",color:"white"},"&light .cm-tooltip-autocomplete-disabled ul li[aria-selected]":{background:"#777"},"&dark .cm-tooltip-autocomplete ul li[aria-selected]":{background:"#347",color:"white"},"&dark .cm-tooltip-autocomplete-disabled ul li[aria-selected]":{background:"#444"},".cm-completionListIncompleteTop:before, .cm-completionListIncompleteBottom:after":{content:'"···"',opacity:.5,display:"block",textAlign:"center"},".cm-tooltip.cm-completionInfo":{position:"absolute",padding:"3px 9px",width:"max-content",maxWidth:"400px",boxSizing:"border-box",whiteSpace:"pre-line"},".cm-completionInfo.cm-completionInfo-left":{right:"100%"},".cm-completionInfo.cm-completionInfo-right":{left:"100%"},".cm-completionInfo.cm-completionInfo-left-narrow":{right:"30px"},".cm-completionInfo.cm-completionInfo-right-narrow":{left:"30px"},"&light .cm-snippetField":{backgroundColor:"#00000022"},"&dark .cm-snippetField":{backgroundColor:"#ffffff22"},".cm-snippetFieldPosition":{verticalAlign:"text-top",width:0,height:"1.15em",display:"inline-block",margin:"0 -0.7px -.7em",borderLeft:"1.4px dotted #888"},".cm-completionMatchedText":{textDecoration:"underline"},".cm-completionDetail":{marginLeft:"0.5em",fontStyle:"italic"},".cm-completionIcon":{fontSize:"90%",width:".8em",display:"inline-block",textAlign:"center",paddingRight:".6em",opacity:"0.6",boxSizing:"content-box"},".cm-completionIcon-function, .cm-completionIcon-method":{"&:after":{content:"'ƒ'"}},".cm-completionIcon-class":{"&:after":{content:"'○'"}},".cm-completionIcon-interface":{"&:after":{content:"'◌'"}},".cm-completionIcon-variable":{"&:after":{content:"'𝑥'"}},".cm-completionIcon-constant":{"&:after":{content:"'𝐶'"}},".cm-completionIcon-type":{"&:after":{content:"'𝑡'"}},".cm-completionIcon-enum":{"&:after":{content:"'∪'"}},".cm-completionIcon-property":{"&:after":{content:"'□'"}},".cm-completionIcon-keyword":{"&:after":{content:"'🔑︎'"}},".cm-completionIcon-namespace":{"&:after":{content:"'▢'"}},".cm-completionIcon-text":{"&:after":{content:"'abc'",fontSize:"50%",verticalAlign:"middle"}}}),Ld={brackets:["(","[","{","'",'"'],before:")]}:;>",stringPrefixes:[]},Id=vt.define({map(t,e){let i=e.mapPos(t,-1,R.TrackAfter)
return null==i?void 0:i}}),Pd=new class extends Et{}
Pd.startSide=1,Pd.endSide=-1
const Nd=Q.define({create:()=>Pt.empty,update(t,e){if(t=t.map(e.changes),e.selection){let i=e.state.doc.lineAt(e.selection.main.head)
t=t.update({filter:t=>t>=i.from&&t<=i.to})}for(let i of e.effects)i.is(Id)&&(t=t.update({add:[Pd.range(i.value,i.value+1)]}))
return t}}),Wd="()[]{}<>«»»«［］｛｝"
function Hd(t){for(let e=0;e<16;e+=2)if(Wd.charCodeAt(e)==t)return Wd.charAt(e+1)
return D(t<128?t:t+1)}function Vd(t,e){return t.languageDataAt("closeBrackets",e)[0]||Ld}const Fd="object"==typeof navigator&&/Android\b/.test(navigator.userAgent),zd=po.inputHandler.of((t,e,i,n)=>{if((Fd?t.composing:t.compositionStarted)||t.state.readOnly)return!1
let s=t.state.selection.main
if(n.length>2||2==n.length&&1==E(O(n,0))||e!=s.from||i!=s.to)return!1
let o=function(t,e){let i=Vd(t,t.selection.main.head),n=i.brackets||Ld.brackets
for(let s of n){let o=Hd(O(s,0))
if(e==s)return o==s?Ud(t,s,n.indexOf(s+s+s)>-1,i):jd(t,s,o,i.before||Ld.before)
if(e==o&&_d(t,t.selection.main.from))return $d(t,0,o)}return null}(t.state,n)
return!!o&&(t.dispatch(o),!0)}),qd=[{key:"Backspace",run:({state:t,dispatch:e})=>{if(t.readOnly)return!1
let i=Vd(t,t.selection.main.head).brackets||Ld.brackets,n=null,s=t.changeByRange(e=>{if(e.empty){let n=function(t,e){let i=t.sliceString(e-2,e)
return E(O(i,0))==i.length?i:i.slice(1)}(t.doc,e.head)
for(let s of i)if(s==n&&Kd(t.doc,e.head)==Hd(O(s,0)))return{changes:{from:e.head-s.length,to:e.head+s.length},range:q.cursor(e.head-s.length)}}return{range:n=e}})
return n||e(t.update(s,{scrollIntoView:!0,userEvent:"delete.backward"})),!n}}]
function _d(t,e){let i=!1
return t.field(Nd).between(0,t.doc.length,t=>{t==e&&(i=!0)}),i}function Kd(t,e){let i=t.sliceString(e,e+2)
return i.slice(0,E(O(i,0)))}function jd(t,e,i,n){let s=null,o=t.changeByRange(o=>{if(!o.empty)return{changes:[{insert:e,from:o.from},{insert:i,from:o.to}],effects:Id.of(o.to+e.length),range:q.range(o.anchor+e.length,o.head+e.length)}
let r=Kd(t.doc,o.head)
return!r||/\s/.test(r)||n.indexOf(r)>-1?{changes:{insert:e+i,from:o.head},effects:Id.of(o.head+e.length),range:q.cursor(o.head+e.length)}:{range:s=o}})
return s?null:t.update(o,{scrollIntoView:!0,userEvent:"input.type"})}function $d(t,e,i){let n=null,s=t.changeByRange(e=>e.empty&&Kd(t.doc,e.head)==i?{changes:{from:e.head,to:e.head+i.length,insert:i},range:q.cursor(e.head+i.length)}:n={range:e})
return n?null:t.update(s,{scrollIntoView:!0,userEvent:"input.type"})}function Ud(t,e,i,n){let s=n.stringPrefixes||Ld.stringPrefixes,o=null,r=t.changeByRange(n=>{if(!n.empty)return{changes:[{insert:e,from:n.from},{insert:e,from:n.to}],effects:Id.of(n.to+e.length),range:q.range(n.anchor+e.length,n.head+e.length)}
let r,l=n.head,a=Kd(t.doc,l)
if(a==e){if(Yd(t,l))return{changes:{insert:e+e,from:l},effects:Id.of(l+e.length),range:q.cursor(l+e.length)}
if(_d(t,l)){let n=i&&t.sliceDoc(l,l+3*e.length)==e+e+e?e+e+e:e
return{changes:{from:l,to:l+n.length,insert:n},range:q.cursor(l+n.length)}}}else{if(i&&t.sliceDoc(l-2*e.length,l)==e+e&&(r=Gd(t,l-2*e.length,s))>-1&&Yd(t,r))return{changes:{insert:e+e+e+e,from:l},effects:Id.of(l+e.length),range:q.cursor(l+e.length)}
if(t.charCategorizer(l)(a)!=Mt.Word&&Gd(t,l,s)>-1&&!function(t,e,i,n){let s=ra(t).resolveInner(e,-1),o=n.reduce((t,e)=>Math.max(t,e.length),0)
...
if(!a)break
s=a}return!1}(t,l,e,s))return{changes:{insert:e+e,from:l},effects:Id.of(l+e.length),range:q.cursor(l+e.length)}}return{range:o=n}})
return o?null:t.update(r,{scrollIntoView:!0,userEvent:"input.type"})}function Yd(t,e){let i=ra(t).resolveInner(e+1)
return i.parent&&i.from==e}function Gd(t,e,i){let n=t.charCategorizer(e)
if(n(t.sliceDoc(e-1,e))!=Mt.Word)return e
for(let s of i){let i=e-s.length
if(t.sliceDoc(i,e)==s&&n(t.sliceDoc(i-1,i))!=Mt.Word)return i}return-1}const Jd=[{key:"Ctrl-Space",run:Td},{mac:"Alt-`",run:Td},{mac:"Alt-i",run:Td},{key:"Escape",run:t=>{let e=t.state.field(Sd,!1)
return!(!e||!e.active.some(t=>0!=t.state)||(t.dispatch({effects:nd.of(null)}),0))}},{key:"ArrowDown",run:Ad(!0)},{key:"ArrowUp",run:Ad(!1)},{key:"PageDown",run:Ad(!0,"page")},{key:"PageUp",run:Ad(!1,"page")},{key:"Enter",run:t=>{let e=t.state.field(Sd,!1)
return!(t.state.readOnly||!e||!e.open||e.open.selected<0||e.open.disabled||Date.now()-e.open.timestamp<t.state.facet(rd).interactionDelay)&&Cd(t,e.open.options[e.open.selected])}}],Xd=tt.highest(xo.computeN([rd],t=>t.facet(rd).defaultKeymap?[Jd]:[]))
class Qd{constructor(t,e,i){this.from=t,this.to=e,this.diagnostic=i}}class Zd{constructor(t,e,i){this.diagnostics=t,this.panel=e,this.selected=i}static init(t,e,i){let n=i.facet(cf).markerFilter
n&&(t=n(t,i))
...
s=h+a.value.length,h+=a.value.length,a.next()}}let u=yf(r)
if(n)o.add(t,t,Oe.widget({widget:new pf(u),diagnostics:r.slice()}))
...
return new Zd(u,e,tf(u))}}function tf(t,e=null,i=0){let n=null
return t.between(i,1e9,(t,i,{spec:s})=>{if(!(e&&s.diagnostics.indexOf(e)<0))if(n){if(s.diagnostics.indexOf(n.diagnostic)<0)return!1
n=new Qd(n.from,i,n.diagnostic)}else n=new Qd(t,i,e||s.diagnostics[0])}),n}const ef=vt.define(),nf=vt.define(),sf=vt.define(),of=Q.define({create:()=>new Zd(Oe.none,null,null),update(t,e){if(e.docChanged&&t.diagnostics.size){let i=t.diagnostics.map(e.changes),n=null,s=t.panel
if(t.selected){let s=e.changes.mapPos(t.selected.from,1)
n=tf(i,t.selected.diagnostic,s)||tf(i,null,s)}!i.size&&s&&e.state.facet(cf).autoPanel&&(s=null),t=new Zd(i,s,n)}for(let i of e.effects)if(i.is(ef)){let n=e.state.facet(cf).autoPanel?i.value.length?gf.open:null:t.panel
t=Zd.init(i.value,n,e.state)}else i.is(nf)?t=new Zd(t.diagnostics,i.value?gf.open:null,t.selected):i.is(sf)&&(t=new Zd(t.diagnostics,t.panel,i.value))
return t},provide:t=>[Mr.from(t,t=>t.panel),po.decorations.from(t,t=>t.diagnostics)]}),rf=Oe.mark({class:"cm-lintRange cm-lintRange-active"})
function lf(t,e){return le("ul",{class:"cm-tooltip-lint"},e.map(e=>ff(t,e,!1)))}const af=t=>{let e=t.state.field(of,!1)
return!(!e||!e.panel||(t.dispatch({effects:nf.of(!1)}),0))},hf=[{key:"Mod-Shift-m",run:t=>{let e=t.state.field(of,!1)
var i,n
e&&e.panel||t.dispatch({effects:(i=t.state,n=[nf.of(!0)],i.field(of,!1)?n:n.concat(vt.appendConfig.of(xf)))})
let s=xr(t,gf.open)
return s&&s.dom.querySelector(".cm-panel-lint ul").focus(),!0},preventDefault:!0},{key:"F8",run:t=>{let e=t.state.field(of,!1)
if(!e)return!1
let i=t.state.selection.main,n=tf(e.diagnostics,null,i.to+1)
return!(!n&&(n=tf(e.diagnostics,null,0),!n||n.from==i.from&&n.to==i.to)||(t.dispatch({selection:{anchor:n.from,head:n.to},scrollIntoView:!0}),0))}}],cf=j.define({combine:t=>({sources:t.map(t=>t.source).filter(t=>null!=t),...Dt(t.map(t=>t.config),{delay:750,markerFilter:null,tooltipFilter:null,needsRefresh:null,hideOn:()=>null},{delay:Math.max,markerFilter:uf,tooltipFilter:uf,needsRefresh:(t,e)=>t?e?i=>t(i)||e(i):t:e,hideOn:(t,e)=>t?e?(i,n,s)=>t(i,n,s)||e(i,n,s):t:e,autoPanel:(t,e)=>t||e})})})
function uf(t,e){return t?e?(i,n)=>e(t(i,n),n):t:e}function df(t){let e=[]
...
continue t}}e.push("")}return e}function ff(t,e,i){var n
let s=i?df(e.actions):[]
...
o=!0
let s=tf(t.state.field(of).diagnostics,e)
s&&i.apply(t,s.from,s.to)},{name:l}=i,a=s[n]?l.indexOf(s[n]):-1,h=a<0?l:[l.slice(0,a),le("u",l.slice(a,a+1)),l.slice(a+1)]
return le("button",{type:"button",class:"cm-diagnosticAction"+(i.markClass?" "+i.markClass:""),onclick:r,onmousedown:r,"aria-label":` Action: ${l}${a<0?"":` (access key "${s[n]})"`}.`},h)}),e.source&&le("div",{class:"cm-diagnosticSource"},e.source))}class pf extends Ae{constructor(t){super(),this.sev=t}eq(t){return t.sev==this.sev}toDOM(){return le("span",{class:"cm-lintPoint cm-lintPoint-"+this.sev})}}class mf{constructor(t,e){this.diagnostic=e,this.id="item_"+Math.floor(4294967295*Math.random()).toString(16),this.dom=ff(t,e,!0),this.dom.id=this.id,this.dom.setAttribute("role","option")}}class gf{constructor(t){this.view=t,this.items=[],this.list=le("ul",{tabIndex:0,role:"listbox","aria-label":this.view.state.phrase("Diagnostics"),onkeydown:e=>{if(!(e.ctrlKey||e.altKey||e.metaKey)){if(27==e.keyCode)af(this.view),this.view.focus()
...
{let{diagnostic:i}=this.items[this.selectedIndex],n=df(i.actions)
for(let s=0;s<n.length;s++)if(n[s].toUpperCase().charCodeAt(0)==e.keyCode){let e=tf(this.view.state.field(of).diagnostics,i)
e&&i.actions[s].apply(t,e.from,e.to)}}}e.preventDefault()}},onclick:t=>{for(let e=0;e<this.items.length;e++)this.items[e].dom.contains(t.target)&&this.moveSelection(e)}}),this.dom=le("div",{class:"cm-panel-lint"},this.list,le("button",{type:"button",name:"close","aria-label":this.view.state.phrase("close"),onclick:()=>af(this.view)},"×")),this.update()}get selectedIndex(){let t=this.view.state.field(of).selected
if(!t)return-1
for(let e=0;e<this.items.length;e++)if(this.items[e].diagnostic==t.diagnostic)return e
return-1}update(){let{diagnostics:t,selected:e}=this.view.state.field(of),i=0,n=!1,s=null,o=new Set
...
break}r<0?(t=new mf(this.view,a),this.items.splice(i,0,t),n=!0):(t=this.items[r],r>i&&(this.items.splice(i,r-i),n=!0)),e&&t.diagnostic==e.diagnostic?t.dom.hasAttribute("aria-selected")||(t.dom.setAttribute("aria-selected","true"),s=t):t.dom.hasAttribute("aria-selected")&&t.dom.removeAttribute("aria-selected"),i++}});i<this.items.length&&!(1==this.items.length&&this.items[0].diagnostic.from<0);)n=!0,this.items.pop()
0==this.items.length&&(this.items.push(new mf(this.view,{from:-1,to:-1,severity:"info",message:this.view.state.phrase("No diagnostics")})),n=!0),s?(this.list.setAttribute("aria-activedescendant",s.id),this.view.requestMeasure({key:this,read:()=>({sel:s.dom.getBoundingClientRect(),panel:this.list.getBoundingClientRect()}),write:({sel:t,panel:e})=>{let i=e.height/this.list.offsetHeight
...
let e=tf(this.view.state.field(of).diagnostics,this.items[t].diagnostic)
e&&this.view.dispatch({selection:{anchor:e.from,head:e.to},scrollIntoView:!0,effects:sf.of(e)})}static open(t){return new gf(t)}}function vf(t){return function(t,e='viewBox="0 0 40 40"'){return`url('data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" ${e}>${encodeURIComponent(t)}</svg>')`}(`<path d="m0 2.5 l2 -1.5 l1 0 l2 1.5 l1 0" stroke="${t}" fill="none" stroke-width=".7"/>`,'width="6" height="3"')}const wf=po.baseTheme({".cm-diagnostic":{padding:"3px 6px 3px 8px",marginLeft:"-1px",display:"block",whiteSpace:"pre-wrap"},".cm-diagnostic-error":{borderLeft:"5px solid #d11"},".cm-diagnostic-warning":{borderLeft:"5px solid orange"},".cm-diagnostic-info":{borderLeft:"5px solid #999"},".cm-diagnostic-hint":{borderLeft:"5px solid #66d"},".cm-diagnosticAction":{font:"inherit",border:"none",padding:"2px 4px",backgroundColor:"#444",color:"white",borderRadius:"3px",marginLeft:"8px",cursor:"pointer"},".cm-diagnosticSource":{fontSize:"70%",opacity:.7},".cm-lintRange":{backgroundPosition:"left bottom",backgroundRepeat:"repeat-x",paddingBottom:"0.7px"},".cm-lintRange-error":{backgroundImage:vf("#d11")},".cm-lintRange-warning":{backgroundImage:vf("orange")},".cm-lintRange-info":{backgroundImage:vf("#999")},".cm-lintRange-hint":{backgroundImage:vf("#66d")},".cm-lintRange-active":{backgroundColor:"#ffdd9980"},".cm-tooltip-lint":{padding:0,margin:0},".cm-lintPoint":{position:"relative","&:after":{content:'""',position:"absolute",bottom:0,left:"-2px",borderLeft:"3px solid transparent",borderRight:"3px solid transparent",borderBottom:"4px solid #d11"}},".cm-lintPoint-warning":{"&:after":{borderBottomColor:"orange"}},".cm-lintPoint-info":{"&:after":{borderBottomColor:"#999"}},".cm-lintPoint-hint":{"&:after":{borderBottomColor:"#66d"}},".cm-panel.cm-panel-lint":{position:"relative","& ul":{maxHeight:"100px",overflowY:"auto","& [aria-selected]":{backgroundColor:"#ddd","& u":{textDecoration:"underline"}},"&:focus [aria-selected]":{background_fallback:"#bdf",backgroundColor:"Highlight",color_fallback:"white",color:"HighlightText"},"& u":{textDecoration:"none"},padding:0,margin:0},"& [name=close]":{position:"absolute",top:"0",right:"2px",background:"inherit",border:"none",font:"inherit",padding:0,margin:0}},"&dark .cm-lintRange-active":{backgroundColor:"#86714a80"},"&dark .cm-panel.cm-panel-lint ul":{"& [aria-selected]":{backgroundColor:"#2e343e"}}})
function bf(t){return"error"==t?4:"warning"==t?3:"info"==t?2:1}function yf(t){let e="hint",i=1
for(let n of t){let t=bf(n.severity)
t>i&&(i=t,e=n.severity)}return e}const xf=[of,po.decorations.compute([of],t=>{let{selected:e,panel:i}=t.field(of)
return e&&i&&e.from!=e.to?Oe.set([rf.range(e.from,e.to)]):Oe.none}),function(t,e={}){let i=vt.define(),n=Q.define({create:()=>[],update(t,n){if(t.length&&(e.hideOnChange&&(n.docChanged||n.selection)?t=[]:e.hideOn&&(t=t.filter(t=>!e.hideOn(n,t))),n.docChanged)){let e=[]
for(let i of t){let t=n.changes.mapPos(i.pos,-1,R.TrackDel)
if(null!=t){let s=Object.assign(Object.create(null),i)
s.pos=t,null!=s.end&&(s.end=n.changes.mapPos(s.end)),e.push(s)}}t=e}for(let e of n.effects)e.is(i)&&(t=e.value),e.is(br)&&(t=[])
return t},provide:t=>pr.from(t)})
return{active:n,extension:[n,qi.define(s=>new vr(s,t,n,i,e.hoverTime||300)),gr]}}(function(t,e,i){let n,{diagnostics:s}=t.state.field(of),o=-1,r=-1
s.between(e-(i<0?1:0),e+(i>0?1:0),(t,s,{spec:l})=>{if(e>=t&&e<=s&&(t==s||(e>t||i>0)&&(e<s||i<0)))return n=l.diagnostics,o=t,r=s,!1})
let l=t.state.facet(cf).tooltipFilter
return n&&l&&(n=l(n,t.state)),n?{pos:o,end:r,above:t.state.doc.lineAt(o).to<r,create:()=>({dom:lf(t,n)})}:null},{hideOn:function(t,e){let i=e.pos,n=e.end||i,s=t.state.facet(cf).hideOn(t,i,n)
if(null!=s)return s
let o=t.startState.doc.lineAt(e.pos)
return!(!t.effects.some(t=>t.is(ef))&&!t.changes.touchesRange(o.from,Math.max(o.to,n)))}}),wf]
var kf=function(t){void 0===t&&(t={})
var{crosshairCursor:e=!1}=t,i=[]
!1!==t.closeBracketsKeymap&&(i=i.concat(qd)),!1!==t.defaultKeymap&&(i=i.concat(Yc)),!1!==t.searchKeymap&&(i=i.concat(Fu)),!1!==t.historyKeymap&&(i=i.concat(Xh)),!1!==t.foldKeymap&&(i=i.concat(qa)),!1!==t.completionKeymap&&(i=i.concat(Jd)),!1!==t.lintKeymap&&(i=i.concat(hf))
var n=[]
return!1!==t.lineNumbers&&n.push(function(t={}){return[jr.of(t),Nr(),Yr]}()),!1!==t.highlightActiveLineGutter&&n.push(Xr),!1!==t.highlightSpecialChars&&n.push(function(t={}){return[Yo.of(t),Go||(Go=qi.fromClass(class{constructor(t){this.view=t,this.decorations=Oe.none,this.decorationCache=Object.create(null),this.decorator=this.makeDecorator(t.state.facet(Yo)),this.decorations=this.decorator.createDeco(t)}makeDecorator(t){return new _o({regexp:t.specialChars,decoration:(e,i,n)=>{let{doc:s}=i.state,o=O(e[0],0)
...
t.startState.facet(Yo)!=e?(this.decorator=this.makeDecorator(e),this.decorations=this.decorator.createDeco(t.view)):this.decorations=this.decorator.updateDeco(t,this.decorations)}},{decorations:t=>t.decorations}))]}()),!1!==t.history&&n.push(function(t={}){return[Ph,Ih.of(t),po.domEventHandlers({beforeinput(t,e){let i="historyUndo"==t.inputType?Wh:"historyRedo"==t.inputType?Hh:null
return!!i&&(t.preventDefault(),i(e))}})]}()),!1!==t.foldGutter&&n.push(function(t={}){let e={...Ga,...t},i=new Ja(e,!0),n=new Ja(e,!1),s=qi.fromClass(class{constructor(t){this.from=t.viewport.from,this.markers=this.buildMarkers(t)}update(t){(t.docChanged||t.viewportChanged||t.startState.facet(ma)!=t.state.facet(ma)||t.startState.field(Na,!1)!=t.state.field(Na,!1)||ra(t.startState)!=ra(t.state)||e.foldingChanged(t))&&(this.markers=this.buildMarkers(t.view))}buildMarkers(t){let e=new Nt
for(let s of t.viewportLineBlocks){let o=Ha(t.state,s.from,s.to)?n:Ba(t.state,s.from,s.to)?i:null
o&&e.add(s.from,s.from,o)}return e.finish()}}),{domEventHandlers:o}=e
return[s,Ir({class:"cm-foldGutter",markers(t){var e
return(null===(e=t.plugin(s))||void 0===e?void 0:e.markers)||Pt.empty},initialSpacer:()=>new Ja(e,!1),domEventHandlers:{...o,click:(t,e,i)=>{if(o.click&&o.click(t,e,i))return!0
let n=Ha(t.state,e.from,e.to)
if(n)return t.dispatch({effects:Ia.of(n)}),!0
let s=Ba(t.state,e.from,e.to)
return!!s&&(t.dispatch({effects:La.of(s)}),!0)}}}),ja()]}()),!1!==t.drawSelection&&n.push(function(t={}){return[Lo.of(t),Po,Wo,Ho,Li.of(!0)]}()),!1!==t.dropCursor&&n.push([Fo,zo]),!1!==t.allowMultipleSelections&&n.push(Ot.allowMultipleSelections.of(!0)),!1!==t.indentOnInput&&n.push(Ot.transactionFilter.of(t=>{if(!t.docChanged||!t.isUserEvent("input.type")&&!t.isUserEvent("input.complete"))return t
...
let e=ya(r,t.from)
if(null==e)continue
let i=/^\s*/.exec(t.text)[0],n=ba(r,e)
i!=n&&a.push({from:t.from,to:t.from+i.length,insert:n})}return a.length?[t,{changes:a,sequential:!0}]:t})),!1!==t.syntaxHighlighting&&n.push(ih(sh,{fallback:!0})),!1!==t.bracketMatching&&n.push(function(t={}){return[lh.of(t),dh]}()),!1!==t.closeBrackets&&n.push([zd,Nd]),!1!==t.autocompletion&&n.push(function(t={}){return[Bd,Sd,rd.of(t),Dd,Xd,Rd]}()),!1!==t.rectangularSelection&&n.push(po.mouseSelectionStyle.of((t,e)=>(t=>t.altKey&&0==t.button)(e)?function(t,e){let i=ir(t,e),n=t.state.selection
...
return l.length?o?q.create(l.concat(n.ranges)):q.create(l):n}}:null}(t,e):null)),!1!==e&&n.push(function(t={}){let[e,i]=nr[t.key||"Alt"],n=qi.fromClass(class{constructor(t){this.view=t,this.isDown=!1}set(t){this.isDown!=t&&(this.isDown=t,this.view.update([]))}},{eventObservers:{keydown(t){this.set(t.keyCode==e||i(t))},keyup(t){t.keyCode!=e&&i(t)||this.set(!1)},mousemove(t){this.set(i(t))}}})
return[n,po.contentAttributes.of(t=>{var e
return(null===(e=t.plugin(n))||void 0===e?void 0:e.isDown)?sr:null})]}()),!1!==t.highlightActiveLine&&n.push(Zo),!1!==t.highlightSelectionMatches&&n.push([uu,cu]),t.tabSize&&"number"==typeof t.tabSize&&n.push(va.of(" ".repeat(t.tabSize))),n.concat([xo.of(i.flat())]).filter(Boolean)}
const Sf="#e06c75",Cf="#abb2bf",Mf="#7d8799",Af="#d19a66",Tf="#2c313a",Of="#282c34",Df="#353a42",Ef="#528bff",Bf=[po.theme({"&":{color:Cf,backgroundColor:Of},".cm-content":{caretColor:Ef},".cm-cursor, .cm-dropCursor":{borderLeftColor:Ef},"&.cm-focused > .cm-scroller > .cm-selectionLayer .cm-selectionBackground, .cm-selectionBackground, .cm-content ::selection":{backgroundColor:"#3E4451"},".cm-panels":{backgroundColor:"#21252b",color:Cf},".cm-panels.cm-panels-top":{borderBottom:"2px solid black"},".cm-panels.cm-panels-bottom":{borderTop:"2px solid black"},".cm-searchMatch":{backgroundColor:"#72a1ff59",outline:"1px solid #457dff"},".cm-searchMatch.cm-searchMatch-selected":{backgroundColor:"#6199ff2f"},".cm-activeLine":{backgroundColor:"#6699ff0b"},".cm-selectionMatch":{backgroundColor:"#aafe661a"},"&.cm-focused .cm-matchingBracket, &.cm-focused .cm-nonmatchingBracket":{backgroundColor:"#bad0f847"},".cm-gutters":{backgroundColor:Of,color:Mf,border:"none"},".cm-activeLineGutter":{backgroundColor:Tf},".cm-foldPlaceholder":{backgroundColor:"transparent",border:"none",color:"#ddd"},".cm-tooltip":{border:"none",backgroundColor:Df},".cm-tooltip .cm-tooltip-arrow:before":{borderTopColor:"transparent",borderBottomColor:"transparent"},".cm-tooltip .cm-tooltip-arrow:after":{borderTopColor:Df,borderBottomColor:Df},".cm-tooltip-autocomplete":{"& > ul > li[aria-selected]":{backgroundColor:Tf,color:Cf}}},{dark:!0}),ih(Qa.define([{tag:ta.keyword,color:"#c678dd"},{tag:[ta.name,ta.deleted,ta.character,ta.propertyName,ta.macroName],color:Sf},{tag:[ta.function(ta.variableName),ta.labelName],color:"#61afef"},{tag:[ta.color,ta.constant(ta.name),ta.standard(ta.name)],color:Af},{tag:[ta.definition(ta.name),ta.separator],color:Cf},{tag:[ta.typeName,ta.className,ta.number,ta.changed,ta.annotation,ta.modifier,ta.self,ta.namespace],color:"#e5c07b"},{tag:[ta.operator,ta.operatorKeyword,ta.url,ta.escape,ta.regexp,ta.link,ta.special(ta.string)],color:"#56b6c2"},{tag:[ta.meta,ta.comment],color:Mf},{tag:ta.strong,fontWeight:"bold"},{tag:ta.emphasis,fontStyle:"italic"},{tag:ta.strikethrough,textDecoration:"line-through"},{tag:ta.link,color:Mf,textDecoration:"underline"},{tag:ta.heading,fontWeight:"bold",color:Sf},{tag:[ta.atom,ta.bool,ta.special(ta.variableName)],color:Af},{tag:[ta.processingInstruction,ta.string,ta.inserted],color:"#98c379"},{tag:ta.invalid,color:"#ffffff"}]))]
var Rf=po.theme({"&":{backgroundColor:"#fff"}},{dark:!1}),Lf=function(t){void 0===t&&(t={})
var{indentWithTab:e=!0,editable:i=!0,readOnly:n=!1,theme:s="light",placeholder:o="",basicSetup:r=!0}=t,l=[]
switch(e&&l.unshift(xo.of([Gc])),r&&("boolean"==typeof r?l.unshift(kf()):l.unshift(kf(r))),o&&l.unshift(function(t){let e=qi.fromClass(class{constructor(e){this.view=e,this.placeholder=t?Oe.set([Oe.widget({widget:new tr(t),side:1}).range(0)]):Oe.none}get decorations(){return this.view.state.doc.length?Oe.none:this.placeholder}},{decorations:t=>t.decorations})
return"string"==typeof t?[e,po.contentAttributes.of({"aria-placeholder":t})]:e}(o)),s){case"light":l.push(Rf)
break
case"dark":l.push(Bf)
break
case"none":break
default:l.push(s)}return!1===i&&l.push(po.editable.of(!1)),n&&l.push(Ot.readOnly.of(!0)),[...l]}
class If{constructor(t,e){this.timeLeftMS=void 0,this.timeoutMS=void 0,this.isCancelled=!1,this.isTimeExhausted=!1,this.callbacks=[],this.timeLeftMS=e,this.timeoutMS=e,this.callbacks.push(t)}tick(){if(!this.isCancelled&&!this.isTimeExhausted&&(this.timeLeftMS--,this.timeLeftMS<=0)){this.isTimeExhausted=!0
var t=this.callbacks.slice()
this.callbacks.length=0,t.forEach(t=>{try{t()}catch(t){console.error("TimeoutLatch callback error:",t)}})}}cancel(){this.isCancelled=!0,this.callbacks.length=0}reset(){this.timeLeftMS=this.timeoutMS,this.isCancelled=!1,this.isTimeExhausted=!1}get isDone(){return this.isCancelled||this.isTimeExhausted}}class Pf{constructor(){this.interval=null,this.latches=new Set}add(t){this.latches.add(t),this.start()}remove(t){this.latches.delete(t),0===this.latches.size&&this.stop()}start(){null===this.interval&&(this.interval=setInterval(()=>{this.latches.forEach(t=>{t.tick(),t.isDone&&this.remove(t)})},1))}stop(){null!==this.interval&&(clearInterval(this.interval),this.interval=null)}}var Nf=null,Wf=pt.define(),Hf=[],Vf=i(34475),Ff=["className","value","selection","extensions","onChange","onStatistics","onCreateEditor","onUpdate","autoFocus","theme","height","minHeight","maxHeight","width","minWidth","maxWidth","basicSetup","placeholder","indentWithTab","editable","readOnly","root","initialState"],zf=(0,o.forwardRef)((t,e)=>{var{className:i,value:r="",selection:l,extensions:a=[],onChange:h,onStatistics:c,onCreateEditor:u,onUpdate:d,autoFocus:f,theme:p="light",height:m,minHeight:g,maxHeight:v,width:w,minWidth:b,maxWidth:y,basicSetup:x,placeholder:k,indentWithTab:S,editable:C,readOnly:M,root:A,initialState:T}=t,O=(0,s.A)(t,Ff),D=(0,o.useRef)(null),{state:E,view:B,container:R,setContainer:L}=function(t){var{value:e,selection:i,onChange:n,onStatistics:s,onCreateEditor:r,onUpdate:l,extensions:a=Hf,autoFocus:h,theme:c="light",height:u=null,minHeight:d=null,maxHeight:f=null,width:p=null,minWidth:m=null,maxWidth:g=null,placeholder:v="",editable:w=!0,readOnly:b=!1,indentWithTab:y=!0,basicSetup:x=!0,root:k,initialState:S}=t,[C,M]=(0,o.useState)(),[A,T]=(0,o.useState)(),[O,D]=(0,o.useState)(),E=(0,o.useState)(()=>({current:null}))[0],B=(0,o.useState)(()=>({current:null}))[0],R=po.theme({"&":{height:u,minHeight:d,maxHeight:f,width:p,minWidth:m,maxWidth:g},"& .cm-scroller":{height:"100% !important"}}),L=po.updateListener.of(t=>{if(t.docChanged&&"function"==typeof n&&!t.transactions.some(t=>t.annotation(Wf))){E.current?E.current.reset():(E.current=new If(()=>{if(B.current){var t=B.current
B.current=null,t()}E.current=null},200),("undefined"==typeof window?new Pf:(Nf||(Nf=new Pf),Nf)).add(E.current))
var e=t.state.doc.toString()
n(e,t)}s&&s((t=>({line:t.state.doc.lineAt(t.state.selection.main.from),lineCount:t.state.doc.lines,lineBreak:t.state.lineBreak,length:t.state.doc.length,readOnly:t.state.readOnly,tabSize:t.state.tabSize,selection:t.state.selection,selectionAsSingle:t.state.selection.asSingle().main,ranges:t.state.selection.ranges,selectionCode:t.state.sliceDoc(t.state.selection.main.from,t.state.selection.main.to),selections:t.state.selection.ranges.map(e=>t.state.sliceDoc(e.from,e.to)),selectedText:t.state.selection.ranges.some(t=>!t.empty)}))(t))}),I=[L,R,...Lf({theme:c,editable:w,readOnly:b,placeholder:v,indentWithTab:y,basicSetup:x})]
return l&&"function"==typeof l&&I.push(po.updateListener.of(l)),I=I.concat(a),(0,o.useLayoutEffect)(()=>{if(C&&!O){var t={doc:e,selection:i,extensions:I},n=S?Ot.fromJSON(S.json,t,S.fields):Ot.create(t)
if(D(n),!A){var s=new po({state:n,parent:C,root:k})
T(s),r&&r(s,n)}}return()=>{A&&(D(void 0),T(void 0))}},[C,O]),(0,o.useEffect)(()=>{t.container&&M(t.container)},[t.container]),(0,o.useEffect)(()=>()=>{A&&(A.destroy(),T(void 0)),E.current&&(E.current.cancel(),E.current=null)},[A]),(0,o.useEffect)(()=>{h&&A&&A.focus()},[h,A]),(0,o.useEffect)(()=>{A&&A.dispatch({effects:vt.reconfigure.of(I)})},[c,a,u,d,f,p,m,g,v,w,b,y,x,n,l]),(0,o.useEffect)(()=>{if(void 0!==e){var t=A?A.state.doc.toString():""
if(A&&e!==t){var i=()=>{A&&e!==A.state.doc.toString()&&A.dispatch({changes:{from:0,to:A.state.doc.toString().length,insert:e||""},annotations:[Wf.of(!0)]})}
E.current&&!E.current.isDone?B.current=i:i()}}},[e,A]),{state:O,setState:D,view:A,setView:T,container:C,setContainer:M}}({root:A,value:r,autoFocus:f,theme:p,height:m,minHeight:g,maxHeight:v,width:w,minWidth:b,maxWidth:y,basicSetup:x,placeholder:k,indentWithTab:S,editable:C,readOnly:M,selection:l,onChange:h,onStatistics:c,onCreateEditor:u,onUpdate:d,extensions:a,initialState:T});(0,o.useImperativeHandle)(e,()=>({editor:D.current,state:E,view:B}),[D,R,E,B])
var I=(0,o.useCallback)(t=>{D.current=t,L(t)},[L])
if("string"!=typeof r)throw new Error("value must be typeof string but got "+typeof r)
var P="string"==typeof p?"cm-theme-"+p:"cm-theme"
return(0,Vf.jsx)("div",(0,n.A)({ref:I,className:P+(i?" "+i:"")},O))})
zf.displayName="CodeMirror"
const qf=zf}}])

//# sourceMappingURL=chunk.864.406ddc00234c46892c0a.map